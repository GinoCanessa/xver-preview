...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      ...
      <sch:assert test="count(f:extension[@url = 'contributedToDeath']) &lt;= 1">extension with URL = 'contributedToDeath': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'performed']) &lt;= 1">extension with URL = 'performed': maximum cardinality of 'extension' is 1</sch:assert>
