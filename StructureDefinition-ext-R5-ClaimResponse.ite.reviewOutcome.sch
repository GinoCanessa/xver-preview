...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      ...
      <sch:assert test="count(f:extension[@url = 'preAuthRef']) &lt;= 1">extension with URL = 'preAuthRef': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'preAuthPeriod']) &lt;= 1">extension with URL = 'preAuthPeriod': maximum cardinality of 'extension' is 1</sch:assert>
