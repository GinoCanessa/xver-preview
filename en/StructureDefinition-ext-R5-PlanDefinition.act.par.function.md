# ExtensionPlanDefinition_Action_Participant_Function - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
```json
{
  ...
  "description" : "R5: `PlanDefinition.action.participant.function` (new:CodeableConcept)",
  "jurisdiction" : [{
    "coding" : [{
