# ExtensionMolecularSequence_Relative_OrdinalPosition - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Indicates the order in which the sequence should be considered when putting multiple 'relative' elements together (new) 
...
```json
{
  ...
  "title" : "R5: Indicates the order in which the sequence should be considered when putting multiple 'relative' elements together (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `MolecularSequence.relative.ordinalPosition` (new:integer)",
  "jurisdiction" : [{
    "coding" : [{
