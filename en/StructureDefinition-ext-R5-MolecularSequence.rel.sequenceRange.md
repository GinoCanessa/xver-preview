# ExtensionMolecularSequence_Relative_SequenceRange - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Indicates the nucleotide range in the composed sequence when multiple 'relative' elements are used together (new) 
...
```json
{
  ...
  "title" : "R5: Indicates the nucleotide range in the composed sequence when multiple 'relative' elements are used together (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `MolecularSequence.relative.sequenceRange` (new:Range)",
  "jurisdiction" : [{
    "coding" : [{
