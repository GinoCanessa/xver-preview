# ExtensionEvidenceVariable_Characteristic_TimeFromEvent_Note - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Used for footnotes or explanatory notes (new) 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-EvidenceVariable.cha.tim.note)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-EvidenceVariable.cha.tim.note.csv), [Excel](../StructureDefinition-ext-R5-EvidenceVariable.cha.tim.note.xlsx), [Schematron](../StructureDefinition-ext-R5-EvidenceVariable.cha.tim.note.sch) 
...
```json
{
  ...
  "id" : "ext-R5-EvidenceVariable.cha.tim.note",
  "extension" : [{
  ...
  "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-EvidenceVariable.characteristic.timeFromEvent.note",
  "version" : "0.1.0",
  "name" : "ExtensionEvidenceVariable_Characteristic_TimeFromEvent_Note",
  "title" : "R5: Used for footnotes or explanatory notes (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `EvidenceVariable.characteristic.timeFromEvent.note` (new:Annotation)",
  "jurisdiction" : [{
    "coding" : [{
