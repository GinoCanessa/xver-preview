# ExtensionRequirements_Publisher - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Name of the publisher/steward (organization or individual) (new) 

R5: `Requirements.publisher` (new:string)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-Requirements.publisher)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-Requirements.publisher.csv), [Excel](../StructureDefinition-ext-R5-Requirements.publisher.xlsx), [Schematron](../StructureDefinition-ext-R5-Requirements.publisher.sch) 
...
```json
{
  ...
  "id" : "ext-R5-Requirements.publisher",
  "extension" : [{
  ...
  "version" : "0.1.0",
  "name" : "ExtensionRequirements_Publisher",
  ...
  "description" : "R5: `Requirements.publisher` (new:string)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "purpose" : "This extension is part of the cross-version definitions generated to enable use of the\r\nelement `Requirements.publisher` as defined in FHIR R5\r\nin FHIR R4.\r\n\r\nThe source element is defined as:\r\n`Requirements.publisher` 0..1 `string`\r\n\r\nAcross FHIR versions, the element set has been mapped as:\r\n* R5 `Requirements.publisher` 0..1 `string`\r\n\r\nFollowing are the generation technical comments:\r\nElement `Requirements.publisher` is not mapped to FHIR R4, since FHIR R5 `Requirements` is not mapped.\nElement `Requirements.publisher` has no mapping targets in FHIR R4. Typically, this is because the element has been added (is a new element).",
  "fhirVersion" : "4.0.1",
  "mapping" : [{
    "identity" : "rim",
    "uri" : "http://hl7.org/v3",
