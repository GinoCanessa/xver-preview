# SubstanceStereochemistry - FHIR Cross-Version Extensions package to use FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## CodeSystem: SubstanceStereochemistry 
...
* [ValueSetR5SubstanceStereochemistryForR4](ValueSet-ValueSet-R5-substance-stereochemistry-for-R4.md)
...
```json
{
  ...
  "title" : "Substance Stereochemistry",
  "status" : "active",
  "experimental" : false,
