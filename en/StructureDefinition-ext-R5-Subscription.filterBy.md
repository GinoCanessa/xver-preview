# ExtensionSubscription_FilterBy - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Criteria for narrowing the subscription topic stream (new) 
...
```json
{
  ...
  "title" : "R5: Criteria for narrowing the subscription topic stream (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Subscription.filterBy` (new:BackboneElement)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "definition" : "R5: `Subscription.filterBy.resourceType` (new:uri)",
    ...
    },
    {
      ...
      "definition" : "R5: `Subscription.filterBy.filterParameter` (new:string)",
    ...
    },
    {
      ...
      "definition" : "R5: `Subscription.filterBy.comparator` (new:code)",
    ...
    },
    {
      ...
      "definition" : "R5: `Subscription.filterBy.modifier` (new:code)",
    ...
    },
    {
      ...
      "definition" : "R5: `Subscription.filterBy.value` (new:string)",
