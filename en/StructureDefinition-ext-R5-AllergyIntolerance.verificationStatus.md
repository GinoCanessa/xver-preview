# ExtensionAllergyIntolerance_VerificationStatus - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: unconfirmed | presumed | confirmed | refuted | entered-in-error 
...
```json
{
  ...
  "title" : "R5: unconfirmed | presumed | confirmed | refuted | entered-in-error",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `AllergyIntolerance.verificationStatus`",
  "jurisdiction" : [{
    "coding" : [{
