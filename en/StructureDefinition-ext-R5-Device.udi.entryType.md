# ExtensionDevice_UdiCarrier_EntryType - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: barcode | rfid | manual | card | self-reported | electronic-transmission | unknown additional codes 

R5: `Device.udiCarrier.entryType` additional codes
...
```json
{
  ...
  "title" : "R5: barcode | rfid | manual | card | self-reported | electronic-transmission | unknown additional codes",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Device.udiCarrier.entryType` additional codes",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        ...
        "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-udi-entry-type-for-R4|0.1.0"
      }
    }]
  }
}
