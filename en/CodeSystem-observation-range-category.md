# ObservationRangeCategory - FHIR Cross-Version Extensions package to use FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## CodeSystem: ObservationRangeCategory 
...
```json
{
  ...
  "concept" : [
    ...
    },
    {
      ...
      "definition" : "Critical Range for Ordinal and Continuous Observations. Results outside this range are critical."
    },
    {
      "code" : "absolute",
