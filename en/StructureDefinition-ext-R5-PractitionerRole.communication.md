# ExtensionPractitionerRole_Communication - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: A language the practitioner (in this role) can use in patient communication (new) 

R5: `PractitionerRole.communication` (new:CodeableConcept)
...
```json
{
  ...
  "title" : "R5: A language the practitioner (in this role) can use in patient communication (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `PractitionerRole.communication` (new:CodeableConcept)",
  "jurisdiction" : [{
    "coding" : [{
