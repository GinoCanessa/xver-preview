# ExtensionEvidenceVariable_Characteristic_DefinitionCodeableConcept - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Defines the characteristic (without using type and value) by a CodeableConcept (new) 
...
```json
{
  ...
  "title" : "R5: Defines the characteristic (without using type and value) by a CodeableConcept (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `EvidenceVariable.characteristic.definitionCodeableConcept` (new:CodeableConcept)",
  "jurisdiction" : [{
    "coding" : [{
