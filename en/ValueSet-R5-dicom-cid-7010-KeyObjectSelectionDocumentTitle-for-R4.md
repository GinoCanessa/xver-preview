# R5DicomCid7010KeyObjectSelectionDocumentTitleForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
* [R5: Classifies the imaging selection (new)](StructureDefinition-ext-R5-ImagingSelection.category.md)
* [R5: Imaging Selection purpose text or code (new)](StructureDefinition-ext-R5-ImagingSelection.code.md)
