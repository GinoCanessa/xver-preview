# ExtensionMolecularSequence_Relative_StartingSequence_Chromosome - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Chromosome Identifier 
...
```json
{
  ...
  "title" : "R5: Chromosome Identifier",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `MolecularSequence.relative.startingSequence.chromosome`",
  "jurisdiction" : [{
    "coding" : [{
