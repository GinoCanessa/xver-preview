# ExtensionSubscriptionTopic_Purpose - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Why this SubscriptionTopic is defined (new) 

R5: `SubscriptionTopic.purpose` (new:markdown)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-SubscriptionTopic.purpose)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-SubscriptionTopic.purpose.csv), [Excel](../StructureDefinition-ext-R5-SubscriptionTopic.purpose.xlsx), [Schematron](../StructureDefinition-ext-R5-SubscriptionTopic.purpose.sch) 
...
```json
{
  ...
  "id" : "ext-R5-SubscriptionTopic.purpose",
  "extension" : [{
  ...
  "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-SubscriptionTopic.purpose",
  "version" : "0.1.0",
  "name" : "ExtensionSubscriptionTopic_Purpose",
  "title" : "R5: Why this SubscriptionTopic is defined (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `SubscriptionTopic.purpose` (new:markdown)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-SubscriptionTopic.purpose"
    },
    {
