# ExtensionMedicationStatement_Adherence - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Indicates whether the medication is or is not being consumed or administered (new) 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-MedicationStatement.adherence)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-MedicationStatement.adherence.csv), [Excel](../StructureDefinition-ext-R5-MedicationStatement.adherence.xlsx), [Schematron](../StructureDefinition-ext-R5-MedicationStatement.adherence.sch) 
...
```json
{
  ...
  "id" : "ext-R5-MedicationStatement.adherence",
  "extension" : [{
  ...
  "version" : "0.1.0",
  "name" : "ExtensionMedicationStatement_Adherence",
  "title" : "R5: Indicates whether the medication is or is not being consumed or administered (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `MedicationStatement.adherence` (new:BackboneElement)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "path" : "Extension.extension",
      "sliceName" : "code",
      "short" : "R5: Type of adherence (new)",
      "definition" : "R5: `MedicationStatement.adherence.code` (new:CodeableConcept)",
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "example",
        "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-medication-statement-adherence-for-R4|0.1.0"
      }
    },
    {
      ...
      "path" : "Extension.extension",
      "sliceName" : "reason",
      "short" : "R5: Details of the reason for the current use of the medication (new)",
      "definition" : "R5: `MedicationStatement.adherence.reason` (new:CodeableConcept)",
