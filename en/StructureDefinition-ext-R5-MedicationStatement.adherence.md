...
This cross-version extension represents the FHIR R5 element `MedicationStatement.adherence` for use in FHIR R4.
...
```json
{
  ...
  "description" : "This cross-version extension represents the FHIR R5 element `MedicationStatement.adherence` for use in FHIR R4.",
  "jurisdiction" : [
    {
      "coding" : [
        {
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "example",
          "valueSet" : "http://hl7.org/fhir/5.0/ValueSet/ValueSet-R5-reason-medication-status-codes-for-R4"
        }
      },
      {
        "id" : "Extension.url",
