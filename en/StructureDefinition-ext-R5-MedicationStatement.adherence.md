  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "requirements" : "Element `MedicationStatement.adherence.code` has a context of MedicationStatement based on following the parent source element upwards and mapping to `MedicationStatement`.",
        "min" : 1,
        "max" : "1",
        "base" : {
          "path" : "Extension.extension",
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "example",
          "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-medication-statement-adherence-for-R4|0.0.1-snapshot-3"
        }
      },
      {
        ...
        "requirements" : "Element `MedicationStatement.adherence.reason` has a context of MedicationStatement based on following the parent source element upwards and mapping to `MedicationStatement`.",
        "min" : 0,
        "max" : "1",
        "base" : {
          "path" : "Extension.extension",
