# Lookup for R5V3LaboratoryObservationSubtypeForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## Lookup for R5V3LaboratoryObservationSubtypeForR4

### Lookup for FHIR R5 ValueSet LaboratoryObservationSubType:http://terminology.hl7.org/ValueSet/v3-LaboratoryObservationSubtype for use in FHIR R4

The FHIR R5 ValueSet LaboratoryObservationSubType has no mapping to FHIR R4.
