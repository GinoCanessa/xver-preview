# ExtensionSpecimen_Container_Location - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Where the container is (new) 

R5: `Specimen.container.location` (new:Reference(Location))
...
```json
{
  ...
  "title" : "R5: Where the container is (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Specimen.container.location` (new:Reference(Location))",
  "jurisdiction" : [{
    "coding" : [{
