# ExtensionMeasureReport_Group_Stratifier_Stratum_MeasureScore - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: measureScore additional types 

R5: `MeasureReport.group.stratifier.stratum.measureScore[x]` additional types (dateTime, CodeableConcept, Period, Range)
...
```json
{
  ...
  "description" : "R5: `MeasureReport.group.stratifier.stratum.measureScore[x]` additional types (dateTime, CodeableConcept, Period, Range)",
  "jurisdiction" : [{
    "coding" : [{
