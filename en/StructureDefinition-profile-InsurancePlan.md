...
* Refer to this Profile: [Cross-version Extension `R5.Coverage.insurancePlan` for use in FHIR R4](StructureDefinition-ext-R5-Coverage.insurancePlan.md)
...
```json
{
  ...
  "status" : "active",
  "experimental" : false,
  "date" : "2026-02-06T13:17:30.717929-06:00",
