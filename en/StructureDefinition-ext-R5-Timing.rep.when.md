# ExtensionTiming_Repeat_When - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## Extension: Cross-version Extension `R5.Timing.repeat.when` for use in FHIR R4 

This cross-version extension represents the FHIR R5 element `Timing.repeat.when` for use in FHIR R4.
...
```json
{
  ...
  "title" : "Cross-version Extension `R5.Timing.repeat.when` for use in FHIR R4",
  "status" : "active",
  "experimental" : false,
    ...
    "element" : [
      ...
      },
      {
        ...
        "binding" : {
          ...
          "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-event-timing-for-R4|0.0.1-snapshot-3"
        }
      }
    ]
  }
