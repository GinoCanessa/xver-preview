# ExtensionMeasure_Group_Stratifier_Component_LinkId - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Unique id for stratifier component in measure (new) 

R5: `Measure.group.stratifier.component.linkId` (new:string)
...
```json
{
  ...
  "title" : "R5: Unique id for stratifier component in measure (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Measure.group.stratifier.component.linkId` (new:string)",
  "jurisdiction" : [{
    "coding" : [{
