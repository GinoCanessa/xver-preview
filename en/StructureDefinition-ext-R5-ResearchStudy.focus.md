# ExtensionResearchStudy_Focus - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: focus additional types 
...
```json
{
  ...
  "title" : "R5: focus additional types",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `ResearchStudy.focus` additional types (CodeableReference(http://hl7.org/fhir/StructureDefinition/Medication), CodeableReference(http://hl7.org/fhir/StructureDefinition/MedicinalProductDefinition), CodeableReference(http://hl7.org/fhir/StructureDefinition/SubstanceDefinition), CodeableReference(http://hl7.org/fhir/StructureDefinition/EvidenceVariable))",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "preferred",
        "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-research-study-focus-type-for-R4|0.1.0"
      }
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        ...
        "http://hl7.org/fhir/5.0/StructureDefinition/profile-MedicinalProductDefinition-for-MedicinalProduct|0.1.0",
