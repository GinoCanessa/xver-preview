# ExtensionInventoryReport_InventoryListing - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: An inventory listing section (grouped by any of the attributes) (new) 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-InventoryReport.inventoryListing)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-InventoryReport.inventoryListing.csv), [Excel](../StructureDefinition-ext-R5-InventoryReport.inventoryListing.xlsx), [Schematron](../StructureDefinition-ext-R5-InventoryReport.inventoryListing.sch) 
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        ...
        "http://hl7.org/fhir/5.0/StructureDefinition/profile-InventoryItem|0.1.0",
