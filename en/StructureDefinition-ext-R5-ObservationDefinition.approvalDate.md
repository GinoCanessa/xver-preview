# ExtensionObservationDefinition_ApprovalDate - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: When ObservationDefinition was approved by publisher (new) 
...
```json
{
  ...
  "title" : "R5: When ObservationDefinition was approved by publisher (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `ObservationDefinition.approvalDate` (new:date)",
  "jurisdiction" : [{
    "coding" : [{
