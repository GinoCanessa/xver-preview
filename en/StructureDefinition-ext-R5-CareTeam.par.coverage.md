# ExtensionCareTeam_Participant_Coverage - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: When the member is generally available within this care team (new) 
...
```json
{
  ...
  "title" : "R5: When the member is generally available within this care team (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `CareTeam.participant.coverage[x]` (new:Period, Timing)",
  "jurisdiction" : [{
    "coding" : [{
