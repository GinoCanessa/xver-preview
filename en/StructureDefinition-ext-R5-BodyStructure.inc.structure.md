# ExtensionBodyStructure_IncludedStructure_Structure - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Code that represents the included structure (new) 

R5: `BodyStructure.includedStructure.structure` (new:CodeableConcept)
...
```json
{
  ...
  "title" : "R5: Code that represents the included structure (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `BodyStructure.includedStructure.structure` (new:CodeableConcept)",
  "jurisdiction" : [{
    "coding" : [{
