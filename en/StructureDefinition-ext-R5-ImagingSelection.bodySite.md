# ExtensionImagingSelection_BodySite - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Body part examined (new) 

R5: `ImagingSelection.bodySite` (new:CodeableReference(BodyStructure))
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-ImagingSelection.bodySite)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-ImagingSelection.bodySite.csv), [Excel](../StructureDefinition-ext-R5-ImagingSelection.bodySite.xlsx), [Schematron](../StructureDefinition-ext-R5-ImagingSelection.bodySite.sch) 
...
```json
{
  ...
  "id" : "ext-R5-ImagingSelection.bodySite",
  "extension" : [{
  ...
  "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-ImagingSelection.bodySite",
  "version" : "0.1.0",
  "name" : "ExtensionImagingSelection_BodySite",
  "title" : "R5: Body part examined (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `ImagingSelection.bodySite` (new:CodeableReference(BodyStructure))",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "purpose" : "This extension is part of the cross-version definitions generated to enable use of the\r\nelement `ImagingSelection.bodySite` as defined in FHIR R5\r\nin FHIR R4.\r\n\r\nThe source element is defined as:\r\n`ImagingSelection.bodySite` 0..1 `CodeableReference(http://hl7.org/fhir/StructureDefinition/BodyStructure)`\r\n\r\nAcross FHIR versions, the element set has been mapped as:\r\n* R5 `ImagingSelection.bodySite` 0..1 `CodeableReference(http://hl7.org/fhir/StructureDefinition/BodyStructure)`\r\n\r\nFollowing are the generation technical comments:\r\nElement `ImagingSelection.bodySite` is not mapped to FHIR R4, since FHIR R5 `ImagingSelection` is not mapped.\nElement `ImagingSelection.bodySite` has no mapping targets in FHIR R4. Typically, this is because the element has been added (is a new element).",
  "fhirVersion" : "4.0.1",
  "mapping" : [{
    "identity" : "rim",
    "uri" : "http://hl7.org/v3",
