...
This cross-version extension represents the FHIR R5 element `Observation.triggeredBy` for use in FHIR R4.
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-Observation.triggeredBy)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-Observation.triggeredBy.csv), [Excel](../StructureDefinition-ext-R5-Observation.triggeredBy.xlsx), [Schematron](../StructureDefinition-ext-R5-Observation.triggeredBy.sch) 
...
```json
{
  ...
  "description" : "This cross-version extension represents the FHIR R5 element `Observation.triggeredBy` for use in FHIR R4.",
  "jurisdiction" : [
    {
      "coding" : [
        {
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "requirements" : "Note that there is an externally-defined extension that has been flagged as the representation of FHIR R5 element `Observation.triggeredBy.observation` with an unmapped Reference type: `http://hl7.org/fhir/StructureDefinition/alternate-reference`.\nElement `Observation.triggeredBy.observation` has a context of Observation based on following the parent source element upwards and mapping to `Observation`.",
        "min" : 1,
        "max" : "1",
        "base" : {
          "path" : "Extension.extension",
      ...
      },
      {
        ...
        "requirements" : "Element `Observation.triggeredBy.type` has a context of Observation based on following the parent source element upwards and mapping to `Observation`.",
        "min" : 1,
        "max" : "1",
        "base" : {
          "path" : "Extension.extension",
      ...
      },
      {
        ...
        "binding" : {
          ...
          "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-observation-triggeredbytype-for-R4|0.0.1-snapshot-3"
        }
      },
      {
        ...
        "requirements" : "Element `Observation.triggeredBy.reason` has a context of Observation based on following the parent source element upwards and mapping to `Observation`.",
        "min" : 0,
        "max" : "1",
        "base" : {
          "path" : "Extension.extension",
