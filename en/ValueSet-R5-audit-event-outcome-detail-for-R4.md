# R5AuditEventOutcomeDetailForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
* [R5: Additional outcome detail (new)](StructureDefinition-ext-R5-AuditEvent.out.detail.md)
