# DeviceUsageStatus - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
* [R5DeviceusageStatusForR4DeviceStatementStatus](ValueSet-R5-deviceusage-status-for-R4-device-statement-status.md)
