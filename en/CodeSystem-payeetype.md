# ClaimPayeeTypeCodes - FHIR Cross-Version Extensions package to use FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## CodeSystem: ClaimPayeeTypeCodes (Experimental) 
...
```json
{
  ...
  "caseSensitive" : true,
  "valueSet" : "http://terminology.hl7.org/ValueSet/payeetype|1.0.1",
  "content" : "complete",
  "concept" : [
    {
      "code" : "subscriber",
    ...
    },
    {
      "code" : "other",
      "display" : "Other",
      "definition" : "Any benefit payable will be paid to a third party such as a guarantor."
    }
  ]
}
