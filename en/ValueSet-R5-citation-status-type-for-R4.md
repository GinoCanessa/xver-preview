# R5CitationStatusTypeForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
* [R5: The status of the citation record (new)](StructureDefinition-ext-R5-Citation.currentState.md)
* [R5: An effective date or period for a status of the citation record (new)](StructureDefinition-ext-R5-Citation.statusDate.md)
...
```json
{
  ...
  "id" : "R5-citation-status-type-for-R4",
  "extension" : [{
  ...
  "url" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-citation-status-type-for-R4",
  "version" : "0.1.0",
  "name" : "R5CitationStatusTypeForR4",
