# ExtensionDeviceDefinition_ConformsTo - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## Extension: Cross-version Extension `R5.DeviceDefinition.conformsTo` for use in FHIR R4 

This cross-version extension represents the FHIR R5 element `DeviceDefinition.conformsTo` for use in FHIR R4.
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-DeviceDefinition.conformsTo)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-DeviceDefinition.conformsTo.csv), [Excel](../StructureDefinition-ext-R5-DeviceDefinition.conformsTo.xlsx), [Schematron](../StructureDefinition-ext-R5-DeviceDefinition.conformsTo.sch) 
...
```json
{
  ...
  "id" : "ext-R5-DeviceDefinition.conformsTo",
  "extension" : [
    {
  ...
  "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-DeviceDefinition.conformsTo",
  "version" : "0.0.1-snapshot-3",
  "name" : "ExtensionDeviceDefinition_ConformsTo",
  "title" : "Cross-version Extension `R5.DeviceDefinition.conformsTo` for use in FHIR R4",
  "status" : "active",
  "experimental" : false,
  ...
  "purpose" : "This extension is part of the cross-version definitions generated to enable use of the\r\nelement `DeviceDefinition.conformsTo` as defined in FHIR R5\r\nin FHIR R4.\r\n\r\nThe source element is defined as:\r\n`DeviceDefinition.conformsTo` 0..* `BackboneElement`\r\n\r\nAcross FHIR versions, the element set has been mapped as:\r\n*  R5: `DeviceDefinition.conformsTo` 0..* `BackboneElement`\n*  R4B: `DeviceDefinition.specialization` 0..* `BackboneElement`\n*  R4: `DeviceDefinition.specialization` 0..* `BackboneElement`\r\n\r\nFollowing are the generation technical comments:\r\nElement `DeviceDefinition.conformsTo` has is mapped to FHIR R4 element `DeviceDefinition.specialization`, but has no comparisons.",
  "fhirVersion" : "4.0.1",
  "mapping" : [
    {
      "identity" : "rim",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "requirements" : "Element `DeviceDefinition.conformsTo.category` is part of an existing definition because parent element `DeviceDefinition.conformsTo` requires a cross-version extension.\nElement `DeviceDefinition.conformsTo.category` has is mapped to FHIR R4 element `DeviceDefinition.specialization`, but has no comparisons.",
        "min" : 0,
        "max" : "1",
        "base" : {
          "path" : "Extension.extension",
      ...
      },
      {
        ...
        "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-DeviceDefinition.conformsTo.category"
      },
      {
      ...
      },
      {
        ...
        "requirements" : "Element `DeviceDefinition.conformsTo.specification` is part of an existing definition because parent element `DeviceDefinition.conformsTo` requires a cross-version extension.\nElement `DeviceDefinition.conformsTo.specification` has is mapped to FHIR R4 element `DeviceDefinition.specialization`, but has no comparisons.",
        "min" : 1,
        "max" : "1",
        "base" : {
          "path" : "Extension.extension",
      ...
      },
      {
        ...
        "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-DeviceDefinition.conformsTo.specification"
      },
      {
      ...
      },
      {
        ...
        "requirements" : "Element `DeviceDefinition.conformsTo.version` is part of an existing definition because parent element `DeviceDefinition.conformsTo` requires a cross-version extension.\nElement `DeviceDefinition.conformsTo.version` has is mapped to FHIR R4 element `DeviceDefinition.specialization.version`, but has no comparisons.",
        "min" : 0,
        "max" : "*",
        "base" : {
          "path" : "Extension.extension",
      ...
      },
      {
        ...
        "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-DeviceDefinition.conformsTo.version"
      },
      {
      ...
      },
      {
        ...
        "requirements" : "Element `DeviceDefinition.conformsTo.source` is part of an existing definition because parent element `DeviceDefinition.conformsTo` requires a cross-version extension.\nElement `DeviceDefinition.conformsTo.source` has is mapped to FHIR R4 element `DeviceDefinition.specialization`, but has no comparisons.",
        "min" : 0,
        "max" : "*",
        "base" : {
          "path" : "Extension.extension",
      ...
      },
      {
        ...
        "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-DeviceDefinition.conformsTo.source"
      },
      {
      ...
      },
      {
        ...
        "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-DeviceDefinition.conformsTo"
      },
      {
