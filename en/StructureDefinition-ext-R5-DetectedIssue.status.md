# ExtensionDetectedIssue_Status - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: preliminary | final | entered-in-error | mitigated additional codes 
...
```json
{
  ...
  "title" : "R5: preliminary | final | entered-in-error | mitigated additional codes",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `DetectedIssue.status` additional codes",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        ...
        "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-detectedissue-status-for-R4-observation-status|0.1.0"
      }
    }]
  }
}
