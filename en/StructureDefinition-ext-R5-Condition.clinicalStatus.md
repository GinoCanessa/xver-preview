# ExtensionCondition_ClinicalStatus - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: active | recurrence | relapse | inactive | remission | resolved | unknown 

R5: `Condition.clinicalStatus`
...
```json
{
  ...
  "title" : "R5: active | recurrence | relapse | inactive | remission | resolved | unknown",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Condition.clinicalStatus`",
  "jurisdiction" : [{
    "coding" : [{
