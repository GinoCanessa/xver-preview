# R5EvidenceReportSectionForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
* [R5: Composition is broken into sections (new)](StructureDefinition-ext-R5-EvidenceReport.section.md)
...
```json
{
  ...
  "id" : "R5-evidence-report-section-for-R4",
  "extension" : [{
  ...
  "url" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-evidence-report-section-for-R4",
  "version" : "0.1.0",
  "name" : "R5EvidenceReportSectionForR4",
