# R5PermissionRuleCombiningForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## ValueSet: Cross-version ValueSet R5.PermissionRuleCombining for use in FHIR R4 
...
* [R5: deny-overrides | permit-overrides | ordered-deny-overrides | ordered-permit-overrides | deny-unless-permit | permit-unless-deny (new)](StructureDefinition-ext-R5-Permission.combining.md)
