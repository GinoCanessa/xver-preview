# ExtensionEvidenceVariable_Purpose - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Why this EvidenceVariable is defined (new) 
...
```json
{
  ...
  "title" : "R5: Why this EvidenceVariable is defined (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `EvidenceVariable.purpose` (new:markdown)",
  "jurisdiction" : [{
    "coding" : [{
