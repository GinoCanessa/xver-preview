# ExtensionValueSet_Compose_Property - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Property to return if client doesn't override (new) 

R5: `ValueSet.compose.property` (new:string)
...
```json
{
  ...
  "title" : "R5: Property to return if client doesn't override (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `ValueSet.compose.property` (new:string)",
  "jurisdiction" : [{
    "coding" : [{
