# ExtensionEvidenceVariable_Characteristic_LinkId - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Label for internal linking (new) 
...
```json
{
  ...
  "title" : "R5: Label for internal linking (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `EvidenceVariable.characteristic.linkId` (new:id)",
  "jurisdiction" : [{
    "coding" : [{
