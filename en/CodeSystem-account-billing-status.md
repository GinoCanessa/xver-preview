# AccountBillingStatus - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## CodeSystem: AccountBillingStatus (Experimental) 
...
* [R5AccountBillingStatusForR4](ValueSet-R5-account-billing-status-for-R4.md)
