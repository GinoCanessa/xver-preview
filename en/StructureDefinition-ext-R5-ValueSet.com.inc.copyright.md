# ExtensionValueSet_Compose_Include_Copyright - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: A copyright statement for the specific code system included in the value set (new) 

R5: `ValueSet.compose.include.copyright` (new:string)
...
```json
{
  ...
  "title" : "R5: A copyright statement for the specific code system included in the value set (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `ValueSet.compose.include.copyright` (new:string)",
  "jurisdiction" : [{
    "coding" : [{
