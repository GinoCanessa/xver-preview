# R5StudyDesignForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
* [R5: The design of the study that produced this evidence (new)](StructureDefinition-ext-R5-Evidence.studyDesign.md)
* [R5: Classifications of the study design characteristics (new)](StructureDefinition-ext-R5-ResearchStudy.studyDesign.md)
