# R5TargetSpeciesForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## ValueSet: Cross-version ValueSet R5.TargetSpecies for use in FHIR R4 

 
This cross-version ValueSet represents content from `http://hl7.org/fhir/ValueSet/target-species|5.0.0` for use in FHIR R4. 

 **References** 

* [R5: The path by which the product is taken into or makes contact with the body (new)](StructureDefinition-ext-R5-APD.rOA.md)
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-target-species-for-R4",
  "version" : "0.1.0",
  "name" : "R5TargetSpeciesForR4",
  "title" : "Cross-version ValueSet R5.TargetSpecies for use in FHIR R4",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "This cross-version ValueSet represents content from `http://hl7.org/fhir/ValueSet/target-species|5.0.0` for use in FHIR R4.",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "purpose" : "This value set is part of the cross-version definitions generated to enable use of the\r\nvalue set `http://hl7.org/fhir/ValueSet/target-species|5.0.0` as defined in FHIR R5\r\nin FHIR R4.\r\n\r\nThe source value set is bound to the following FHIR R5 elements:\r\n* `AdministrableProductDefinition.routeOfAdministration.targetSpecies.code` as Example\r\n\r\nAcross FHIR versions, the value set has been mapped as:\r\n* `http://hl7.org/fhir/ValueSet/target-species|5.0.0`\n* `http://hl7.org/fhir/ValueSet/target-species|4.3.0`\r\n\r\nThe following concepts are not included in this cross-version definition because they have valid representations\r\n* _no concepts_\r\n\r\nFollowing are the generation technical comments:\r\nAll concepts in the comparison are have code literals listed as identical.\nThe source and target value sets have the same number of active concepts (200).\nFHIR ValueSet `http://hl7.org/fhir/ValueSet/target-species|5.0.0`, defined in FHIR R5 does not have any mapping to FHIR R4",
  "compose" : {
    "include" : [{
