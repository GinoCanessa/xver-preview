# ExtensionTask_Input - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## Extension: Cross-version Extension `R5.Task.input` for use in FHIR R4 

This cross-version extension represents the FHIR R5 element `Task.input` for use in FHIR R4.
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-Task.input)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-Task.input.csv), [Excel](../StructureDefinition-ext-R5-Task.input.xlsx), [Schematron](../StructureDefinition-ext-R5-Task.input.sch) 
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Task.input",
  "version" : "0.0.1-snapshot-3",
  "name" : "ExtensionTask_Input",
  "title" : "Cross-version Extension `R5.Task.input` for use in FHIR R4",
  "status" : "active",
  "experimental" : false,
  ...
  "purpose" : "This extension is part of the cross-version definitions generated to enable use of the\r\nelement `Task.input` as defined in FHIR R5\r\nin FHIR R4.\r\n\r\nThe source element is defined as:\r\n`Task.input` 0..* `BackboneElement`\r\n\r\nAcross FHIR versions, the element set has been mapped as:\r\n*  R5: `Task.input` 0..* `BackboneElement`\n*  R4B: `Task.input` 0..* `BackboneElement`\n*  R4: `Task.input` 0..* `BackboneElement`\r\n\r\nFollowing are the generation technical comments:\r\nElement `Task.input` has is mapped to FHIR R4 element `Task.input`, but has no comparisons.",
  "fhirVersion" : "4.0.1",
  "mapping" : [
    {
      "identity" : "rim",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "requirements" : "Inputs are named to enable task automation to bind data and pass it from one task to the next. Element `Task.input.type` is part of an existing definition because parent element `Task.input` requires a cross-version extension.\nElement `Task.input.type` has is mapped to FHIR R4 element `Task.input.type`, but has no comparisons.",
        "min" : 1,
        "max" : "1",
        "base" : {
          "path" : "Extension.extension",
      ...
      },
      {
        ...
        "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Task.input.type"
      },
      {
      ...
      },
      {
        ...
        "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Task.input"
      },
      {
