# ExtensionAppointment_VirtualService - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-Appointment.virtualService)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-Appointment.virtualService.csv), [Excel](../StructureDefinition-ext-R5-Appointment.virtualService.xlsx), [Schematron](../StructureDefinition-ext-R5-Appointment.virtualService.sch) 
...
```json
{
  ...
  "version" : "0.1.0",
  "name" : "ExtensionAppointment_VirtualService",
  ...
  "description" : "R5: `Appointment.virtualService` (new:VirtualServiceDetail)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Appointment.virtualService"
    },
    {
