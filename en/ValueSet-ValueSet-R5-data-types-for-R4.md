# ValueSetR5DataTypesForR4 - FHIR Cross-Version Extensions package to use FHIR R5 in FHIR R4 v0.0.1-snapshot-3
...
| | |
| :--- | :--- |
| This cross-version ValueSet represents content from http://hl7.org/fhir/ValueSet/data-types | 5.0.0 for use in FHIR R4 that is appropriate for use but unavailable in`http://hl7.org/fhir/ValueSet/data-types|4.0.1`. |
...
```json
{
  ...
  "id" : "ValueSet-R5-data-types-for-R4",
  "extension" : [
    {
  ...
  "url" : "http://hl7.org/fhir/5.0/ValueSet/ValueSet-R5-data-types-for-R4",
  "version" : "0.0.1-snapshot-3",
  "name" : "ValueSetR5DataTypesForR4",
  ...
  "description" : "This cross-version ValueSet represents content from http://hl7.org/fhir/ValueSet/data-types|5.0.0 for use in FHIR R4 that is appropriate for use but unavailable in `http://hl7.org/fhir/ValueSet/data-types|4.0.1`.",
  "jurisdiction" : [
    {
      "coding" : [
        {
