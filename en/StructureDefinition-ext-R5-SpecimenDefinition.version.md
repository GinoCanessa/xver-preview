# ExtensionSpecimenDefinition_Version - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Business version of the SpecimenDefinition (new) 
...
```json
{
  ...
  "title" : "R5: Business version of the SpecimenDefinition (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `SpecimenDefinition.version` (new:string)",
  "jurisdiction" : [{
    "coding" : [{
