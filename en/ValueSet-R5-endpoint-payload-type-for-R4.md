# R5EndpointPayloadTypeForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
* [R5: The type of content that may be used at this endpoint (e.g. XDS Discharge summaries) (new)](StructureDefinition-ext-R5-Endpoint.pay.type.md)
...
```json
{
  ...
  "id" : "R5-endpoint-payload-type-for-R4",
  "extension" : [{
  ...
  "url" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-endpoint-payload-type-for-R4",
  "version" : "0.1.0",
  "name" : "R5EndpointPayloadTypeForR4",
