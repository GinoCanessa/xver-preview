# R5UnitOfPresentationForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
* [R5: The presentation type in which this item is given to a patient. e.g. for a spray - 'puff' (new)](StructureDefinition-ext-R5-APD.unitOfPresentation.md)
* [R5: The “real-world” units in which the quantity of the item is described (new)](StructureDefinition-ext-R5-ManufacturedItemDefinition.unitOfPresentation.md)
...
```json
{
  ...
  "id" : "R5-unit-of-presentation-for-R4",
  "extension" : [{
  ...
  "url" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-unit-of-presentation-for-R4",
  "version" : "0.1.0",
  "name" : "R5UnitOfPresentationForR4",
