# ExtensionDevice_Gateway - FHIR Cross-Version Extensions package to use FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## Extension: Cross-version Extension `R5.Device.gateway` for use in FHIR R4 

This cross-version extension represents the FHIR R5 element `Device.gateway` for use in FHIR R4.
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-Device.gateway)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-Device.gateway.csv), [Excel](../StructureDefinition-ext-R5-Device.gateway.xlsx), [Schematron](../StructureDefinition-ext-R5-Device.gateway.sch) 
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Device.gateway",
  "version" : "0.0.1-snapshot-3",
  "name" : "ExtensionDevice_Gateway",
  "title" : "Cross-version Extension `R5.Device.gateway` for use in FHIR R4",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "This cross-version extension represents the FHIR R5 element `Device.gateway` for use in FHIR R4.",
  "jurisdiction" : [
    {
      "coding" : [
        {
  ...
  "purpose" : "This extension is part of the cross-version definitions generated to enable use of the\r\nelement `Device.gateway` as defined in FHIR R5\r\nin FHIR R4.\r\n\r\nThe source element is defined as:\r\n`Device.gateway` 0..* `CodeableReference(http://hl7.org/fhir/StructureDefinition/Device)`\r\n\r\nAcross FHIR versions, the element set has been mapped as:\r\n*  R5: `Device.gateway` 0..* `CodeableReference(http://hl7.org/fhir/StructureDefinition/Device)`\r\n\r\nFollowing are the generation technical comments:\r\nElement `Device.gateway` is will have a context of Device based on following the parent source element upwards and mapping to `Device`.",
  "fhirVersion" : "4.0.1",
  "mapping" : [
    {
      "identity" : "rim",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Device.gateway"
      },
      {
