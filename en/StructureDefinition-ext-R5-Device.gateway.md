# ExtensionDevice_Gateway - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Linked device acting as a communication/data collector, translator or controller (new) 

R5: `Device.gateway` (new:CodeableReference(Device))
...
```json
{
  ...
  "title" : "R5: Linked device acting as a communication/data collector, translator or controller (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Device.gateway` (new:CodeableReference(Device))",
  "jurisdiction" : [{
    "coding" : [{
