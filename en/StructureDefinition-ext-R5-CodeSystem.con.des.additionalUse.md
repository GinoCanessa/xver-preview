# ExtensionCodeSystem_Concept_Designation_AdditionalUse - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Additional ways how this designation would be used (new) 

R5: `CodeSystem.concept.designation.additionalUse` (new:Coding)
...
```json
{
  ...
  "description" : "R5: `CodeSystem.concept.designation.additionalUse` (new:Coding)",
  "jurisdiction" : [{
    "coding" : [{
