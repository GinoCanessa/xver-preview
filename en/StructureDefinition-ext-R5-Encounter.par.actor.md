# ExtensionEncounter_Participant_Actor - FHIR Cross-Version Extensions package to use FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## Extension: Cross-version Extension `R5.Encounter.participant.actor` for use in FHIR R4 

This cross-version extension represents the FHIR R5 element `Encounter.participant.actor` for use in FHIR R4.
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-Encounter.par.actor)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-Encounter.par.actor.csv), [Excel](../StructureDefinition-ext-R5-Encounter.par.actor.xlsx), [Schematron](../StructureDefinition-ext-R5-Encounter.par.actor.sch) 
...
```json
{
  ...
  "name" : "ExtensionEncounter_Participant_Actor",
  "title" : "Cross-version Extension `R5.Encounter.participant.actor` for use in FHIR R4",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "This cross-version extension represents the FHIR R5 element `Encounter.participant.actor` for use in FHIR R4.",
  "jurisdiction" : [
    {
      "coding" : [
        {
  ...
  "purpose" : "This extension is part of the cross-version definitions generated to enable use of the\r\nelement `Encounter.participant.actor` as defined in FHIR R5\r\nin FHIR R4.\r\n\r\nThe source element is defined as:\r\n`Encounter.participant.actor` 0..1 `Reference(http://hl7.org/fhir/StructureDefinition/Patient,http://hl7.org/fhir/StructureDefinition/Group,http://hl7.org/fhir/StructureDefinition/RelatedPerson,http://hl7.org/fhir/StructureDefinition/Practitioner,http://hl7.org/fhir/StructureDefinition/PractitionerRole,http://hl7.org/fhir/StructureDefinition/Device,http://hl7.org/fhir/StructureDefinition/HealthcareService)`\r\n\r\nAcross FHIR versions, the element set has been mapped as:\r\n*  R5: `Encounter.participant.actor` 0..1 `Reference(http://hl7.org/fhir/StructureDefinition/Patient,http://hl7.org/fhir/StructureDefinition/Group,http://hl7.org/fhir/StructureDefinition/RelatedPerson,http://hl7.org/fhir/StructureDefinition/Practitioner,http://hl7.org/fhir/StructureDefinition/PractitionerRole,http://hl7.org/fhir/StructureDefinition/Device,http://hl7.org/fhir/StructureDefinition/HealthcareService)`\n*  R4B: `Encounter.participant.individual` 0..1 `Reference(http://hl7.org/fhir/StructureDefinition/Practitioner,http://hl7.org/fhir/StructureDefinition/PractitionerRole,http://hl7.org/fhir/StructureDefinition/RelatedPerson)`\n*  R4: `Encounter.participant.individual` 0..1 `Reference(http://hl7.org/fhir/StructureDefinition/Practitioner,http://hl7.org/fhir/StructureDefinition/PractitionerRole,http://hl7.org/fhir/StructureDefinition/RelatedPerson)`\r\n\r\nFollowing are the generation technical comments:\r\nElement `Encounter.participant.actor` is mapped to FHIR R4 element `Encounter.participant.individual`.",
  "fhirVersion" : "4.0.1",
  "mapping" : [
    {
      "identity" : "rim",
