# ExtensionProcedure_Focus - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Who is the target of the procedure when it is not the subject of record only (new) 
...
```json
{
  ...
  "title" : "R5: Who is the target of the procedure when it is not the subject of record only (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Procedure.focus` (new:Reference(Patient,Group,RelatedPerson,Practitioner,Organization,CareTeam,PractitionerRole,Specimen))",
  "jurisdiction" : [{
    "coding" : [{
