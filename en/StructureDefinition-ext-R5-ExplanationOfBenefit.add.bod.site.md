# ExtensionExplanationOfBenefit_AddItem_BodySite_Site - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Location (new) 

R5: `ExplanationOfBenefit.addItem.bodySite.site` (new:CodeableReference(BodyStructure))
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-ExplanationOfBenefit.add.bod.site)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-ExplanationOfBenefit.add.bod.site.csv), [Excel](../StructureDefinition-ext-R5-ExplanationOfBenefit.add.bod.site.xlsx), [Schematron](../StructureDefinition-ext-R5-ExplanationOfBenefit.add.bod.site.sch) 
...
```json
{
  ...
  "id" : "ext-R5-ExplanationOfBenefit.add.bod.site",
  "extension" : [{
  ...
  "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-ExplanationOfBenefit.addItem.bodySite.site",
  "version" : "0.1.0",
  "name" : "ExtensionExplanationOfBenefit_AddItem_BodySite_Site",
  ...
  "description" : "R5: `ExplanationOfBenefit.addItem.bodySite.site` (new:CodeableReference(BodyStructure))",
  "jurisdiction" : [{
    "coding" : [{
