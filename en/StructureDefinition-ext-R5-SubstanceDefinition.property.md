...
This cross-version extension represents the FHIR R5 element `SubstanceDefinition.property` for use in FHIR R4.
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-SubstanceDefinition.property)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-SubstanceDefinition.property.csv), [Excel](../StructureDefinition-ext-R5-SubstanceDefinition.property.xlsx), [Schematron](../StructureDefinition-ext-R5-SubstanceDefinition.property.sch) 
...
```json
{
  ...
  "id" : "ext-R5-SubstanceDefinition.property",
  "extension" : [
    {
  ...
  "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-SubstanceDefinition.property",
  "version" : "0.0.1-snapshot-3",
  "name" : "ExtensionSubstanceDefinition_Property",
  ...
  "description" : "This cross-version extension represents the FHIR R5 element `SubstanceDefinition.property` for use in FHIR R4.",
  "jurisdiction" : [
    {
      "coding" : [
        {
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-SubstanceDefinition.property"
      },
      {
