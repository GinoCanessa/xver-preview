# R5ItemTypeForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-item-type-for-R4",
  "version" : "0.0.1-snapshot-3",
  "name" : "R5ItemTypeForR4",
