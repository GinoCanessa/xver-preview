# ExtensionAuditEvent_Outcome_Detail - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Additional outcome detail (new) 

R5: `AuditEvent.outcome.detail` (new:CodeableConcept)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-AuditEvent.out.detail)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-AuditEvent.out.detail.csv), [Excel](../StructureDefinition-ext-R5-AuditEvent.out.detail.xlsx), [Schematron](../StructureDefinition-ext-R5-AuditEvent.out.detail.sch) 
...
```json
{
  ...
  "id" : "ext-R5-AuditEvent.out.detail",
  "extension" : [{
  ...
  "version" : "0.1.0",
  "name" : "ExtensionAuditEvent_Outcome_Detail",
  "title" : "R5: Additional outcome detail (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `AuditEvent.outcome.detail` (new:CodeableConcept)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        ...
        "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-audit-event-outcome-detail-for-R4|0.1.0"
      }
    }]
  }
}
