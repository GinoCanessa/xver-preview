# ExtensionEpisodeOfCare_Diagnosis - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## Extension: Cross-version Extension `R5.EpisodeOfCare.diagnosis` for use in FHIR R4 

This cross-version extension represents the FHIR R5 element `EpisodeOfCare.diagnosis` for use in FHIR R4.
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-EpisodeOfCare.diagnosis)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-EpisodeOfCare.diagnosis.csv), [Excel](../StructureDefinition-ext-R5-EpisodeOfCare.diagnosis.xlsx), [Schematron](../StructureDefinition-ext-R5-EpisodeOfCare.diagnosis.sch) 
...
```json
{
  ...
  "id" : "ext-R5-EpisodeOfCare.diagnosis",
  "extension" : [
    {
  ...
  "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-EpisodeOfCare.diagnosis",
  "version" : "0.0.1-snapshot-3",
  "name" : "ExtensionEpisodeOfCare_Diagnosis",
  "title" : "Cross-version Extension `R5.EpisodeOfCare.diagnosis` for use in FHIR R4",
  "status" : "active",
  "experimental" : false,
  ...
  "purpose" : "This extension is part of the cross-version definitions generated to enable use of the\r\nelement `EpisodeOfCare.diagnosis` as defined in FHIR R5\r\nin FHIR R4.\r\n\r\nThe source element is defined as:\r\n`EpisodeOfCare.diagnosis` 0..* `BackboneElement`\r\n\r\nAcross FHIR versions, the element set has been mapped as:\r\n*  R5: `EpisodeOfCare.diagnosis` 0..* `BackboneElement`\n*  R4B: `EpisodeOfCare.diagnosis` 0..* `BackboneElement`\n*  R4: `EpisodeOfCare.diagnosis` 0..* `BackboneElement`\r\n\r\nFollowing are the generation technical comments:\r\nElement `EpisodeOfCare.diagnosis` has is mapped to FHIR R4 element `EpisodeOfCare.diagnosis`, but has no comparisons.",
  "fhirVersion" : "4.0.1",
  "mapping" : [
    {
      "identity" : "rim",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "requirements" : "Element `EpisodeOfCare.diagnosis.condition` is part of an existing definition because parent element `EpisodeOfCare.diagnosis` requires a cross-version extension.\nElement `EpisodeOfCare.diagnosis.condition` has is mapped to FHIR R4 element `EpisodeOfCare.diagnosis.condition`, but has no comparisons.",
        "min" : 0,
        "max" : "*",
        "base" : {
          "path" : "Extension.extension",
      ...
      },
      {
        ...
        "requirements" : "Element `EpisodeOfCare.diagnosis.use` is part of an existing definition because parent element `EpisodeOfCare.diagnosis` requires a cross-version extension.\nElement `EpisodeOfCare.diagnosis.use` has is mapped to FHIR R4 element `EpisodeOfCare.diagnosis.role`, but has no comparisons.",
        "min" : 0,
        "max" : "1",
        "base" : {
          "path" : "Extension.extension",
      ...
      },
      {
        ...
        "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-EpisodeOfCare.diagnosis.use"
      },
      {
      ...
      },
      {
        ...
        "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-EpisodeOfCare.diagnosis"
      },
      {
