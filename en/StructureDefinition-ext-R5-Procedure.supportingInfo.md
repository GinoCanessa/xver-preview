# ExtensionProcedure_SupportingInfo - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Extra information relevant to the procedure (new) 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-Procedure.supportingInfo)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-Procedure.supportingInfo.csv), [Excel](../StructureDefinition-ext-R5-Procedure.supportingInfo.xlsx), [Schematron](../StructureDefinition-ext-R5-Procedure.supportingInfo.sch) 
...
```json
{
  ...
  "id" : "ext-R5-Procedure.supportingInfo",
  "extension" : [{
  ...
  "version" : "0.1.0",
  "name" : "ExtensionProcedure_SupportingInfo",
  "title" : "R5: Extra information relevant to the procedure (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Procedure.supportingInfo` (new:Reference(Resource))",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Procedure.supportingInfo"
    },
    {
