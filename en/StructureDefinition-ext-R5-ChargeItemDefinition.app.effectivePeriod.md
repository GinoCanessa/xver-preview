# ExtensionChargeItemDefinition_Applicability_EffectivePeriod - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: When the charge item definition is expected to be used (new) 

R5: `ChargeItemDefinition.applicability.effectivePeriod` (new:Period)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-ChargeItemDefinition.app.effectivePeriod)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-ChargeItemDefinition.app.effectivePeriod.csv), [Excel](../StructureDefinition-ext-R5-ChargeItemDefinition.app.effectivePeriod.xlsx), [Schematron](../StructureDefinition-ext-R5-ChargeItemDefinition.app.effectivePeriod.sch) 
...
```json
{
  ...
  "id" : "ext-R5-ChargeItemDefinition.app.effectivePeriod",
  "extension" : [{
  ...
  "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-ChargeItemDefinition.applicability.effectivePeriod",
  "version" : "0.1.0",
  "name" : "ExtensionChargeItemDefinition_Applicability_EffectivePeriod",
  "title" : "R5: When the charge item definition is expected to be used (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `ChargeItemDefinition.applicability.effectivePeriod` (new:Period)",
  "jurisdiction" : [{
    "coding" : [{
