# ExtensionElementDefinition_Pattern - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: pattern additional types 

R5: `ElementDefinition.pattern[x]` additional types (CodeableReference, RatioRange, Availability, ExtendedContactDetail)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-ElementDefinition.pattern)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-ElementDefinition.pattern.csv), [Excel](../StructureDefinition-ext-R5-ElementDefinition.pattern.xlsx), [Schematron](../StructureDefinition-ext-R5-ElementDefinition.pattern.sch) 
...
```json
{
  ...
  "description" : "R5: `ElementDefinition.pattern[x]` additional types (CodeableReference, RatioRange, Availability, ExtendedContactDetail)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    "element" : [{
      ...
      "definition" : "R5: `ElementDefinition.pattern[x]` additional types (CodeableReference, RatioRange, Availability, ExtendedContactDetail)",
      "comment" : "Element `ElementDefinition.pattern[x]` is mapped to FHIR R4 element `ElementDefinition.pattern[x]` as `RelatedTo`.\nThe mappings for `ElementDefinition.pattern[x]` do not cover the following types: Availability, CodeableReference, ExtendedContactDetail, RatioRange.\nThe target context `ElementDefinition.pattern[x]` is a choice-type element and cannot directly hold extensions. The context is moved up to parent element `ElementDefinition`.\nMostly used for fixing values of CodeableConcept. In general, pattern[x] is not intended for use with primitive types, where is has the same meaning as fixed[x].",
      "min" : 0,
      "max" : "1",
      "base" : {
        "path" : "Extension",
