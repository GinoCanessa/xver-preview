# ExtensionDiagnosticReport_Note - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Comments about the diagnostic report (new) 
...
```json
{
  ...
  "title" : "R5: Comments about the diagnostic report (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `DiagnosticReport.note` (new:Annotation)",
  "jurisdiction" : [{
    "coding" : [{
