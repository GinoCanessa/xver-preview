# ProfileSubstanceProtein - FHIR Cross-Version Extensions package to use FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## Resource Profile: ProfileSubstanceProtein 
...
* Refer to this Profile: [Cross-version Extension `R5.SubstanceDefinition.protein` for use in FHIR R4](StructureDefinition-ext-R5-SubstanceDefinition.protein.md)
...
```json
{
  ...
  "differential" : {
    "element" : [
      ...
      {
        "id" : "Basic.extension:SubstanceProtein",
        "path" : "Basic.extension",
        "sliceName" : "SubstanceProtein",
        "short" : "Cross-version extension for SubstanceProtein from R5 for use in FHIR R4",
        "min" : 1,
        "max" : "1",
        "base" : {
          "path" : "DomainResource.extension",
        ...
        "type" : [
          {
            "code" : "Extension",
            "profile" : [
              "http://hl7.org/fhir/5.0/StructureDefinition/extension-SubstanceProtein|0.0.1-snapshot-3"
            ]
          }
        ]
      },
