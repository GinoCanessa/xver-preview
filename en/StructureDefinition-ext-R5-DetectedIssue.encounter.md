# ExtensionDetectedIssue_Encounter - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Encounter detected issue is part of (new) 
...
```json
{
  ...
  "title" : "R5: Encounter detected issue is part of (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `DetectedIssue.encounter` (new:Reference(Encounter))",
  "jurisdiction" : [{
    "coding" : [{
