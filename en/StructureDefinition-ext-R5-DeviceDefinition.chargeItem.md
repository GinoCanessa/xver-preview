...
This cross-version extension represents the FHIR R5 element `DeviceDefinition.chargeItem` for use in FHIR R4.
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-DeviceDefinition.chargeItem)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-DeviceDefinition.chargeItem.csv), [Excel](../StructureDefinition-ext-R5-DeviceDefinition.chargeItem.xlsx), [Schematron](../StructureDefinition-ext-R5-DeviceDefinition.chargeItem.sch) 
...
```json
{
  ...
  "id" : "ext-R5-DeviceDefinition.chargeItem",
  "extension" : [
    {
  ...
  "name" : "ExtensionDeviceDefinition_ChargeItem",
  ...
  "description" : "This cross-version extension represents the FHIR R5 element `DeviceDefinition.chargeItem` for use in FHIR R4.",
  "jurisdiction" : [
    {
      "coding" : [
        {
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "requirements" : "Element `DeviceDefinition.chargeItem.chargeItemCode` has a context of DeviceDefinition based on following the parent source element upwards and mapping to `DeviceDefinition`.",
        "min" : 1,
        "max" : "1",
        "base" : {
          "path" : "Extension.extension",
      ...
      {
        "id" : "Extension.extension:chargeItemCode.extension:_datatype",
        "path" : "Extension.extension.extension",
        "sliceName" : "_datatype",
      ...
      {
        "id" : "Extension.extension:chargeItemCode.extension:_datatype.url",
      ...
      {
        "id" : "Extension.extension:chargeItemCode.extension:_datatype.value[x]",
      ...
      },
      {
        ...
        "requirements" : "Element `DeviceDefinition.chargeItem.count` has a context of DeviceDefinition based on following the parent source element upwards and mapping to `DeviceDefinition`.",
        "min" : 1,
        "max" : "1",
        "base" : {
          "path" : "Extension.extension",
      ...
      },
      {
        ...
        "requirements" : "Element `DeviceDefinition.chargeItem.effectivePeriod` has a context of DeviceDefinition based on following the parent source element upwards and mapping to `DeviceDefinition`.",
        "min" : 0,
        "max" : "1",
        "base" : {
          "path" : "Extension.extension",
      ...
      },
      {
        ...
        "requirements" : "Element `DeviceDefinition.chargeItem.useContext` has a context of DeviceDefinition based on following the parent source element upwards and mapping to `DeviceDefinition`.",
        "min" : 0,
        "max" : "*",
        "base" : {
          "path" : "Extension.extension",
      ...
      },
      {
        ...
        "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-DeviceDefinition.chargeItem"
      },
      {
