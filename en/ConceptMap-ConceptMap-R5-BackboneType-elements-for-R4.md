# ConceptMapR5BackboneTypeElementsForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3
...
```json
{
  ...
  "status" : "active",
  "experimental" : false,
  "date" : "2026-02-17T14:42:26.9960652-06:00",
  "contact" : [
    {
          ...
          "target" : [
            {
              ...
              "comment" : "Element `BackboneType` is not mapped to FHIR R4, since FHIR R5 `BackboneType` is not mapped."
            }
          ]
        }
      ]
