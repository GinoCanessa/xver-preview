# ExtensionProcedure_Performer_Period - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: When the performer performed the procedure (new) 
...
```json
{
  ...
  "title" : "R5: When the performer performed the procedure (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Procedure.performer.period` (new:Period)",
  "jurisdiction" : [{
    "coding" : [{
