  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "requirements" : "Element `Account.balance.aggregate` has a context of Account based on following the parent source element upwards and mapping to `Account`.",
        "min" : 0,
        "max" : "1",
        "base" : {
          "path" : "Extension.extension",
      ...
      },
      {
        ...
        "binding" : {
          ...
          "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-account-aggregate-for-R4|0.0.1-snapshot-3"
        }
      },
      {
        ...
        "requirements" : "Element `Account.balance.term` has a context of Account based on following the parent source element upwards and mapping to `Account`.",
        "min" : 0,
        "max" : "1",
        "base" : {
          "path" : "Extension.extension",
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "extensible",
          "description" : "Indicates the balance was outstanding at the given age.",
          "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-account-balance-term-for-R4|0.0.1-snapshot-3"
        }
      },
      {
        ...
        "requirements" : "Element `Account.balance.estimate` has a context of Account based on following the parent source element upwards and mapping to `Account`.",
        "min" : 0,
        "max" : "1",
        "base" : {
          "path" : "Extension.extension",
      ...
      },
      {
        ...
        "requirements" : "Element `Account.balance.amount` has a context of Account based on following the parent source element upwards and mapping to `Account`.",
        "min" : 1,
        "max" : "1",
        "base" : {
          "path" : "Extension.extension",
