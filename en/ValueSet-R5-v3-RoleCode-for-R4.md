# R5V3RoleCodeForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## ValueSet: Cross-version ValueSet R5.RoleCode for use in FHIR R4 
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-v3-RoleCode-for-R4",
  "version" : "0.0.1-snapshot-3",
  "name" : "R5V3RoleCodeForR4",
  "title" : "Cross-version ValueSet R5.RoleCode for use in FHIR R4",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "This cross-version ValueSet represents content from `http://terminology.hl7.org/ValueSet/v3-RoleCode|2.0.0` for use in FHIR R4.",
  "jurisdiction" : [
    {
      "coding" : [
        {
