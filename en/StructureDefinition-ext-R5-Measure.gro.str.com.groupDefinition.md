# ExtensionMeasure_Group_Stratifier_Component_GroupDefinition - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: A group resource that defines this population (new) 

R5: `Measure.group.stratifier.component.groupDefinition` (new:Reference(Group))
...
```json
{
  ...
  "description" : "R5: `Measure.group.stratifier.component.groupDefinition` (new:Reference(Group))",
  "jurisdiction" : [{
    "coding" : [{
