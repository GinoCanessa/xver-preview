...
A computable version of the following element information is available in: [ConceptMapR5ConditionElementsForR4Condition](ConceptMap-ConceptMap-R5-Condition-elements-for-R4-Condition.md)
