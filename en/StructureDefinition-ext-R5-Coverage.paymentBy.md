# ExtensionCoverage_PaymentBy - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Self-pay parties and responsibility (new) 

R5: `Coverage.paymentBy` (new:BackboneElement)
...
```json
{
  ...
  "title" : "R5: Self-pay parties and responsibility (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Coverage.paymentBy` (new:BackboneElement)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "path" : "Extension.extension",
      "sliceName" : "party",
      "short" : "R5: Parties performing self-payment (new)",
      "definition" : "R5: `Coverage.paymentBy.party` (new:Reference(Patient,RelatedPerson,Organization))",
    ...
    },
    {
      ...
      "short" : "R5: Party's responsibility (new)",
      "definition" : "R5: `Coverage.paymentBy.responsibility` (new:string)",
