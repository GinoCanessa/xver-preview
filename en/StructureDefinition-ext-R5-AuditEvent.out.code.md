# ExtensionAuditEvent_Outcome_Code - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Whether the event succeeded or failed (new) 

R5: `AuditEvent.outcome.code` (new:Coding)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-AuditEvent.out.code)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-AuditEvent.out.code.csv), [Excel](../StructureDefinition-ext-R5-AuditEvent.out.code.xlsx), [Schematron](../StructureDefinition-ext-R5-AuditEvent.out.code.sch) 
...
```json
{
  ...
  "version" : "0.1.0",
  "name" : "ExtensionAuditEvent_Outcome_Code",
  "title" : "R5: Whether the event succeeded or failed (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `AuditEvent.outcome.code` (new:Coding)",
  "jurisdiction" : [{
    "coding" : [{
