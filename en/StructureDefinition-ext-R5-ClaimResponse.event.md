# ExtensionClaimResponse_Event - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
```json
{
  ...
  "description" : "R5: `ClaimResponse.event` (new:BackboneElement)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "definition" : "R5: `ClaimResponse.event.type` (new:CodeableConcept)",
    ...
    },
    {
      ...
      "definition" : "R5: `ClaimResponse.event.when[x]` (new:dateTime, Period)",
