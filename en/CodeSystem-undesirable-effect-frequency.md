# UndesirablEffectFrequency - FHIR Cross-Version Extensions package to use FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## CodeSystem: UndesirablEffectFrequency 
...
* [ValueSetR5UndesirableEffectFrequencyForR4](ValueSet-ValueSet-R5-undesirable-effect-frequency-for-R4.md)
...
```json
{
  ...
  "title" : "Undesirabl Effect Frequency",
  "status" : "active",
  "experimental" : false,
