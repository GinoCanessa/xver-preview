...
### Lookup for FHIR R5 ArtifactAssessment for use in FHIR R4

The FHIR R5 resource is represented in FHIR R4 via the Basic resource.

Note that there is a profile defined to simplify use of this cross-version resource representation:[Profile: ArtifactAssessment](StructureDefinition-profile-ArtifactAssessment.md)

A computable version of the following element information is available in: [ConceptMapR5ArtifactAssessmentElementsForR4](ConceptMap-ConceptMap-R5-ArtifactAssessment-elements-for-R4.md)
