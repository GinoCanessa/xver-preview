# ExtensionImmunization_InformationSource - FHIR Cross-Version Extensions package to use FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## Extension: Cross-version Extension `R5.Immunization.informationSource` for use in FHIR R4 

This cross-version extension represents the FHIR R5 element `Immunization.informationSource` for use in FHIR R4.
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-Immunization.informationSource)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-Immunization.informationSource.csv), [Excel](../StructureDefinition-ext-R5-Immunization.informationSource.xlsx), [Schematron](../StructureDefinition-ext-R5-Immunization.informationSource.sch) 
...
```json
{
  ...
  "id" : "ext-R5-Immunization.informationSource",
  "extension" : [
    {
  ...
  "name" : "ExtensionImmunization_InformationSource",
  "title" : "Cross-version Extension `R5.Immunization.informationSource` for use in FHIR R4",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "This cross-version extension represents the FHIR R5 element `Immunization.informationSource` for use in FHIR R4.",
  "jurisdiction" : [
    {
      "coding" : [
        {
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "preferred",
          "valueSet" : "http://hl7.org/fhir/5.0/ValueSet/ValueSet-R5-immunization-origin-for-R4"
        }
      },
      {
      ...
      },
      {
        ...
        "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Immunization.informationSource"
      },
      {
