# ExtensionImmunization_InformationSource - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Indicates the source of a reported record (new) 
...
```json
{
  ...
  "title" : "R5: Indicates the source of a  reported record (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Immunization.informationSource` (new:CodeableReference(Patient,Practitioner,PractitionerRole,RelatedPerson,Organization))",
  "jurisdiction" : [{
    "coding" : [{
