# ExtensionActivityDefinition_ObservationResultRequirement - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: observationResultRequirement additional types 

R5: `ActivityDefinition.observationResultRequirement` additional types (canonical(http://hl7.org/fhir/StructureDefinition/ObservationDefinition)) additional types from child elements (value)
...
```json
{
  ...
  "title" : "R5: observationResultRequirement additional types",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `ActivityDefinition.observationResultRequirement` additional types (canonical(http://hl7.org/fhir/StructureDefinition/ObservationDefinition)) additional types from child elements (value)",
  "jurisdiction" : [{
    "coding" : [{
