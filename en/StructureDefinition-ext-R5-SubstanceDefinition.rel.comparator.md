# ExtensionSubstanceDefinition_Relationship_Comparator - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: An operator for the amount, for example "average", "approximately", "less than" (new) 

R5: `SubstanceDefinition.relationship.comparator` (new:CodeableConcept)
...
```json
{
  ...
  "title" : "R5: An operator for the amount, for example \"average\", \"approximately\", \"less than\" (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `SubstanceDefinition.relationship.comparator` (new:CodeableConcept)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        ...
        "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-substance-amount-type-for-R4|0.1.0"
      }
    }]
  }
}
