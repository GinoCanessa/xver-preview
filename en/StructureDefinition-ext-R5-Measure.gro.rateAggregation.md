# ExtensionMeasure_Group_RateAggregation - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: How is rate aggregation performed for this measure (new) 
...
```json
{
  ...
  "title" : "R5: How is rate aggregation performed for this measure (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Measure.group.rateAggregation` (new:markdown)",
  "jurisdiction" : [{
    "coding" : [{
