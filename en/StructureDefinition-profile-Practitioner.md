...
```json
{
  ...
  "differential" : {
    "element" : [
      ...
      {
        "id" : "Practitioner.communication.extension:communication",
        "path" : "Practitioner.communication.extension",
        ...
        "type" : [
          {
            "code" : "Extension",
            "profile" : [
              "http://hl7.org/fhir/5.0/StructureDefinition/extension-Practitioner.communication|0.0.1-snapshot-3"
            ]
          }
        ]
      }
