# ExtensionDeviceDefinition_Property_Value - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Value of the property additional types 
...
```json
{
  ...
  "title" : "R5: Value of the property additional types",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `DeviceDefinition.property.value[x]` additional types (string, boolean, integer, Range, Attachment)",
  "jurisdiction" : [{
    "coding" : [{
