# ExtensionRequestOrchestration_Action_Location - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
```json
{
  ...
  "description" : "R5: `RequestOrchestration.action.location` (new:CodeableReference(Location))",
  "jurisdiction" : [{
    "coding" : [{
