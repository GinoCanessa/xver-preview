# ExtensionRequestOrchestration_Action_Location - FHIR Cross-Version Extensions package to use FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## Extension: Cross-version Extension `R5.RequestOrchestration.action.location` for use in FHIR R4 

This cross-version extension represents the FHIR R5 element `RequestOrchestration.action.location` for use in FHIR R4.
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-RequestOrchestration.act.location)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-RequestOrchestration.act.location.csv), [Excel](../StructureDefinition-ext-R5-RequestOrchestration.act.location.xlsx), [Schematron](../StructureDefinition-ext-R5-RequestOrchestration.act.location.sch) 
...
```json
{
  ...
  "id" : "ext-R5-RequestOrchestration.act.location",
  "extension" : [
    {
  ...
  "title" : "Cross-version Extension `R5.RequestOrchestration.action.location` for use in FHIR R4",
  "status" : "active",
  "experimental" : false,
