# StatisticStatisticType - FHIR Cross-Version Extensions package to use FHIR R5 in FHIR R4 v0.0.1-snapshot-3
...
* [ValueSetR5StatisticTypeForR4](ValueSet-ValueSet-R5-statistic-type-for-R4.md)
...
```json
{
  ...
  "caseSensitive" : true,
  "valueSet" : "http://terminology.hl7.org/ValueSet/statistic-type|1.0.1",
  "content" : "complete",
  "concept" : [
    {
