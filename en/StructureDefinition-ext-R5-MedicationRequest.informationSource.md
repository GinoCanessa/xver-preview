# ExtensionMedicationRequest_InformationSource - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: The person or organization who provided the information about this request, if the source is someone other than the requestor (new) 

R5: `MedicationRequest.informationSource` (new:Reference(Patient,Practitioner,PractitionerRole,RelatedPerson,Organization))
...
```json
{
  ...
  "title" : "R5: The person or organization who provided the information about this request, if the source is someone other than the requestor (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `MedicationRequest.informationSource` (new:Reference(Patient,Practitioner,PractitionerRole,RelatedPerson,Organization))",
  "jurisdiction" : [{
    "coding" : [{
