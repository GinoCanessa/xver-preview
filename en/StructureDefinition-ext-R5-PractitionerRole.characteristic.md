# ExtensionPractitionerRole_Characteristic - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Collection of characteristics (attributes) (new) 

R5: `PractitionerRole.characteristic` (new:CodeableConcept)
...
```json
{
  ...
  "description" : "R5: `PractitionerRole.characteristic` (new:CodeableConcept)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        ...
        "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-service-mode-for-R4|0.1.0"
      }
    }]
  }
}
