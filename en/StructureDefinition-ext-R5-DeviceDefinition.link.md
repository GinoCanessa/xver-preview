# ExtensionDeviceDefinition_Link - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: An associated device, attached to, used with, communicating with or linking a previous or new device model to the focal device (new) 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-DeviceDefinition.link)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-DeviceDefinition.link.csv), [Excel](../StructureDefinition-ext-R5-DeviceDefinition.link.xlsx), [Schematron](../StructureDefinition-ext-R5-DeviceDefinition.link.sch) 
...
```json
{
  ...
  "id" : "ext-R5-DeviceDefinition.link",
  "extension" : [{
  ...
  "title" : "R5: An associated device, attached to, used with, communicating with or linking a previous or new device model to the focal device (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `DeviceDefinition.link` (new:BackboneElement)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "purpose" : "This extension is part of the cross-version definitions generated to enable use of the\r\nelement `DeviceDefinition.link` as defined in FHIR R5\r\nin FHIR R4.\r\n\r\nThe source element is defined as:\r\n`DeviceDefinition.link` 0..* `BackboneElement`\r\n\r\nAcross FHIR versions, the element set has been mapped as:\r\n*  R5: `DeviceDefinition.link` 0..* `BackboneElement`\r\n\r\nFollowing are the generation technical comments:\r\nElement `DeviceDefinition.link` has a context of DeviceDefinition based on following the parent source element upwards and mapping to `DeviceDefinition`.\nElement `DeviceDefinition.link` has no mapping targets in FHIR R4. Typically, this is because the element has been added (is a new element).",
  "fhirVersion" : "4.0.1",
  "mapping" : [{
    "identity" : "rim",
    "uri" : "http://hl7.org/v3",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "path" : "Extension.extension",
      "sliceName" : "relation",
      "short" : "R5: The type indicates the relationship of the related device to the device instance (new)",
      "definition" : "R5: `DeviceDefinition.link.relation` (new:Coding)",
      ...
      "requirements" : "Element `DeviceDefinition.link.relation` is part of an existing definition because parent element `DeviceDefinition.link` requires a cross-version extension.\nElement `DeviceDefinition.link.relation` has a context of DeviceDefinition based on following the parent source element upwards and mapping to `DeviceDefinition`.\nElement `DeviceDefinition.link.relation` has no mapping targets in FHIR R4. Typically, this is because the element has been added (is a new element).",
      "min" : 1,
      "max" : "1",
      "base" : {
        "path" : "Extension.extension",
    ...
    },
    {
      ...
      "binding" : {
        ...
        "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-devicedefinition-relationtype-for-R4|0.1.0"
      }
    },
    {
      "id" : "Extension.extension:relatedDevice",
      "path" : "Extension.extension",
      "sliceName" : "relatedDevice",
      "short" : "R5: A reference to the linked device (new)",
      "definition" : "R5: `DeviceDefinition.link.relatedDevice` (new:CodeableReference(DeviceDefinition))",
      ...
      "requirements" : "Element `DeviceDefinition.link.relatedDevice` is part of an existing definition because parent element `DeviceDefinition.link` requires a cross-version extension.\nElement `DeviceDefinition.link.relatedDevice` has a context of DeviceDefinition based on following the parent source element upwards and mapping to `DeviceDefinition`.\nElement `DeviceDefinition.link.relatedDevice` has no mapping targets in FHIR R4. Typically, this is because the element has been added (is a new element).",
      "min" : 1,
      "max" : "1",
      "base" : {
        "path" : "Extension.extension",
    ...
    {
      "id" : "Extension.extension:relatedDevice.extension",
    ...
    {
      "id" : "Extension.extension:relatedDevice.extension:_datatype",
      "path" : "Extension.extension.extension",
      "sliceName" : "_datatype",
    ...
    {
      "id" : "Extension.extension:relatedDevice.extension:_datatype.url",
    ...
    {
      "id" : "Extension.extension:relatedDevice.extension:_datatype.value[x]",
    ...
    {
      "id" : "Extension.extension:relatedDevice.extension:concept",
      "path" : "Extension.extension.extension",
      "sliceName" : "concept",
    ...
    {
      "id" : "Extension.extension:relatedDevice.extension:concept.url",
      "path" : "Extension.extension.extension.url",
      "min" : 1,
      "max" : "1",
      "base" : {
    ...
    {
      "id" : "Extension.extension:relatedDevice.extension:concept.value[x]",
      "path" : "Extension.extension.extension.value[x]",
    ...
    {
      "id" : "Extension.extension:relatedDevice.extension:reference",
      "path" : "Extension.extension.extension",
      "sliceName" : "reference",
    ...
    {
      "id" : "Extension.extension:relatedDevice.extension:reference.url",
      "path" : "Extension.extension.extension.url",
      "min" : 1,
      "max" : "1",
      "base" : {
    ...
    {
      "id" : "Extension.extension:relatedDevice.extension:reference.value[x]",
      "path" : "Extension.extension.extension.value[x]",
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["http://hl7.org/fhir/5.0/StructureDefinition/profile-DeviceDefinition|0.1.0",
        "http://hl7.org/fhir/StructureDefinition/DeviceDefinition|4.0.1"]
      }]
    },
    {
      "id" : "Extension.extension:relatedDevice.url",
      "path" : "Extension.extension.url",
      "min" : 1,
      "max" : "1",
      "base" : {
      ...
      "fixedUri" : "relatedDevice"
    },
    {
      "id" : "Extension.extension:relatedDevice.value[x]",
      "path" : "Extension.extension.value[x]",
      "min" : 0,
      "max" : "0",
      "base" : {
    ...
    },
    {
      ...
      "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-DeviceDefinition.link"
    },
    {
