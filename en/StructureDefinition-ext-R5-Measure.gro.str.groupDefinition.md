# ExtensionMeasure_Group_Stratifier_GroupDefinition - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
```json
{
  ...
  "description" : "R5: `Measure.group.stratifier.groupDefinition` (new:Reference(Group))",
  "jurisdiction" : [{
    "coding" : [{
