# ExtensionImmunization_Reason - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Why immunization occurred additional types 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-Immunization.reason)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-Immunization.reason.csv), [Excel](../StructureDefinition-ext-R5-Immunization.reason.xlsx), [Schematron](../StructureDefinition-ext-R5-Immunization.reason.sch) 
...
```json
{
  ...
  "version" : "0.1.0",
  "name" : "ExtensionImmunization_Reason",
  "title" : "R5: Why immunization occurred additional types",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Immunization.reason` additional types (CodeableReference(http://hl7.org/fhir/StructureDefinition/Condition), CodeableReference(http://hl7.org/fhir/StructureDefinition/Observation), CodeableReference(http://hl7.org/fhir/StructureDefinition/DiagnosticReport))",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "purpose" : "This extension is part of the cross-version definitions generated to enable use of the\r\nelement `Immunization.reason` as defined in FHIR R5\r\nin FHIR R4.\r\n\r\nThe source element is defined as:\r\n`Immunization.reason` 0..* `CodeableReference(http://hl7.org/fhir/StructureDefinition/Condition,http://hl7.org/fhir/StructureDefinition/Observation,http://hl7.org/fhir/StructureDefinition/DiagnosticReport)`\r\n\r\nAcross FHIR versions, the element set has been mapped as:\r\n*  R5: `Immunization.reason` 0..* `CodeableReference(http://hl7.org/fhir/StructureDefinition/Condition,http://hl7.org/fhir/StructureDefinition/Observation,http://hl7.org/fhir/StructureDefinition/DiagnosticReport)`\n*  R4B: `Immunization.reasonCode` 0..* `CodeableConcept`\n*  R4: `Immunization.reasonCode` 0..* `CodeableConcept`\r\n\r\nFollowing are the generation technical comments:\r\nElement `Immunization.reason` is mapped to FHIR R4 element `Immunization.reasonCode` as `SourceIsBroaderThanTarget`.\nElement `Immunization.reason` is mapped to FHIR R4 element `Immunization.reasonReference` as `SourceIsBroaderThanTarget`.\nThe mappings for `Immunization.reason` do not cover the following types: CodeableReference.",
  "fhirVersion" : "4.0.1",
  "mapping" : [{
    "identity" : "rim",
    "uri" : "http://hl7.org/v3",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Immunization.reason"
    },
    {
