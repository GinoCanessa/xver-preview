# ExtensionAppointment_Participant_Required - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: The participant is required to attend (optional when false) additional types 
