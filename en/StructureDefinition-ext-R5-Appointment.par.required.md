# ExtensionAppointment_Participant_Required - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## Extension: Cross-version Extension `R5.Appointment.participant.required` for use in FHIR R4 

This cross-version extension represents the FHIR R5 element `Appointment.participant.required` for use in FHIR R4.
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-Appointment.par.required)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-Appointment.par.required.csv), [Excel](../StructureDefinition-ext-R5-Appointment.par.required.xlsx), [Schematron](../StructureDefinition-ext-R5-Appointment.par.required.sch) 
...
```json
{
  ...
  "id" : "ext-R5-Appointment.par.required",
  "extension" : [
    {
  ...
  "title" : "Cross-version Extension `R5.Appointment.participant.required` for use in FHIR R4",
  "status" : "active",
  "experimental" : false,
  ...
  "context" : [
    {
      "type" : "element",
      "expression" : "Appointment.participant.required"
    }
  ],
  "type" : "Extension",
