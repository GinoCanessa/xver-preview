# ExtensionSubscriptionTopic_Url - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Canonical identifier for this subscription topic, represented as an absolute URI (globally unique) (new) 

R5: `SubscriptionTopic.url` (new:uri)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-SubscriptionTopic.url)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-SubscriptionTopic.url.csv), [Excel](../StructureDefinition-ext-R5-SubscriptionTopic.url.xlsx), [Schematron](../StructureDefinition-ext-R5-SubscriptionTopic.url.sch) 
...
```json
{
  ...
  "id" : "ext-R5-SubscriptionTopic.url",
  "extension" : [{
  ...
  "version" : "0.1.0",
  "name" : "ExtensionSubscriptionTopic_Url",
  "title" : "R5: Canonical identifier for this subscription topic, represented as an absolute URI (globally unique) (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `SubscriptionTopic.url` (new:uri)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-SubscriptionTopic.url"
    },
    {
