# R5VersionIndependentAllResourceTypesForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
* [R5: Potential target for the link (new)](StructureDefinition-ext-R5-GraphDefinition.node.md)
