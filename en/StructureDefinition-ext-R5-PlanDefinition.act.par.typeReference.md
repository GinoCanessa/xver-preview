# ExtensionPlanDefinition_Action_Participant_TypeReference - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
```json
{
  ...
  "description" : "R5: `PlanDefinition.action.participant.typeReference` (new:Reference(CareTeam,Device,DeviceDefinition,Endpoint,Group,HealthcareService,Location,Organization,Patient,Practitioner,PractitionerRole,RelatedPerson))",
  "jurisdiction" : [{
    "coding" : [{
