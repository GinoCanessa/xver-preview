# ExtensionDataRequirement_ValueFilter - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: What values are expected (new) 
...
```json
{
  ...
  "title" : "R5: What values are expected (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `DataRequirement.valueFilter` (new:Element)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        ...
        "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-value-filter-comparator-for-R4|0.1.0"
      }
    },
    {
