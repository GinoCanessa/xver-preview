# Lookup for R5EncounterStatusForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
A computable version of the following mapping information is available in: [R5EncounterStatusForR4](ConceptMap-Map-R5-encounter-status-for-R4.md)
