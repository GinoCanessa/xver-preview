# Lookup for ValueSetR5EncounterStatusForR4 - FHIR Cross-Version Extensions package to use FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## Lookup for ValueSetR5EncounterStatusForR4
...
A computable version of the following mapping information is available in: [ValueSetR5EncounterStatusForR4](ConceptMap-R5-encounter-status-for-R4.md)
