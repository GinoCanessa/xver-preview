# ExtensionImagingStudy_Reason - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Why the study was requested / performed additional types 

R5: `ImagingStudy.reason` additional types (CodeableReference(http://hl7.org/fhir/StructureDefinition/Condition), CodeableReference(http://hl7.org/fhir/StructureDefinition/Observation), CodeableReference(http://hl7.org/fhir/StructureDefinition/DiagnosticReport), CodeableReference(http://hl7.org/fhir/StructureDefinition/DocumentReference))
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-ImagingStudy.reason)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-ImagingStudy.reason.csv), [Excel](../StructureDefinition-ext-R5-ImagingStudy.reason.xlsx), [Schematron](../StructureDefinition-ext-R5-ImagingStudy.reason.sch) 
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-ImagingStudy.reason",
  "version" : "0.1.0",
  "name" : "ExtensionImagingStudy_Reason",
  "title" : "R5: Why the study was requested / performed additional types",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `ImagingStudy.reason` additional types (CodeableReference(http://hl7.org/fhir/StructureDefinition/Condition), CodeableReference(http://hl7.org/fhir/StructureDefinition/Observation), CodeableReference(http://hl7.org/fhir/StructureDefinition/DiagnosticReport), CodeableReference(http://hl7.org/fhir/StructureDefinition/DocumentReference))",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "purpose" : "This extension is part of the cross-version definitions generated to enable use of the\r\nelement `ImagingStudy.reason` as defined in FHIR R5\r\nin FHIR R4.\r\n\r\nThe source element is defined as:\r\n`ImagingStudy.reason` 0..* `CodeableReference(http://hl7.org/fhir/StructureDefinition/Condition,http://hl7.org/fhir/StructureDefinition/Observation,http://hl7.org/fhir/StructureDefinition/DiagnosticReport,http://hl7.org/fhir/StructureDefinition/DocumentReference)`\r\n\r\nAcross FHIR versions, the element set has been mapped as:\r\n*  R5: `ImagingStudy.reason` 0..* `CodeableReference(http://hl7.org/fhir/StructureDefinition/Condition,http://hl7.org/fhir/StructureDefinition/Observation,http://hl7.org/fhir/StructureDefinition/DiagnosticReport,http://hl7.org/fhir/StructureDefinition/DocumentReference)`\n*  R4B: `ImagingStudy.reasonCode` 0..* `CodeableConcept`\n*  R4: `ImagingStudy.reasonCode` 0..* `CodeableConcept`\r\n\r\nFollowing are the generation technical comments:\r\nElement `ImagingStudy.reason` is mapped to FHIR R4 element `ImagingStudy.reasonCode` as `SourceIsBroaderThanTarget`.\nElement `ImagingStudy.reason` is mapped to FHIR R4 element `ImagingStudy.reasonReference` as `SourceIsBroaderThanTarget`.\nThe mappings for `ImagingStudy.reason` do not cover the following types: CodeableReference.",
  "fhirVersion" : "4.0.1",
  "mapping" : [{
    "identity" : "rim",
    "uri" : "http://hl7.org/v3",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-ImagingStudy.reason"
    },
    {
