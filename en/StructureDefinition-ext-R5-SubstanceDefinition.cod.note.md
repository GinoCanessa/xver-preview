# ExtensionSubstanceDefinition_Code_Note - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Any comment can be provided in this field (new) 

R5: `SubstanceDefinition.code.note` (new:Annotation)
...
```json
{
  ...
  "title" : "R5: Any comment can be provided in this field (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `SubstanceDefinition.code.note` (new:Annotation)",
  "jurisdiction" : [{
    "coding" : [{
