# ExtensionObservationDefinition_UseContext - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Content intends to support these contexts (new) 
...
```json
{
  ...
  "title" : "R5: Content intends to support these contexts (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `ObservationDefinition.useContext` (new:UsageContext)",
  "jurisdiction" : [{
    "coding" : [{
