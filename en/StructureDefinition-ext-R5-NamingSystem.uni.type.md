# ExtensionNamingSystem_UniqueId_Type - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: oid | uuid | uri | iri-stem | v2csmnemonic | other additional codes 
...
```json
{
  ...
  "title" : "R5: oid | uuid | uri | iri-stem | v2csmnemonic | other additional codes",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `NamingSystem.uniqueId.type` additional codes",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        ...
        "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-namingsystem-identifier-type-for-R4|0.1.0"
      }
    }]
  }
}
