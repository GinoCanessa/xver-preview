# ValueSetR5AssertOperatorCodesForR4 - FHIR Cross-Version Extensions package to use FHIR R5 in FHIR R4 v0.0.1-snapshot-3
...
* [Cross-version Extension `R5.TestScript.setup.action.assert` for use in FHIR R4](StructureDefinition-ext-R5-TestScript.set.act.assert.md)
...
```json
{
  ...
  "id" : "ValueSet-R5-assert-operator-codes-for-R4",
  "extension" : [
    {
  ...
  "url" : "http://hl7.org/fhir/5.0/ValueSet/ValueSet-R5-assert-operator-codes-for-R4",
  "version" : "0.0.1-snapshot-3",
  "name" : "ValueSetR5AssertOperatorCodesForR4",
