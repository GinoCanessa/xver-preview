# ExtensionMedicationKnowledge_MedicineClassification_Source - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: The source of the classification (new) 
...
```json
{
  ...
  "title" : "R5: The source of the classification (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `MedicationKnowledge.medicineClassification.source[x]` (new:string, uri)",
  "jurisdiction" : [{
    "coding" : [{
