# ExtensionNutritionOrder_OralDiet_Schedule_AsNeeded - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-NutritionOrder.ora.sch.asNeeded)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-NutritionOrder.ora.sch.asNeeded.csv), [Excel](../StructureDefinition-ext-R5-NutritionOrder.ora.sch.asNeeded.xlsx), [Schematron](../StructureDefinition-ext-R5-NutritionOrder.ora.sch.asNeeded.sch) 
...
```json
{
  ...
  "id" : "ext-R5-NutritionOrder.ora.sch.asNeeded",
  "extension" : [{
  ...
  "version" : "0.1.0",
  "name" : "ExtensionNutritionOrder_OralDiet_Schedule_AsNeeded",
  ...
  "description" : "R5: `NutritionOrder.oralDiet.schedule.asNeeded` (new:boolean)",
  "jurisdiction" : [{
    "coding" : [{
