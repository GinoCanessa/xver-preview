# ExtensionSubscription_Content - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: empty | id-only | full-resource (new) 
...
```json
{
  ...
  "title" : "R5: empty | id-only | full-resource (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Subscription.content` (new:code)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        ...
        "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-subscription-payload-content-for-R4|0.1.0"
      }
    }]
  }
}
