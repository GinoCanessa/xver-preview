# ExtensionPlanDefinition_Action_Output_Requirement - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-PlanDefinition.act.out.requirement)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-PlanDefinition.act.out.requirement.csv), [Excel](../StructureDefinition-ext-R5-PlanDefinition.act.out.requirement.xlsx), [Schematron](../StructureDefinition-ext-R5-PlanDefinition.act.out.requirement.sch) 
...
```json
{
  ...
  "id" : "ext-R5-PlanDefinition.act.out.requirement",
  "extension" : [{
  ...
  "version" : "0.1.0",
  "name" : "ExtensionPlanDefinition_Action_Output_Requirement",
  ...
  "description" : "R5: `PlanDefinition.action.output.requirement` (new:DataRequirement)",
  "jurisdiction" : [{
    "coding" : [{
