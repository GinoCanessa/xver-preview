# ExtensionClinicalUseDefinition_Interaction - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Specifics for when this is an interaction (new) 

R5: `ClinicalUseDefinition.interaction` (new:BackboneElement)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-ClinicalUseDefinition.interaction)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-ClinicalUseDefinition.interaction.csv), [Excel](../StructureDefinition-ext-R5-ClinicalUseDefinition.interaction.xlsx), [Schematron](../StructureDefinition-ext-R5-ClinicalUseDefinition.interaction.sch) 
...
```json
{
  ...
  "id" : "ext-R5-ClinicalUseDefinition.interaction",
  "extension" : [{
  ...
  "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-ClinicalUseDefinition.interaction",
  "version" : "0.1.0",
  "name" : "ExtensionClinicalUseDefinition_Interaction",
  "title" : "R5: Specifics for when this is an interaction (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `ClinicalUseDefinition.interaction` (new:BackboneElement)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "purpose" : "This extension is part of the cross-version definitions generated to enable use of the\r\nelement `ClinicalUseDefinition.interaction` as defined in FHIR R5\r\nin FHIR R4.\r\n\r\nThe source element is defined as:\r\n`ClinicalUseDefinition.interaction` 0..1 `BackboneElement`\r\n\r\nAcross FHIR versions, the element set has been mapped as:\r\n*  R5: `ClinicalUseDefinition.interaction` 0..1 `BackboneElement`\r\n\r\nFollowing are the generation technical comments:\r\nElement `ClinicalUseDefinition.interaction` is not mapped to FHIR R4, since FHIR R5 `ClinicalUseDefinition` is not mapped.\nElement `ClinicalUseDefinition.interaction` has no mapping targets in FHIR R4. Typically, this is because the element has been added (is a new element).",
  "fhirVersion" : "4.0.1",
  "mapping" : [{
    "identity" : "rim",
    "uri" : "http://hl7.org/v3",
  ...
  "differential" : {
    ...
    {
      "id" : "Extension.extension:interactant",
      "path" : "Extension.extension",
      "sliceName" : "interactant",
      "short" : "R5: The specific medication, product, food etc. or laboratory test that interacts (new)",
      "definition" : "R5: `ClinicalUseDefinition.interaction.interactant` (new:BackboneElement)",
    ...
    {
      "id" : "Extension.extension:interactant.extension",
    ...
    {
      "id" : "Extension.extension:interactant.extension:item",
      "path" : "Extension.extension.extension",
      "sliceName" : "item",
      "short" : "R5: The specific medication, product, food etc. or laboratory test that interacts (new)",
      "definition" : "R5: `ClinicalUseDefinition.interaction.interactant.item[x]` (new:CodeableConcept, Reference(MedicinalProductDefinition,Medication,Substance,NutritionProduct,BiologicallyDerivedProduct,ObservationDefinition))",
    ...
    {
      "id" : "Extension.extension:interactant.extension:item.url",
    ...
    {
      "id" : "Extension.extension:interactant.extension:item.value[x]",
    ...
    {
      "id" : "Extension.extension:interactant.url",
    ...
    {
      "id" : "Extension.extension:interactant.value[x]",
    ...
    },
    {
      ...
      "path" : "Extension.extension",
      "sliceName" : "type",
      "short" : "R5: The type of the interaction e.g. drug-drug interaction, drug-lab test interaction (new)",
      "definition" : "R5: `ClinicalUseDefinition.interaction.type` (new:CodeableConcept)",
    ...
    },
    {
      ...
      "binding" : {
        ...
        "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-interaction-type-for-R4|0.1.0"
      }
    },
    {
      "id" : "Extension.extension:effect",
      "path" : "Extension.extension",
      "sliceName" : "effect",
      "short" : "R5: The effect of the interaction, for example \"reduced gastric absorption of primary medication\" (new)",
      "definition" : "R5: `ClinicalUseDefinition.interaction.effect` (new:CodeableReference(ObservationDefinition))",
    ...
    {
      "id" : "Extension.extension:effect.extension",
      "path" : "Extension.extension.extension",
      "slicing" : {
        "discriminator" : [{
          "type" : "value",
    ...
    {
      "id" : "Extension.extension:effect.extension:_datatype",
      "path" : "Extension.extension.extension",
      "sliceName" : "_datatype",
    ...
    {
      "id" : "Extension.extension:effect.extension:_datatype.url",
      "path" : "Extension.extension.extension.url",
      "min" : 1,
      "max" : "1",
      "base" : {
    ...
    {
      "id" : "Extension.extension:effect.extension:_datatype.value[x]",
      "path" : "Extension.extension.extension.value[x]",
    ...
    {
      "id" : "Extension.extension:effect.extension:concept",
      "path" : "Extension.extension.extension",
      "sliceName" : "concept",
    ...
    {
      "id" : "Extension.extension:effect.extension:concept.url",
      "path" : "Extension.extension.extension.url",
      "min" : 1,
      "max" : "1",
      "base" : {
    ...
    {
      "id" : "Extension.extension:effect.extension:concept.value[x]",
      "path" : "Extension.extension.extension.value[x]",
    ...
    {
      "id" : "Extension.extension:effect.extension:reference",
      "path" : "Extension.extension.extension",
      "sliceName" : "reference",
    ...
    {
      "id" : "Extension.extension:effect.extension:reference.url",
      "path" : "Extension.extension.extension.url",
      "min" : 1,
      "max" : "1",
      "base" : {
    ...
    {
      "id" : "Extension.extension:effect.extension:reference.value[x]",
      "path" : "Extension.extension.extension.value[x]",
    ...
    {
      "id" : "Extension.extension:effect.url",
      "path" : "Extension.extension.url",
      "min" : 1,
      "max" : "1",
      "base" : {
    ...
    {
      "id" : "Extension.extension:effect.value[x]",
      "path" : "Extension.extension.value[x]",
      "min" : 0,
      "max" : "0",
      "base" : {
    ...
    {
      "id" : "Extension.extension:incidence",
      "path" : "Extension.extension",
      "sliceName" : "incidence",
      "short" : "R5: The incidence of the interaction, e.g. theoretical, observed (new)",
      "definition" : "R5: `ClinicalUseDefinition.interaction.incidence` (new:CodeableConcept)",
    ...
    {
      "id" : "Extension.extension:incidence.url",
      "path" : "Extension.extension.url",
      "min" : 1,
      "max" : "1",
      "base" : {
    ...
    {
      "id" : "Extension.extension:incidence.value[x]",
      "path" : "Extension.extension.value[x]",
      ...
      "binding" : {
        ...
        "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-interaction-incidence-for-R4|0.1.0"
      }
    },
    {
      ...
      "short" : "R5: Actions for managing the interaction (new)",
      "definition" : "R5: `ClinicalUseDefinition.interaction.management` (new:CodeableConcept)",
    ...
    },
    {
      ...
      "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-ClinicalUseDefinition.interaction"
    },
    {
