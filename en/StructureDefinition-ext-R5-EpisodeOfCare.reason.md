# ExtensionEpisodeOfCare_Reason - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: The list of medical reasons that are expected to be addressed during the episode of care (new) 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-EpisodeOfCare.reason)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-EpisodeOfCare.reason.csv), [Excel](../StructureDefinition-ext-R5-EpisodeOfCare.reason.xlsx), [Schematron](../StructureDefinition-ext-R5-EpisodeOfCare.reason.sch) 
...
```json
{
  ...
  "id" : "ext-R5-EpisodeOfCare.reason",
  "extension" : [{
  ...
  "version" : "0.1.0",
  "name" : "ExtensionEpisodeOfCare_Reason",
  "title" : "R5: The list of medical reasons that are expected to be addressed during the episode of care (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `EpisodeOfCare.reason` (new:BackboneElement)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "path" : "Extension.extension",
      "sliceName" : "use",
      "short" : "R5: What the reason value should be used for/as (new)",
      "definition" : "R5: `EpisodeOfCare.reason.use` (new:CodeableConcept)",
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "example",
        "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-encounter-reason-use-for-R4|0.1.0"
      }
    },
    {
      ...
      "path" : "Extension.extension",
      "sliceName" : "value",
      "short" : "R5: Medical reason to be addressed (new)",
      "definition" : "R5: `EpisodeOfCare.reason.value` (new:CodeableReference(Condition,Procedure,Observation,HealthcareService))",
    ...
    },
    {
      ...
      "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-EpisodeOfCare.reason"
    },
    {
