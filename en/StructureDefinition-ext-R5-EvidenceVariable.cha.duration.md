# ExtensionEvidenceVariable_Characteristic_Duration - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Length of time in which the characteristic is met (new) 
...
```json
{
  ...
  "title" : "R5: Length of time in which the characteristic is met (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `EvidenceVariable.characteristic.duration[x]` (new:Quantity, Range)",
  "jurisdiction" : [{
    "coding" : [{
