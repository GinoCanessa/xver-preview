...
A computable version of the following element information is available in: [R5MedicationStatementElementMapToR4](ConceptMap-R5-MedicationStatement-element-map-to-R4.md)
...
| [`MedicationStatement.relatedClinicalInformation`](https://hl7.org/fhir/R5/MedicationStatement.html#resource) | [Standard Extension: alternate-reference](http://hl7.org/fhir/StructureDefinition/alternate-reference) |
