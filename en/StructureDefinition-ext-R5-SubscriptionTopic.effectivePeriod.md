# ExtensionSubscriptionTopic_EffectivePeriod - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: The effective date range for the SubscriptionTopic (new) 

R5: `SubscriptionTopic.effectivePeriod` (new:Period)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-SubscriptionTopic.effectivePeriod)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-SubscriptionTopic.effectivePeriod.csv), [Excel](../StructureDefinition-ext-R5-SubscriptionTopic.effectivePeriod.xlsx), [Schematron](../StructureDefinition-ext-R5-SubscriptionTopic.effectivePeriod.sch) 
...
```json
{
  ...
  "id" : "ext-R5-SubscriptionTopic.effectivePeriod",
  "extension" : [{
  ...
  "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-SubscriptionTopic.effectivePeriod",
  "version" : "0.1.0",
  "name" : "ExtensionSubscriptionTopic_EffectivePeriod",
  "title" : "R5: The effective date range for the SubscriptionTopic (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `SubscriptionTopic.effectivePeriod` (new:Period)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-SubscriptionTopic.effectivePeriod"
    },
    {
