# R5DetectedissueStatusForR4ObservationStatus - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
* [R5: preliminary | final | entered-in-error | mitigated additional codes](StructureDefinition-ext-R5-DetectedIssue.status.md)
