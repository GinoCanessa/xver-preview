# ExtensionHealthcareService_OfferedIn - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: The service within which this service is offered (new) 
...
```json
{
  ...
  "title" : "R5: The service within which this service is offered (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `HealthcareService.offeredIn` (new:Reference(HealthcareService))",
  "jurisdiction" : [{
    "coding" : [{
