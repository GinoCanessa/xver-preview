...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-ServiceRequest.reason)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-ServiceRequest.reason.csv), [Excel](../StructureDefinition-ext-R5-ServiceRequest.reason.xlsx), [Schematron](../StructureDefinition-ext-R5-ServiceRequest.reason.sch) 
...
```json
{
  ...
  "id" : "ext-R5-ServiceRequest.reason",
  "extension" : [{
  ...
  "version" : "0.1.0",
  "name" : "ExtensionServiceRequest_Reason",
  "title" : "R5: Explanation/Justification for procedure or service additional types",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `ServiceRequest.reason` additional types (CodeableReference(http://hl7.org/fhir/StructureDefinition/Condition), CodeableReference(http://hl7.org/fhir/StructureDefinition/Observation), CodeableReference(http://hl7.org/fhir/StructureDefinition/DiagnosticReport), CodeableReference(http://hl7.org/fhir/StructureDefinition/DocumentReference), CodeableReference(http://hl7.org/fhir/StructureDefinition/DetectedIssue))",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        ...
        "http://hl7.org/fhir/5.0/StructureDefinition/profile-DetectedIssue|0.1.0",
    ...
    },
    {
      ...
      "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-ServiceRequest.reason"
    },
    {
