# ExtensionMedicationKnowledge_Definitional_Ingredient_Type - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: A code that defines the type of ingredient, active, base, etc (new) 
...
```json
{
  ...
  "title" : "R5: A code that defines the type of ingredient, active, base, etc (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `MedicationKnowledge.definitional.ingredient.type` (new:CodeableConcept)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "example",
        "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-v3-RoleClassIngredientEntity-for-R4|0.1.0"
      }
    }]
  }
}
