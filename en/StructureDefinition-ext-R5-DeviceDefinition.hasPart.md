# ExtensionDeviceDefinition_HasPart - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: A device, part of the current one (new) 
...
```json
{
  ...
  "title" : "R5: A device, part of the current one (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `DeviceDefinition.hasPart` (new:BackboneElement)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "path" : "Extension.extension",
      "sliceName" : "reference",
      "short" : "R5: Reference to the part (new)",
      "definition" : "R5: `DeviceDefinition.hasPart.reference` (new:Reference(DeviceDefinition))",
    ...
    },
    {
      ...
      "path" : "Extension.extension",
      "sliceName" : "count",
      "short" : "R5: Number of occurrences of the part (new)",
      "definition" : "R5: `DeviceDefinition.hasPart.count` (new:integer)",
