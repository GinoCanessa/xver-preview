# ExtensionEvidenceVariable_Characteristic_TimeFromEvent_Range - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Used to express the observation within a period before and/or after the event (new) 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-EvidenceVariable.cha.tim.range)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-EvidenceVariable.cha.tim.range.csv), [Excel](../StructureDefinition-ext-R5-EvidenceVariable.cha.tim.range.xlsx), [Schematron](../StructureDefinition-ext-R5-EvidenceVariable.cha.tim.range.sch) 
...
```json
{
  ...
  "id" : "ext-R5-EvidenceVariable.cha.tim.range",
  "extension" : [{
  ...
  "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-EvidenceVariable.characteristic.timeFromEvent.range",
  "version" : "0.1.0",
  "name" : "ExtensionEvidenceVariable_Characteristic_TimeFromEvent_Range",
  "title" : "R5: Used to express the observation within a period before and/or after the event (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `EvidenceVariable.characteristic.timeFromEvent.range` (new:Range)",
  "jurisdiction" : [{
    "coding" : [{
