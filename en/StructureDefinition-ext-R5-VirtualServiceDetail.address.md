# ExtensionVirtualServiceDetail_Address - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Contact address/number (new) 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-VirtualServiceDetail.address)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-VirtualServiceDetail.address.csv), [Excel](../StructureDefinition-ext-R5-VirtualServiceDetail.address.xlsx), [Schematron](../StructureDefinition-ext-R5-VirtualServiceDetail.address.sch) 
...
```json
{
  ...
  "id" : "ext-R5-VirtualServiceDetail.address",
  "extension" : [{
  ...
  "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-VirtualServiceDetail.address",
  "version" : "0.1.0",
  "name" : "ExtensionVirtualServiceDetail_Address",
  "title" : "R5: Contact address/number (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `VirtualServiceDetail.address[x]` (new:ContactPoint, ExtendedContactDetail, string, url)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "purpose" : "This extension is part of the cross-version definitions generated to enable use of the\r\nelement `VirtualServiceDetail.address[x]` as defined in FHIR R5\r\nin FHIR R4.\r\n\r\nThe source element is defined as:\r\n`VirtualServiceDetail.address[x]` 0..1 `ContactPoint, ExtendedContactDetail, string, url`\r\n\r\nAcross FHIR versions, the element set has been mapped as:\r\n* R5 `VirtualServiceDetail.address[x]` 0..1 `ContactPoint, ExtendedContactDetail, string, url`\r\n\r\nFollowing are the generation technical comments:\r\nElement `VirtualServiceDetail.address[x]` is not mapped to FHIR R4, since FHIR R5 `VirtualServiceDetail` is not mapped.\nElement `VirtualServiceDetail.address[x]` has no mapping targets in FHIR R4. Typically, this is because the element has been added (is a new element).",
  "fhirVersion" : "4.0.1",
  "mapping" : [{
    "identity" : "rim",
    "uri" : "http://hl7.org/v3",
