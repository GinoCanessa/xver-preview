# ExtensionComposition_Url - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Canonical identifier for this Composition, represented as a URI (globally unique) (new) 

R5: `Composition.url` (new:uri)
...
```json
{
  ...
  "title" : "R5: Canonical identifier for this Composition, represented as a URI (globally unique) (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Composition.url` (new:uri)",
  "jurisdiction" : [{
    "coding" : [{
