# LegalStatusOfSupply - FHIR Cross-Version Extensions package to use FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## CodeSystem: LegalStatusOfSupply 
...
* [ValueSetR5LegalStatusOfSupplyForR4](ValueSet-ValueSet-R5-legal-status-of-supply-for-R4.md)
