# R5MedicinalProductCrossReferenceTypeForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
* [R5: The type of relationship, for instance branded to generic or virtual to actual product (new)](StructureDefinition-ext-R5-MPD.cro.type.md)
...
```json
{
  ...
  "id" : "R5-medicinal-product-cross-reference-type-for-R4",
  "extension" : [{
  ...
  "url" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-medicinal-product-cross-reference-type-for-R4",
  "version" : "0.1.0",
  "name" : "R5MedicinalProductCrossReferenceTypeForR4",
