# ExtensionInvoice_LineItem_Serviced - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Service data or period (new) 

R5: `Invoice.lineItem.serviced[x]` (new:date, Period)
...
```json
{
  ...
  "title" : "R5: Service data or period (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Invoice.lineItem.serviced[x]` (new:date, Period)",
  "jurisdiction" : [{
    "coding" : [{
