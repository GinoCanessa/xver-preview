# ExtensionInvoice_LineItem_Serviced - FHIR Cross-Version Extensions package to use FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## Extension: Cross-version Extension `R5.Invoice.lineItem.serviced[x]` for use in FHIR R4 

This cross-version extension represents the FHIR R5 element `Invoice.lineItem.serviced[x]` for use in FHIR R4.
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-Invoice.lin.serviced.csv), [Excel](../StructureDefinition-ext-R5-Invoice.lin.serviced.xlsx), [Schematron](../StructureDefinition-ext-R5-Invoice.lin.serviced.sch) 
...
```json
{
  ...
  "id" : "ext-R5-Invoice.lin.serviced",
  "extension" : [
    {
