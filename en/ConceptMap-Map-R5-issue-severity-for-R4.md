# MapR5IssueSeverityForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## ConceptMap: MapR5IssueSeverityForR4 
...
```json
{
  ...
  "id" : "Map-R5-issue-severity-for-R4",
  "extension" : [
    {
  ...
  "url" : "http://hl7.org/fhir/uv/xver/ConceptMap/R5-issue-severity-for-R4",
  "version" : "0.0.1-snapshot-3",
  "name" : "MapR5IssueSeverityForR4",
  "title" : "Cross-version ConceptMap for ValueSet R5-issue-severity-for-R4 from FHIR R5 to FHIR R4",
  "status" : "active",
  "experimental" : false,
  "date" : "2026-02-21T13:36:49.3529958-06:00",
  "contact" : [
    {
  ...
  "sourceUri" : "http://hl7.org/fhir/ValueSet/issue-severity|5.0.0",
  "targetUri" : "http://hl7.org/fhir/ValueSet/issue-severity|4.0.1",
  "group" : [
    {
