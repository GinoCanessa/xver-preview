# ContractPublicationStatus - FHIR Cross-Version Extensions package to use FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## CodeSystem: ContractPublicationStatus (Experimental) 
...
```json
{
  ...
  "title" : "Contract Publication Status",
  "status" : "active",
  "experimental" : true,
