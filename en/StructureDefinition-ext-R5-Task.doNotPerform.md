# ExtensionTask_DoNotPerform - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: True if Task is prohibiting action (new) 

R5: `Task.doNotPerform` (new:boolean)
...
```json
{
  ...
  "title" : "R5: True if Task is prohibiting action (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Task.doNotPerform` (new:boolean)",
  "jurisdiction" : [{
    "coding" : [{
