# ExtensionPlanDefinition_Action_Location - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Where it should happen (new) 
...
```json
{
  ...
  "title" : "R5: Where it should happen (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `PlanDefinition.action.location` (new:CodeableReference(Location))",
  "jurisdiction" : [{
    "coding" : [{
