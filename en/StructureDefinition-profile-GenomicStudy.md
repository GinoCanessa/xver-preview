# ProfileGenomicStudy - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## Resource Profile: ProfileGenomicStudy 
...
```json
{
  ...
  "differential" : {
    "element" : [
      ...
      {
        "id" : "Basic.extension:GenomicStudy",
        "path" : "Basic.extension",
        "sliceName" : "GenomicStudy",
        "short" : "Cross-version extension for GenomicStudy from R5 for use in FHIR R4",
        "min" : 1,
        "max" : "1",
        "base" : {
          "path" : "DomainResource.extension",
        ...
        "type" : [
          {
            "code" : "Extension",
            "profile" : [
              "http://hl7.org/fhir/5.0/StructureDefinition/extension-GenomicStudy|0.0.1-snapshot-3"
            ]
          }
        ]
      },
