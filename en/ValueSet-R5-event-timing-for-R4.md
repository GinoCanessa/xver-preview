# R5EventTimingForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
* [R5: when](StructureDefinition-ext-R5-Timing.rep.when.md)
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-event-timing-for-R4",
  "version" : "0.1.0",
  "name" : "R5EventTimingForR4",
