# ExtensionSubstanceDefinition_Property_Type - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: A code expressing the type of property (new) 

R5: `SubstanceDefinition.property.type` (new:CodeableConcept)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-SubstanceDefinition.pro.type)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-SubstanceDefinition.pro.type.csv), [Excel](../StructureDefinition-ext-R5-SubstanceDefinition.pro.type.xlsx), [Schematron](../StructureDefinition-ext-R5-SubstanceDefinition.pro.type.sch) 
...
```json
{
  ...
  "id" : "ext-R5-SubstanceDefinition.pro.type",
  "extension" : [{
  ...
  "version" : "0.1.0",
  "name" : "ExtensionSubstanceDefinition_Property_Type",
  "title" : "R5: A code expressing the type of property (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `SubstanceDefinition.property.type` (new:CodeableConcept)",
  "jurisdiction" : [{
    "coding" : [{
