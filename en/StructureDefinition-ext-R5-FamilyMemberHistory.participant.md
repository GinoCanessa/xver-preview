# ExtensionFamilyMemberHistory_Participant - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Who or what participated in the activities related to the family member history and how they were involved (new) 

R5: `FamilyMemberHistory.participant` (new:BackboneElement)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-FamilyMemberHistory.participant)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-FamilyMemberHistory.participant.csv), [Excel](../StructureDefinition-ext-R5-FamilyMemberHistory.participant.xlsx), [Schematron](../StructureDefinition-ext-R5-FamilyMemberHistory.participant.sch) 
...
```json
{
  ...
  "id" : "ext-R5-FamilyMemberHistory.participant",
  "extension" : [{
  ...
  "title" : "R5: Who or what participated in the activities related to the family member history and how they were involved (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `FamilyMemberHistory.participant` (new:BackboneElement)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "purpose" : "This extension is part of the cross-version definitions generated to enable use of the\r\nelement `FamilyMemberHistory.participant` as defined in FHIR R5\r\nin FHIR R4.\r\n\r\nThe source element is defined as:\r\n`FamilyMemberHistory.participant` 0..* `BackboneElement`\r\n\r\nAcross FHIR versions, the element set has been mapped as:\r\n*  R5: `FamilyMemberHistory.participant` 0..* `BackboneElement`\r\n\r\nFollowing are the generation technical comments:\r\nElement `FamilyMemberHistory.participant` has a context of FamilyMemberHistory based on following the parent source element upwards and mapping to `FamilyMemberHistory`.\nElement `FamilyMemberHistory.participant` has no mapping targets in FHIR R4. Typically, this is because the element has been added (is a new element).",
  "fhirVersion" : "4.0.1",
  "mapping" : [{
    "identity" : "rim",
    "uri" : "http://hl7.org/v3",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "definition" : "R5: `FamilyMemberHistory.participant.function` (new:CodeableConcept)",
      ...
      "requirements" : "Element `FamilyMemberHistory.participant.function` is part of an existing definition because parent element `FamilyMemberHistory.participant` requires a cross-version extension.\nElement `FamilyMemberHistory.participant.function` has a context of FamilyMemberHistory based on following the parent source element upwards and mapping to `FamilyMemberHistory`.\nElement `FamilyMemberHistory.participant.function` has no mapping targets in FHIR R4. Typically, this is because the element has been added (is a new element).",
      "min" : 0,
      "max" : "1",
      "base" : {
        "path" : "Extension.extension",
    ...
    },
    {
      ...
      "path" : "Extension.extension",
      "sliceName" : "actor",
      "short" : "R5: Who or what participated in the activities related to the family member history (new)",
      "definition" : "R5: `FamilyMemberHistory.participant.actor` (new:Reference(Practitioner,PractitionerRole,Patient,RelatedPerson,Device,Organization,CareTeam))",
      ...
      "requirements" : "Element `FamilyMemberHistory.participant.actor` is part of an existing definition because parent element `FamilyMemberHistory.participant` requires a cross-version extension.\nElement `FamilyMemberHistory.participant.actor` has a context of FamilyMemberHistory based on following the parent source element upwards and mapping to `FamilyMemberHistory`.\nElement `FamilyMemberHistory.participant.actor` has no mapping targets in FHIR R4. Typically, this is because the element has been added (is a new element).",
      "min" : 1,
      "max" : "1",
      "base" : {
        "path" : "Extension.extension",
