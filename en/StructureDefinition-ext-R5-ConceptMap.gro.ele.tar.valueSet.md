# ExtensionConceptMap_Group_Element_Target_ValueSet - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Identifies the set of target concepts (new) 

R5: `ConceptMap.group.element.target.valueSet` (new:canonical(ValueSet))
...
```json
{
  ...
  "title" : "R5: Identifies the set of target concepts (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `ConceptMap.group.element.target.valueSet` (new:canonical(ValueSet))",
  "jurisdiction" : [{
    "coding" : [{
