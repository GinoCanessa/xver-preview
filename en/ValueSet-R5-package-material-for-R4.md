# R5PackageMaterialForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3
...
* [Cross-version Extension `R5.PackagedProductDefinition.packaging` for use in FHIR R4](StructureDefinition-packaging.md)
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-package-material-for-R4",
  "version" : "0.0.1-snapshot-3",
  "name" : "R5PackageMaterialForR4",
