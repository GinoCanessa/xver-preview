# ExtensionSubstanceDefinition_Relationship_RatioHighLimitAmount - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: For use when the numeric has an uncertain range (new) 

R5: `SubstanceDefinition.relationship.ratioHighLimitAmount` (new:Ratio)
...
```json
{
  ...
  "title" : "R5: For use when the numeric has an uncertain range (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `SubstanceDefinition.relationship.ratioHighLimitAmount` (new:Ratio)",
  "jurisdiction" : [{
    "coding" : [{
