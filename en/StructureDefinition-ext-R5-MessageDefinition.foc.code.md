# ExtensionMessageDefinition_Focus_Code - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: code additional codes 

R5: `MessageDefinition.focus.code` additional codes
...
```json
{
  ...
  "description" : "R5: `MessageDefinition.focus.code` additional codes",
  "jurisdiction" : [{
    "coding" : [{
