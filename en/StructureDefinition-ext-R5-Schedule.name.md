# ExtensionSchedule_Name - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Human-readable label (new) 
...
```json
{
  ...
  "title" : "R5: Human-readable label (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Schedule.name` (new:string)",
  "jurisdiction" : [{
    "coding" : [{
