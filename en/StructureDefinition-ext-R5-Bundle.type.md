# ExtensionBundle_Type - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: document | message | transaction | transaction-response | batch | batch-response | history | searchset | collection | subscription-notification 
...
```json
{
  ...
  "title" : "R5: document | message | transaction | transaction-response | batch | batch-response | history | searchset | collection | subscription-notification",
  "status" : "active",
  "experimental" : false,
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        ...
        "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-bundle-type-for-R4|0.1.0"
      }
    }]
  }
}
