# ExampleScenarioActorType - FHIR Cross-Version Extensions package to use FHIR R5 in FHIR R4 v0.0.1-snapshot-3
...
```json
{
  ...
  "title" : "Example Scenario Actor Type",
  "status" : "active",
  "experimental" : false,
  ...
  "concept" : [
    {
      "code" : "person",
      "display" : "Person",
      "definition" : "A human actor"
    },
    {
      "code" : "system",
      "display" : "System",
      "definition" : "A software application or other system"
    }
  ]
}
