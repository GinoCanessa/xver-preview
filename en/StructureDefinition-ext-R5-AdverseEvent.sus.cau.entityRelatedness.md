# ExtensionAdverseEvent_SuspectEntity_Causality_EntityRelatedness - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Result of the assessment regarding the relatedness of the suspected entity to the event additional types 
...
```json
{
  ...
  "title" : "R5: Result of the assessment regarding the relatedness of the suspected entity to the event additional types",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `AdverseEvent.suspectEntity.causality.entityRelatedness` additional types (CodeableConcept) additional types from child elements (coding)",
  "jurisdiction" : [{
    "coding" : [{
