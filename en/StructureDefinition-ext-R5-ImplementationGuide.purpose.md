# ExtensionImplementationGuide_Purpose - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Why this implementation guide is defined (new) 

R5: `ImplementationGuide.purpose` (new:markdown)
...
```json
{
  ...
  "title" : "R5: Why this implementation guide is defined (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `ImplementationGuide.purpose` (new:markdown)",
  "jurisdiction" : [{
    "coding" : [{
