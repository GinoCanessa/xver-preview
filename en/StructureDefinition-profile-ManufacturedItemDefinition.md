...
```json
{
  ...
  "differential" : {
    "element" : [
      ...
      {
        "id" : "Basic.extension:ManufacturedItemDefinition",
        "path" : "Basic.extension",
        "sliceName" : "ManufacturedItemDefinition",
        "short" : "Cross-version extension for ManufacturedItemDefinition from R5 for use in FHIR R4",
        "min" : 1,
        "max" : "1",
        "base" : {
          "path" : "DomainResource.extension",
        ...
        "type" : [
          {
            "code" : "Extension",
            "profile" : [
              "http://hl7.org/fhir/5.0/StructureDefinition/extension-ManufacturedItemDefinition|0.0.1-snapshot-3"
            ]
          }
        ]
      },
