...
* Refer to this Profile: [Cross-version Extension `R5.Citation` for use in FHIR R4](StructureDefinition-ext-R5-Citation.md)
...
```json
{
  ...
  "differential" : {
    "element" : [
      ...
      {
        "id" : "Basic.extension:ArtifactAssessment",
        "path" : "Basic.extension",
        "sliceName" : "ArtifactAssessment",
        "short" : "Cross-version extension for ArtifactAssessment from R5 for use in FHIR R4",
        "min" : 1,
        "max" : "1",
        "base" : {
          "path" : "DomainResource.extension",
        ...
        "type" : [
          {
            "code" : "Extension",
            "profile" : [
              "http://hl7.org/fhir/5.0/StructureDefinition/extension-ArtifactAssessment|0.0.1-snapshot-3"
            ]
          }
        ]
      },
