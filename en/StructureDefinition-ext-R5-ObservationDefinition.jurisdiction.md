# ExtensionObservationDefinition_Jurisdiction - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Intended jurisdiction for this ObservationDefinition (if applicable) (new) 
...
```json
{
  ...
  "title" : "R5: Intended jurisdiction for this ObservationDefinition (if applicable) (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `ObservationDefinition.jurisdiction` (new:CodeableConcept)",
  "jurisdiction" : [{
    "coding" : [{
