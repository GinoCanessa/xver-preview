...
* Refer to this Profile: [Cross-version Extension `R5.DiagnosticReport.composition` for use in FHIR R4](StructureDefinition-ext-R5-DiagnosticReport.composition.md)
...
```json
{
  ...
  "status" : "active",
  "experimental" : false,
  "date" : "2026-02-06T13:17:30.6515217-06:00",
