# ExtensionEvidenceVariable_Category - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: A grouping for ordinal or polychotomous variables (new) 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-EvidenceVariable.category)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-EvidenceVariable.category.csv), [Excel](../StructureDefinition-ext-R5-EvidenceVariable.category.xlsx), [Schematron](../StructureDefinition-ext-R5-EvidenceVariable.category.sch) 
...
```json
{
  ...
  "id" : "ext-R5-EvidenceVariable.category",
  "extension" : [{
  ...
  "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-EvidenceVariable.category",
  "version" : "0.1.0",
  "name" : "ExtensionEvidenceVariable_Category",
  "title" : "R5: A grouping for ordinal or polychotomous variables (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `EvidenceVariable.category` (new:BackboneElement)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "path" : "Extension.extension",
      "sliceName" : "name",
      "short" : "R5: Description of the grouping (new)",
      "definition" : "R5: `EvidenceVariable.category.name` (new:string)",
    ...
    },
    {
      ...
      "path" : "Extension.extension",
      "sliceName" : "value",
      "short" : "R5: Definition of the grouping (new)",
      "definition" : "R5: `EvidenceVariable.category.value[x]` (new:CodeableConcept, Quantity, Range)",
    ...
    },
    {
      ...
      "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-EvidenceVariable.category"
    },
    {
