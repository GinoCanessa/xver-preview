# ExtensionMedicationAdministration_Occurence - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Specific date/time or interval of time during which the administration took place (or did not take place) additional types 
...
```json
{
  ...
  "title" : "R5: Specific date/time or interval of time during which the administration took place (or did not take place) additional types",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `MedicationAdministration.occurence[x]` additional types (Timing)",
  "jurisdiction" : [{
    "coding" : [{
