# AnimalTissueType - FHIR Cross-Version Extensions package to use FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## CodeSystem: AnimalTissueType 
...
* [ValueSetR5AnimalTissueTypeForR4](ValueSet-ValueSet-R5-animal-tissue-type-for-R4.md)
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/animal-tissue-type",
  "version" : "5.0.0",
