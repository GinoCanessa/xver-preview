# ExtensionCapabilityStatement_Rest_Resource_ConditionalPatch - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: If allows/uses conditional patch (new) 

R5: `CapabilityStatement.rest.resource.conditionalPatch` (new:boolean)
...
```json
{
  ...
  "title" : "R5: If allows/uses conditional patch (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `CapabilityStatement.rest.resource.conditionalPatch` (new:boolean)",
  "jurisdiction" : [{
    "coding" : [{
