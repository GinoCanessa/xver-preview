# R5AccountElementMapToR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
```json
{
  ...
  "status" : "active",
  "experimental" : false,
  "date" : "2026-03-04T17:07:45.6108708-06:00",
  "contact" : [{
  ...
  "group" : [{
    ...
    "element" : [{
      ...
      "target" : [{
        ...
        "comment" : "Element `Account.meta` is mapped to FHIR R4 element `Account.meta` as `Equivalent`."
      }]
    },
    {
    ...
    },
    {
      ...
      "target" : [{
        ...
        "equivalence" : "equivalent",
        "comment" : "Element `Account.contained` is mapped to FHIR R4 element `Account.contained` as `Equivalent`.\nThis should never be done when the content can be identified properly, as once identification is lost, it is extremely difficult (and context dependent) to restore it again. Contained resources may have profiles and tags in their meta elements, but SHALL NOT have security labels."
      }]
    },
    {
      ...
      "target" : [{
        ...
        "equivalence" : "equivalent",
        "comment" : "Element `Account.identifier` is mapped to FHIR R4 element `Account.identifier` as `Equivalent`."
      }]
    },
    {
      "code" : "Account.status",
    ...
    },
    {
      ...
      "target" : [{
        ...
        "equivalence" : "equivalent",
        "comment" : "Element `Account.type` is mapped to FHIR R4 element `Account.type` as `Equivalent`."
      }]
    },
    {
      "code" : "Account.name",
      ...
      "target" : [{
        ...
        "equivalence" : "equivalent",
        "comment" : "Element `Account.name` is mapped to FHIR R4 element `Account.name` as `Equivalent`."
      }]
    },
    {
    ...
    },
    {
      ...
      "target" : [{
        ...
        "equivalence" : "wider",
        "comment" : "Element `Account.coverage` is mapped to FHIR R4 element `Account.coverage` as `Equivalent`.\nTypically. this may be some form of insurance, internal charges, or self-pay.\n\nLocal or jurisdictional business rules may determine which coverage covers which types of billable items charged to the account, and in which order.\nWhere the order is important, a local/jurisdictional extension may be defined to specify the order for the type of charge."
      }]
    },
    {
      ...
      "target" : [{
        ...
        "equivalence" : "equivalent",
        "comment" : "Element `Account.coverage.coverage` is mapped to FHIR R4 element `Account.coverage.coverage` as `Equivalent`."
      }]
    },
    {
    ...
    },
    {
      ...
      "target" : [{
        ...
        "equivalence" : "equivalent",
        "comment" : "Element `Account.owner` is mapped to FHIR R4 element `Account.owner` as `Equivalent`."
      }]
    },
    {
      ...
      "target" : [{
        ...
        "equivalence" : "equivalent",
        "comment" : "Element `Account.description` is mapped to FHIR R4 element `Account.description` as `Equivalent`."
      }]
    },
    {
      ...
      "target" : [{
        ...
        "equivalence" : "wider",
        "comment" : "Element `Account.guarantor` is mapped to FHIR R4 element `Account.guarantor` as `Equivalent`."
      }]
    },
    {
      ...
      "target" : [{
        ...
        "equivalence" : "equivalent",
        "comment" : "Element `Account.guarantor.party` is mapped to FHIR R4 element `Account.guarantor.party` as `Equivalent`."
      }]
    },
    {
      ...
      "target" : [{
        ...
        "equivalence" : "equivalent",
        "comment" : "Element `Account.guarantor.onHold` is mapped to FHIR R4 element `Account.guarantor.onHold` as `Equivalent`."
      }]
    },
    {
      ...
      "target" : [{
        ...
        "equivalence" : "equivalent",
        "comment" : "Element `Account.guarantor.period` is mapped to FHIR R4 element `Account.guarantor.period` as `Equivalent`."
      }]
    },
    {
  ...
  },
  {
    ...
    },
    {
      ...
      "target" : [{
        "code" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Account.relatedAccount",
        "equivalence" : "wider",
        "comment" : "Element `Account.relatedAccount` has a context of Account based on following the parent source element upwards and mapping to `Account`.\nElement `Account.relatedAccount` has no mapping targets in FHIR R4. Typically, this is because the element has been added (is a new element)."
      }]
    },
    {
    ...
    },
    {
      ...
      "display" : "account",
      "target" : [{
        "code" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Account.relatedAccount:account",
        "equivalence" : "wider",
        "comment" : "Element `Account.relatedAccount.account` is part of an existing definition because parent element `Account.relatedAccount` requires a cross-version extension.\nElement `Account.relatedAccount.account` is mapped to FHIR R4 element `Account.partOf` as `SourceIsBroaderThanTarget`."
      }]
    },
