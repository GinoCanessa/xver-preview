# R5EncounterStatusForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
* [R5: planned | in-progress | on-hold | discharged | completed | cancelled | discontinued | entered-in-error | unknown](StructureDefinition-ext-R5-Encounter.status.md)
* [R5: planned | in-progress | on-hold | discharged | completed | cancelled | discontinued | entered-in-error | unknown](StructureDefinition-ext-R5-EncounterHistory.status.md)
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-encounter-status-for-R4",
  "version" : "0.1.0",
  "name" : "R5EncounterStatusForR4",
