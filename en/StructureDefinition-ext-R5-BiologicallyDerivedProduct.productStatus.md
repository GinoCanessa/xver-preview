# ExtensionBiologicallyDerivedProduct_ProductStatus - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: productStatus additional types 

R5: `BiologicallyDerivedProduct.productStatus` additional types (Coding) additional types from child elements (userSelected)
...
```json
{
  ...
  "title" : "R5: productStatus additional types",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `BiologicallyDerivedProduct.productStatus` additional types (Coding) additional types from child elements (userSelected)",
  "jurisdiction" : [{
    "coding" : [{
