# ExtensionBiologicallyDerivedProduct_ProductStatus - FHIR Cross-Version Extensions package to use FHIR R5 in FHIR R4 v0.0.1-snapshot-3
    ...
    "element" : [
      ...
      },
      {
        ...
        "binding" : {
          ...
          "valueSet" : "http://hl7.org/fhir/5.0/ValueSet/ValueSet-R5-biologicallyderived-product-status-for-R4-product-status"
        }
      }
    ]
  }
