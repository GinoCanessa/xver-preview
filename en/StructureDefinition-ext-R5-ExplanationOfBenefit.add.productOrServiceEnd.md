# ExtensionExplanationOfBenefit_AddItem_ProductOrServiceEnd - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: End of a range of codes (new) 

R5: `ExplanationOfBenefit.addItem.productOrServiceEnd` (new:CodeableConcept)
...
```json
{
  ...
  "description" : "R5: `ExplanationOfBenefit.addItem.productOrServiceEnd` (new:CodeableConcept)",
  "jurisdiction" : [{
    "coding" : [{
