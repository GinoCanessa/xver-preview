# ExtensionCapabilityStatement_AcceptLanguage - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Languages supported (new) 

R5: `CapabilityStatement.acceptLanguage` (new:code)
...
```json
{
  ...
  "title" : "R5: Languages supported (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `CapabilityStatement.acceptLanguage` (new:code)",
  "jurisdiction" : [{
    "coding" : [{
