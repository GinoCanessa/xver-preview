# ExtensionConceptMap_AdditionalAttribute - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Definition of an additional attribute to act as a data source or target (new) 
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        ...
        "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-conceptmap-attribute-type-for-R4|0.1.0"
      }
    },
    {
      "id" : "Extension.url",
