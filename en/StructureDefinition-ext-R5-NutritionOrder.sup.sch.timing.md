# ExtensionNutritionOrder_Supplement_Schedule_Timing - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Scheduled frequency of diet (new) 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-NutritionOrder.sup.sch.timing)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-NutritionOrder.sup.sch.timing.csv), [Excel](../StructureDefinition-ext-R5-NutritionOrder.sup.sch.timing.xlsx), [Schematron](../StructureDefinition-ext-R5-NutritionOrder.sup.sch.timing.sch) 
...
```json
{
  ...
  "id" : "ext-R5-NutritionOrder.sup.sch.timing",
  "extension" : [{
  ...
  "version" : "0.1.0",
  "name" : "ExtensionNutritionOrder_Supplement_Schedule_Timing",
  "title" : "R5: Scheduled frequency of diet (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `NutritionOrder.supplement.schedule.timing` (new:Timing)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-NutritionOrder.supplement.schedule.timing"
    },
    {
