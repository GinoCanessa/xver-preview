# ExtensionSupplyRequest_Reason - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: The reason why the supply item was requested additional types 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-SupplyRequest.reason)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-SupplyRequest.reason.csv), [Excel](../StructureDefinition-ext-R5-SupplyRequest.reason.xlsx), [Schematron](../StructureDefinition-ext-R5-SupplyRequest.reason.sch) 
...
```json
{
  ...
  "id" : "ext-R5-SupplyRequest.reason",
  "extension" : [{
  ...
  "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-SupplyRequest.reason",
  "version" : "0.1.0",
  "name" : "ExtensionSupplyRequest_Reason",
  "title" : "R5: The reason why the supply item was requested additional types",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `SupplyRequest.reason` additional types (CodeableReference(http://hl7.org/fhir/StructureDefinition/Condition), CodeableReference(http://hl7.org/fhir/StructureDefinition/Observation), CodeableReference(http://hl7.org/fhir/StructureDefinition/DiagnosticReport), CodeableReference(http://hl7.org/fhir/StructureDefinition/DocumentReference))",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "purpose" : "This extension is part of the cross-version definitions generated to enable use of the\r\nelement `SupplyRequest.reason` as defined in FHIR R5\r\nin FHIR R4.\r\n\r\nThe source element is defined as:\r\n`SupplyRequest.reason` 0..* `CodeableReference(http://hl7.org/fhir/StructureDefinition/Condition,http://hl7.org/fhir/StructureDefinition/Observation,http://hl7.org/fhir/StructureDefinition/DiagnosticReport,http://hl7.org/fhir/StructureDefinition/DocumentReference)`\r\n\r\nAcross FHIR versions, the element set has been mapped as:\r\n*  R5: `SupplyRequest.reason` 0..* `CodeableReference(http://hl7.org/fhir/StructureDefinition/Condition,http://hl7.org/fhir/StructureDefinition/Observation,http://hl7.org/fhir/StructureDefinition/DiagnosticReport,http://hl7.org/fhir/StructureDefinition/DocumentReference)`\n*  R4B: `SupplyRequest.reasonCode` 0..* `CodeableConcept`\n*  R4: `SupplyRequest.reasonCode` 0..* `CodeableConcept`\r\n\r\nFollowing are the generation technical comments:\r\nElement `SupplyRequest.reason` is mapped to FHIR R4 element `SupplyRequest.reasonCode` as `SourceIsBroaderThanTarget`.\nElement `SupplyRequest.reason` is mapped to FHIR R4 element `SupplyRequest.reasonReference` as `SourceIsBroaderThanTarget`.\nThe mappings for `SupplyRequest.reason` do not cover the following types: CodeableReference.",
  "fhirVersion" : "4.0.1",
  "mapping" : [{
    "identity" : "rim",
    "uri" : "http://hl7.org/v3",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "preferred",
        "valueSet" : "http://hl7.org/fhir/ValueSet/supplyrequest-reason|4.0.1"
      }
    },
    {
    ...
    },
    {
      ...
      "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-SupplyRequest.reason"
    },
    {
