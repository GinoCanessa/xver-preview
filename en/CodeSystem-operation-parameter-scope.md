# OperationParameterScope - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## CodeSystem: OperationParameterScope 
...
* [R5OperationParameterScopeForR4](ValueSet-R5-operation-parameter-scope-for-R4.md)
