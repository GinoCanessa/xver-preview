# ExtensionGoal_Continuous - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: After meeting the goal, ongoing activity is needed to sustain the goal objective (new) 
...
```json
{
  ...
  "title" : "R5: After meeting the goal, ongoing activity is needed to sustain the goal objective (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Goal.continuous` (new:boolean)",
  "jurisdiction" : [{
    "coding" : [{
