# R5DevicedispenseStatusForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
* [R5: preparation | in-progress | cancelled | on-hold | completed | entered-in-error | stopped | declined | unknown (new)](StructureDefinition-ext-R5-DeviceDispense.status.md)
