# R5WeekOfMonthForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
* [R5: Details of the recurrence pattern/template used to generate occurrences (new)](StructureDefinition-ext-R5-Appointment.recurrenceTemplate.md)
