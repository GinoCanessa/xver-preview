# ExtensionParameters_Parameter_Value - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: value additional types 

R5: `Parameters.parameter.value[x]` additional types (CodeableReference, RatioRange, Availability, ExtendedContactDetail)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-Parameters.par.value)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-Parameters.par.value.csv), [Excel](../StructureDefinition-ext-R5-Parameters.par.value.xlsx), [Schematron](../StructureDefinition-ext-R5-Parameters.par.value.sch) 
...
```json
{
  ...
  "id" : "ext-R5-Parameters.par.value",
  "extension" : [{
  ...
  "description" : "R5: `Parameters.parameter.value[x]` additional types (CodeableReference, RatioRange, Availability, ExtendedContactDetail)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Parameters.parameter.value"
    },
    {
