# ExtensionMedicinalProductDefinition_Characteristic - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Key product features such as "sugar free", "modified release" (new) 

R5: `MedicinalProductDefinition.characteristic` (new:BackboneElement)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-MedicinalProductDefinition.characteristic.csv), [Excel](../StructureDefinition-ext-R5-MedicinalProductDefinition.characteristic.xlsx), [Schematron](../StructureDefinition-ext-R5-MedicinalProductDefinition.characteristic.sch) 
...
```json
{
  ...
  "id" : "ext-R5-MedicinalProductDefinition.characteristic",
  "extension" : [{
  ...
  "version" : "0.1.0",
  "name" : "ExtensionMedicinalProductDefinition_Characteristic",
  "title" : "R5: Key product features such as \"sugar free\", \"modified release\" (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `MedicinalProductDefinition.characteristic` (new:BackboneElement)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "definition" : "R5: `MedicinalProductDefinition.characteristic.type` (new:CodeableConcept)",
    ...
    },
    {
      ...
      "definition" : "R5: `MedicinalProductDefinition.characteristic.value[x]` (new:Attachment, boolean, CodeableConcept, date, integer, markdown, Quantity)",
    ...
    },
    {
      ...
      "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-MedicinalProductDefinition.characteristic"
    },
    {
