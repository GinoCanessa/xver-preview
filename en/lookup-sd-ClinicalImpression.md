# Lookup for ProfileClinicalImpression - FHIR Cross-Version Extensions package to use FHIR R5 in FHIR R4 v0.0.1-snapshot-3
...
| [`ClinicalImpression.status`](https://hl7.org/fhir/R5/ClinicalImpression.html#resource) | [ClinicalImpression.status](https://hl7.org/fhir/R4/ClinicalImpression.html#resource)[http://hl7.org/fhir/5.0/StructureDefinition/extension-ClinicalImpression.status](StructureDefinition-ext-R5-ClinicalImpression.status.md) |
