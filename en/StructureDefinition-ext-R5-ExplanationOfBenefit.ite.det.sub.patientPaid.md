# ExtensionExplanationOfBenefit_Item_Detail_SubDetail_PatientPaid - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Paid by the patient (new) 

R5: `ExplanationOfBenefit.item.detail.subDetail.patientPaid` (new:Money)
...
```json
{
  ...
  "description" : "R5: `ExplanationOfBenefit.item.detail.subDetail.patientPaid` (new:Money)",
  "jurisdiction" : [{
    "coding" : [{
