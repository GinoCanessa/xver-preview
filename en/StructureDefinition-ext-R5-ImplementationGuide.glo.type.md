# ExtensionImplementationGuide_Global_Type - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: type additional codes 

R5: `ImplementationGuide.global.type` additional codes
...
```json
{
  ...
  "description" : "R5: `ImplementationGuide.global.type` additional codes",
  "jurisdiction" : [{
    "coding" : [{
