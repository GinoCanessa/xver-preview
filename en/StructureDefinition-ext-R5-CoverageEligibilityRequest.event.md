...
This cross-version extension represents the FHIR R5 element `CoverageEligibilityRequest.event` for use in FHIR R4.
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-CoverageEligibilityRequest.event)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-CoverageEligibilityRequest.event.csv), [Excel](../StructureDefinition-ext-R5-CoverageEligibilityRequest.event.xlsx), [Schematron](../StructureDefinition-ext-R5-CoverageEligibilityRequest.event.sch) 
...
```json
{
  ...
  "id" : "ext-R5-CoverageEligibilityRequest.event",
  "extension" : [
    {
  ...
  "name" : "ExtensionCoverageEligibilityRequest_Event",
  ...
  "description" : "This cross-version extension represents the FHIR R5 element `CoverageEligibilityRequest.event` for use in FHIR R4.",
  "jurisdiction" : [
    {
      "coding" : [
        {
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "requirements" : "Element `CoverageEligibilityRequest.event.type` has a context of CoverageEligibilityRequest based on following the parent source element upwards and mapping to `CoverageEligibilityRequest`.",
        "min" : 1,
        "max" : "1",
        "base" : {
          "path" : "Extension.extension",
      ...
      },
      {
        ...
        "requirements" : "Element `CoverageEligibilityRequest.event.when[x]` has a context of CoverageEligibilityRequest based on following the parent source element upwards and mapping to `CoverageEligibilityRequest`.",
        "min" : 1,
        "max" : "1",
        "base" : {
          "path" : "Extension.extension",
      ...
      },
      {
        ...
        "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-CoverageEligibilityRequest.event"
      },
      {
