# ExtensionCoverageEligibilityRequest_Event - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Event information (new) 

R5: `CoverageEligibilityRequest.event` (new:BackboneElement)
...
```json
{
  ...
  "description" : "R5: `CoverageEligibilityRequest.event` (new:BackboneElement)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "definition" : "R5: `CoverageEligibilityRequest.event.type` (new:CodeableConcept)",
    ...
    },
    {
      ...
      "definition" : "R5: `CoverageEligibilityRequest.event.when[x]` (new:dateTime, Period)",
