# ExtensionSubstanceDefinition_MolecularWeight_Method - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: The method by which the weight was determined (new) 

R5: `SubstanceDefinition.molecularWeight.method` (new:CodeableConcept)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-SubstanceDefinition.mol.method)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-SubstanceDefinition.mol.method.csv), [Excel](../StructureDefinition-ext-R5-SubstanceDefinition.mol.method.xlsx), [Schematron](../StructureDefinition-ext-R5-SubstanceDefinition.mol.method.sch) 
...
```json
{
  ...
  "id" : "ext-R5-SubstanceDefinition.mol.method",
  "extension" : [{
  ...
  "version" : "0.1.0",
  "name" : "ExtensionSubstanceDefinition_MolecularWeight_Method",
  "title" : "R5: The method by which the weight was determined (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `SubstanceDefinition.molecularWeight.method` (new:CodeableConcept)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        ...
        "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-substance-weight-method-for-R4|0.1.0"
      }
    }]
  }
}
