# ExtensionSpecimenDefinition_LastReviewDate - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: The date on which the asset content was last reviewed by the publisher (new) 
...
```json
{
  ...
  "title" : "R5: The date on which the asset content was last reviewed by the publisher (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `SpecimenDefinition.lastReviewDate` (new:date)",
  "jurisdiction" : [{
    "coding" : [{
