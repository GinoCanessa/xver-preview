# ExtensionChargeItem_OverrideReason - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: overrideReason additional types 
...
```json
{
  ...
  "title" : "R5: overrideReason additional types",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `ChargeItem.overrideReason` additional types (CodeableConcept) additional types from child elements (coding)",
  "jurisdiction" : [{
    "coding" : [{
