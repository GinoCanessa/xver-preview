# ExtensionTestPlan_Purpose - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Why this test plan is defined (new) 

R5: `TestPlan.purpose` (new:markdown)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-TestPlan.purpose)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-TestPlan.purpose.csv), [Excel](../StructureDefinition-ext-R5-TestPlan.purpose.xlsx), [Schematron](../StructureDefinition-ext-R5-TestPlan.purpose.sch) 
...
```json
{
  ...
  "version" : "0.1.0",
  "name" : "ExtensionTestPlan_Purpose",
  "title" : "R5: Why this test plan is defined (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `TestPlan.purpose` (new:markdown)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "purpose" : "This extension is part of the cross-version definitions generated to enable use of the\r\nelement `TestPlan.purpose` as defined in FHIR R5\r\nin FHIR R4.\r\n\r\nThe source element is defined as:\r\n`TestPlan.purpose` 0..1 `markdown`\r\n\r\nAcross FHIR versions, the element set has been mapped as:\r\n* R5 `TestPlan.purpose` 0..1 `markdown`\r\n\r\nFollowing are the generation technical comments:\r\nElement `TestPlan.purpose` is not mapped to FHIR R4, since FHIR R5 `TestPlan` is not mapped.\nElement `TestPlan.purpose` has no mapping targets in FHIR R4. Typically, this is because the element has been added (is a new element).",
  "fhirVersion" : "4.0.1",
  "mapping" : [{
    "identity" : "rim",
    "uri" : "http://hl7.org/v3",
