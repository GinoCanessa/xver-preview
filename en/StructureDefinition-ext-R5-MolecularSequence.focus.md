# ExtensionMolecularSequence_Focus - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: What the molecular sequence is about, when it is not about the subject of record (new) 
...
```json
{
  ...
  "title" : "R5: What the molecular sequence is about, when it is not about the subject of record (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `MolecularSequence.focus` (new:Reference(Resource))",
  "jurisdiction" : [{
    "coding" : [{
