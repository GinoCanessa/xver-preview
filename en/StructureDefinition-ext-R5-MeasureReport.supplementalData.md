# ExtensionMeasureReport_SupplementalData - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Additional information collected for the report (new) 

R5: `MeasureReport.supplementalData` (new:Reference(Resource))
...
```json
{
  ...
  "title" : "R5: Additional information collected for the report (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `MeasureReport.supplementalData` (new:Reference(Resource))",
  "jurisdiction" : [{
    "coding" : [{
