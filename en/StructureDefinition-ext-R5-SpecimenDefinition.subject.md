# ExtensionSpecimenDefinition_Subject - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Type of subject for specimen collection (new) 
...
```json
{
  ...
  "title" : "R5: Type of subject for specimen collection (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `SpecimenDefinition.subject[x]` (new:CodeableConcept, Reference(Group))",
  "jurisdiction" : [{
    "coding" : [{
