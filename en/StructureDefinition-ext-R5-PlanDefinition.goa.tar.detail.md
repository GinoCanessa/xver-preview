# ExtensionPlanDefinition_Goal_Target_Detail - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: detail additional types 
...
```json
{
  ...
  "title" : "R5: detail additional types",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `PlanDefinition.goal.target.detail[x]` additional types (string, boolean, integer, Ratio)",
  "jurisdiction" : [{
    "coding" : [{
