# ExtensionRequestOrchestration_Action_Participant_Type - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: careteam | device | group | healthcareservice | location | organization | patient | practitioner | practitionerrole | relatedperson (new) 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-RequestOrchestration.act.par.type)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-RequestOrchestration.act.par.type.csv), [Excel](../StructureDefinition-ext-R5-RequestOrchestration.act.par.type.xlsx), [Schematron](../StructureDefinition-ext-R5-RequestOrchestration.act.par.type.sch) 
...
```json
{
  ...
  "id" : "ext-R5-RequestOrchestration.act.par.type",
  "extension" : [{
  ...
  "version" : "0.1.0",
  "name" : "ExtensionRequestOrchestration_Action_Participant_Type",
  "title" : "R5: careteam | device | group | healthcareservice | location | organization | patient | practitioner | practitionerrole | relatedperson (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `RequestOrchestration.action.participant.type` (new:code)",
  "jurisdiction" : [{
    "coding" : [{
