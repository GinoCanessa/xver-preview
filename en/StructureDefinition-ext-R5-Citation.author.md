# ExtensionCitation_Author - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Who authored the citation record (new) 

R5: `Citation.author` (new:ContactDetail)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-Citation.author)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-Citation.author.csv), [Excel](../StructureDefinition-ext-R5-Citation.author.xlsx), [Schematron](../StructureDefinition-ext-R5-Citation.author.sch) 
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Citation.author",
  "version" : "0.1.0",
  "name" : "ExtensionCitation_Author",
  "title" : "R5: Who authored the citation record (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Citation.author` (new:ContactDetail)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Citation.author"
    },
    {
