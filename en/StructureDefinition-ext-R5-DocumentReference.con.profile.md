# ExtensionDocumentReference_Content_Profile - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Content profile rules for the document (new) 

R5: `DocumentReference.content.profile` (new:BackboneElement)
...
```json
{
  ...
  "title" : "R5: Content profile rules for the document (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `DocumentReference.content.profile` (new:BackboneElement)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "path" : "Extension.extension",
      "sliceName" : "value",
      "short" : "R5: Code|uri|canonical (new)",
      "definition" : "R5: `DocumentReference.content.profile.value[x]` (new:canonical, Coding, uri)",
    ...
    },
    {
      ...
      "binding" : {
        ...
        "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-v3-HL7FormatCodes-for-R4|0.1.0"
      }
    },
    {
      "id" : "Extension.url",
