# AssertionResponseTypes - FHIR Cross-Version Extensions package to use FHIR R5 in FHIR R4 v0.0.1-snapshot-3
...
* [ValueSetR5AssertResponseCodeTypesForR4](ValueSet-ValueSet-R5-assert-response-code-types-for-R4.md)
