# R5AssertResponseCodeTypesForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
```json
{
  ...
  "id" : "R5-assert-response-code-types-for-R4",
  "extension" : [{
  ...
  "url" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-assert-response-code-types-for-R4",
  "version" : "0.1.0",
  "name" : "R5AssertResponseCodeTypesForR4",
