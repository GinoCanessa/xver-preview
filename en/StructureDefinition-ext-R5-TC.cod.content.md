# ExtensionTerminologyCapabilities_CodeSystem_Content - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: not-present | example | fragment | complete | supplement (new) 
...
```json
{
  ...
  "title" : "R5: not-present | example | fragment | complete | supplement (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `TerminologyCapabilities.codeSystem.content` (new:code)",
  "jurisdiction" : [{
    "coding" : [{
