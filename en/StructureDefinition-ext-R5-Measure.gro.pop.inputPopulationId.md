# ExtensionMeasure_Group_Population_InputPopulationId - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Which population (new) 
...
```json
{
  ...
  "description" : "R5: `Measure.group.population.inputPopulationId` (new:string)",
  "jurisdiction" : [{
    "coding" : [{
