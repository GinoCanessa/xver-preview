# ExtensionConceptMap_Topic - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: E.g. Education, Treatment, Assessment, etc (new) 

R5: `ConceptMap.topic` (new:CodeableConcept)
...
```json
{
  ...
  "description" : "R5: `ConceptMap.topic` (new:CodeableConcept)",
  "jurisdiction" : [{
    "coding" : [{
