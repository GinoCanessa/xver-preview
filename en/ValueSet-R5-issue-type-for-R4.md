# R5IssueTypeForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
* [R5: code additional codes](StructureDefinition-ext-R5-OperationOutcome.iss.code.md)
