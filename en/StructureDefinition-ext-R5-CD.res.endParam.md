# ExtensionCompartmentDefinition_Resource_EndParam - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Search Param for interpreting $everything.end (new) 
...
```json
{
  ...
  "title" : "R5: Search Param for interpreting $everything.end (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `CompartmentDefinition.resource.endParam` (new:uri)",
  "jurisdiction" : [{
    "coding" : [{
