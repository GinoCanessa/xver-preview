# ExtensionMedicinalProductDefinition_Status - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: The status within the lifecycle of this product record (new) 

R5: `MedicinalProductDefinition.status` (new:CodeableConcept)
...
```json
{
  ...
  "title" : "R5: The status within the lifecycle of this product record (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `MedicinalProductDefinition.status` (new:CodeableConcept)",
  "jurisdiction" : [{
    "coding" : [{
