# ExtensionInventoryItem_Name - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: The item name(s) - the brand name, or common name, functional name, generic name or others (new) 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-InventoryItem.name)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-InventoryItem.name.csv), [Excel](../StructureDefinition-ext-R5-InventoryItem.name.xlsx), [Schematron](../StructureDefinition-ext-R5-InventoryItem.name.sch) 
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-InventoryItem.name",
  "version" : "0.1.0",
  "name" : "ExtensionInventoryItem_Name",
  "title" : "R5: The item name(s) - the brand name, or common name, functional name, generic name or others (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `InventoryItem.name` (new:BackboneElement)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "purpose" : "This extension is part of the cross-version definitions generated to enable use of the\r\nelement `InventoryItem.name` as defined in FHIR R5\r\nin FHIR R4.\r\n\r\nThe source element is defined as:\r\n`InventoryItem.name` 0..* `BackboneElement`\r\n\r\nAcross FHIR versions, the element set has been mapped as:\r\n* R5 `InventoryItem.name` 0..* `BackboneElement`\r\n\r\nFollowing are the generation technical comments:\r\nElement `InventoryItem.name` is not mapped to FHIR R4, since FHIR R5 `InventoryItem` is not mapped.\nElement `InventoryItem.name` has no mapping targets in FHIR R4. Typically, this is because the element has been added (is a new element).",
  "fhirVersion" : "4.0.1",
  "mapping" : [{
    "identity" : "rim",
    "uri" : "http://hl7.org/v3",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "path" : "Extension.extension",
      "sliceName" : "nameType",
      "short" : "R5: The type of name e.g. 'brand-name', 'functional-name', 'common-name' (new)",
      "definition" : "R5: `InventoryItem.name.nameType` (new:Coding)",
      ...
      "requirements" : "Element `InventoryItem.name.nameType` is part of an existing definition because parent element `InventoryItem.name` requires a cross-version extension.\nElement `InventoryItem.name.nameType` is not mapped to FHIR R4, since FHIR R5 `InventoryItem` is not mapped.\nElement `InventoryItem.name.nameType` has no mapping targets in FHIR R4. Typically, this is because the element has been added (is a new element).",
      "min" : 1,
      "max" : "1",
      "base" : {
        "path" : "Extension.extension",
    ...
    },
    {
      ...
      "binding" : {
        ...
        "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-inventoryitem-nametype-for-R4|0.1.0"
      }
    },
    {
      ...
      "path" : "Extension.extension",
      "sliceName" : "language",
      "short" : "R5: The language used to express the item name (new)",
      "definition" : "R5: `InventoryItem.name.language` (new:code)",
      ...
      "requirements" : "Element `InventoryItem.name.language` is part of an existing definition because parent element `InventoryItem.name` requires a cross-version extension.\nElement `InventoryItem.name.language` is not mapped to FHIR R4, since FHIR R5 `InventoryItem` is not mapped.\nElement `InventoryItem.name.language` has no mapping targets in FHIR R4. Typically, this is because the element has been added (is a new element).",
      "min" : 1,
      "max" : "1",
      "base" : {
        "path" : "Extension.extension",
    ...
    },
    {
      ...
      "path" : "Extension.extension",
      "sliceName" : "name",
      "short" : "R5: The name or designation of the item (new)",
      "definition" : "R5: `InventoryItem.name.name` (new:string)",
      ...
      "requirements" : "Element `InventoryItem.name.name` is part of an existing definition because parent element `InventoryItem.name` requires a cross-version extension.\nElement `InventoryItem.name.name` is not mapped to FHIR R4, since FHIR R5 `InventoryItem` is not mapped.\nElement `InventoryItem.name.name` has no mapping targets in FHIR R4. Typically, this is because the element has been added (is a new element).",
      "min" : 1,
      "max" : "1",
      "base" : {
        "path" : "Extension.extension",
