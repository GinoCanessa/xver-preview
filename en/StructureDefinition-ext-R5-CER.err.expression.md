# ExtensionCoverageEligibilityResponse_Error_Expression - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: FHIRPath of element(s) related to issue (new) 

R5: `CoverageEligibilityResponse.error.expression` (new:string)
...
```json
{
  ...
  "title" : "R5: FHIRPath of element(s) related to issue (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `CoverageEligibilityResponse.error.expression` (new:string)",
  "jurisdiction" : [{
    "coding" : [{
