# ExtensionOrganizationAffiliation_Contact - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Official contact details at the participatingOrganization relevant to this Affiliation (new) 

R5: `OrganizationAffiliation.contact` (new:ExtendedContactDetail)
...
* Use this Extension: [Cross-version Profile for R5.OrganizationAffiliation for use in FHIR R4](StructureDefinition-profile-OrganizationAffiliation.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-OrganizationAffiliation.contact)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-OrganizationAffiliation.contact.csv), [Excel](../StructureDefinition-ext-R5-OrganizationAffiliation.contact.xlsx), [Schematron](../StructureDefinition-ext-R5-OrganizationAffiliation.contact.sch) 
...
```json
{
  ...
  "id" : "ext-R5-OrganizationAffiliation.contact",
  "extension" : [{
  ...
  "version" : "0.1.0",
  "name" : "ExtensionOrganizationAffiliation_Contact",
  "title" : "R5: Official contact details at the participatingOrganization relevant to this Affiliation (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `OrganizationAffiliation.contact` (new:ExtendedContactDetail)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "purpose" : "This extension is part of the cross-version definitions generated to enable use of the\r\nelement `OrganizationAffiliation.contact` as defined in FHIR R5\r\nin FHIR R4.\r\n\r\nThe source element is defined as:\r\n`OrganizationAffiliation.contact` 0..* `ExtendedContactDetail`\r\n\r\nAcross FHIR versions, the element set has been mapped as:\r\n*  R5: `OrganizationAffiliation.contact` 0..* `ExtendedContactDetail`\r\n\r\nFollowing are the generation technical comments:\r\nElement `OrganizationAffiliation.contact` has a context of OrganizationAffiliation based on following the parent source element upwards and mapping to `OrganizationAffiliation`.\nElement `OrganizationAffiliation.contact` has no mapping targets in FHIR R4. Typically, this is because the element has been added (is a new element).",
  "fhirVersion" : "4.0.1",
  "mapping" : [{
    "identity" : "rim",
    "uri" : "http://hl7.org/v3",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-OrganizationAffiliation.contact"
    },
    {
