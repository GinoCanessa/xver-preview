...
```json
{
  ...
  "status" : "active",
  "experimental" : false,
  "date" : "2026-02-21T13:36:54.3597067-06:00",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "short" : "Cross-version extension for Subscription.identifier from R5 for use in FHIR R4",
        ...
        "type" : [
          {
            "code" : "Extension",
            "profile" : [
              "http://hl7.org/fhir/5.0/StructureDefinition/extension-Subscription.identifier|0.0.1-snapshot-3"
            ]
          }
        ]
      },
