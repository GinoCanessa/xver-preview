# ConceptMapR5QuantityComparatorForR4 - FHIR Cross-Version Extensions package to use FHIR R5 in FHIR R4 v0.0.1-snapshot-3
...
```json
{
  ...
  "status" : "active",
  "experimental" : false,
  "date" : "2026-02-09T22:05:37.3307125-06:00",
  "contact" : [
    {
