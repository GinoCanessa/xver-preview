# ExtensionTestPlan_Url - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Canonical identifier for this test plan, represented as a URI (globally unique) (new) 

R5: `TestPlan.url` (new:uri)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-TestPlan.url)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-TestPlan.url.csv), [Excel](../StructureDefinition-ext-R5-TestPlan.url.xlsx), [Schematron](../StructureDefinition-ext-R5-TestPlan.url.sch) 
...
```json
{
  ...
  "version" : "0.1.0",
  "name" : "ExtensionTestPlan_Url",
  "title" : "R5: Canonical identifier for this test plan, represented as a URI (globally unique) (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `TestPlan.url` (new:uri)",
  "jurisdiction" : [{
    "coding" : [{
