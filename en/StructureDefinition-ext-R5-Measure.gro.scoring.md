# ExtensionMeasure_Group_Scoring - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: proportion | ratio | continuous-variable | cohort (new) 
...
```json
{
  ...
  "title" : "R5: proportion | ratio | continuous-variable | cohort (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Measure.group.scoring` (new:CodeableConcept)",
  "jurisdiction" : [{
    "coding" : [{
