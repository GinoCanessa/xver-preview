# ExtensionSubscription_Identifier - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Additional identifiers (business identifier) (new) 
...
```json
{
  ...
  "title" : "R5: Additional identifiers (business identifier) (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Subscription.identifier` (new:Identifier)",
  "jurisdiction" : [{
    "coding" : [{
