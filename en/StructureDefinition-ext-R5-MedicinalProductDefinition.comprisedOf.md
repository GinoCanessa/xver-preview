# ExtensionMedicinalProductDefinition_ComprisedOf - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Types of medicinal manufactured items and/or devices that this product consists of, such as tablets, capsule, or syringes (new) 

R5: `MedicinalProductDefinition.comprisedOf` (new:Reference(ManufacturedItemDefinition,DeviceDefinition))
...
```json
{
  ...
  "title" : "R5: Types of medicinal manufactured items and/or devices that this product consists of, such as tablets, capsule, or syringes (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `MedicinalProductDefinition.comprisedOf` (new:Reference(ManufacturedItemDefinition,DeviceDefinition))",
  "jurisdiction" : [{
    "coding" : [{
