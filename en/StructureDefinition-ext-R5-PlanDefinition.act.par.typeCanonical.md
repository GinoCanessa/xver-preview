# ExtensionPlanDefinition_Action_Participant_TypeCanonical - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
```json
{
  ...
  "description" : "R5: `PlanDefinition.action.participant.typeCanonical` (new:canonical(CapabilityStatement))",
  "jurisdiction" : [{
    "coding" : [{
