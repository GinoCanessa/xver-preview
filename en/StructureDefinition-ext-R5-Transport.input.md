# ExtensionTransport_Input - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Information used to perform transport (new) 

R5: `Transport.input` (new:BackboneElement)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-Transport.input)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-Transport.input.csv), [Excel](../StructureDefinition-ext-R5-Transport.input.xlsx), [Schematron](../StructureDefinition-ext-R5-Transport.input.sch) 
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Transport.input",
  "version" : "0.1.0",
  "name" : "ExtensionTransport_Input",
  "title" : "R5: Information used to perform transport (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Transport.input` (new:BackboneElement)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "purpose" : "This extension is part of the cross-version definitions generated to enable use of the\r\nelement `Transport.input` as defined in FHIR R5\r\nin FHIR R4.\r\n\r\nThe source element is defined as:\r\n`Transport.input` 0..* `BackboneElement`\r\n\r\nAcross FHIR versions, the element set has been mapped as:\r\n* R5 `Transport.input` 0..* `BackboneElement`\r\n\r\nFollowing are the generation technical comments:\r\nElement `Transport.input` is not mapped to FHIR R4, since FHIR R5 `Transport` is not mapped.\nElement `Transport.input` has no mapping targets in FHIR R4. Typically, this is because the element has been added (is a new element).",
  "fhirVersion" : "4.0.1",
  "mapping" : [{
    "identity" : "rim",
    "uri" : "http://hl7.org/v3",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "path" : "Extension.extension",
      "sliceName" : "type",
      "short" : "R5: Label for the input (new)",
      "definition" : "R5: `Transport.input.type` (new:CodeableConcept)",
      ...
      "requirements" : "Inputs are named to enable transport automation to bind data and pass it from one transport to the next. Element `Transport.input.type` is part of an existing definition because parent element `Transport.input` requires a cross-version extension.\nElement `Transport.input.type` is not mapped to FHIR R4, since FHIR R5 `Transport` is not mapped.\nElement `Transport.input.type` has no mapping targets in FHIR R4. Typically, this is because the element has been added (is a new element).",
      "min" : 1,
      "max" : "1",
      "base" : {
        "path" : "Extension.extension",
    ...
    },
    {
      ...
      "path" : "Extension.extension",
      "sliceName" : "value",
      "short" : "R5: Content to use in performing the transport (new)",
      ...
      "requirements" : "Element `Transport.input.value[x]` is part of an existing definition because parent element `Transport.input` requires a cross-version extension.\nElement `Transport.input.value[x]` is not mapped to FHIR R4, since FHIR R5 `Transport` is not mapped.\nElement `Transport.input.value[x]` has no mapping targets in FHIR R4. Typically, this is because the element has been added (is a new element).",
      "min" : 1,
      "max" : "1",
      "base" : {
        "path" : "Extension.extension",
