# ExtensionNutritionOrder_EnteralFormula_DeliveryDevice - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-NutritionOrder.ent.deliveryDevice.csv), [Excel](../StructureDefinition-ext-R5-NutritionOrder.ent.deliveryDevice.xlsx), [Schematron](../StructureDefinition-ext-R5-NutritionOrder.ent.deliveryDevice.sch) 
...
```json
{
  ...
  "id" : "ext-R5-NutritionOrder.ent.deliveryDevice",
  "extension" : [{
  ...
  "description" : "R5: `NutritionOrder.enteralFormula.deliveryDevice` (new:CodeableReference(DeviceDefinition))",
  "jurisdiction" : [{
    "coding" : [{
