# ExtensionAppointment_Note - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: note additional types 
...
```json
{
  ...
  "title" : "R5: note additional types",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Appointment.note` additional types (Annotation) additional types from child elements (time)",
  "jurisdiction" : [{
    "coding" : [{
