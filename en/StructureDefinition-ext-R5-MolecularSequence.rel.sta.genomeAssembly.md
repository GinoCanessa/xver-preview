# ExtensionMolecularSequence_Relative_StartingSequence_GenomeAssembly - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: The genome assembly used for starting sequence, e.g. GRCh38 (new) 
...
```json
{
  ...
  "title" : "R5: The genome assembly used for starting sequence, e.g. GRCh38 (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `MolecularSequence.relative.startingSequence.genomeAssembly` (new:CodeableConcept)",
  "jurisdiction" : [{
    "coding" : [{
