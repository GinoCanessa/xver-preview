# ProfileSubstanceNucleicAcid - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## Resource Profile: ProfileSubstanceNucleicAcid 
...
```json
{
  ...
  "differential" : {
    "element" : [
      ...
      {
        "id" : "Basic.extension:SubstanceNucleicAcid",
        "path" : "Basic.extension",
        "sliceName" : "SubstanceNucleicAcid",
        "short" : "Cross-version extension for SubstanceNucleicAcid from R5 for use in FHIR R4",
        "min" : 1,
        "max" : "1",
        "base" : {
          "path" : "DomainResource.extension",
        ...
        "type" : [
          {
            "code" : "Extension",
            "profile" : [
              "http://hl7.org/fhir/5.0/StructureDefinition/extension-SubstanceNucleicAcid|0.0.1-snapshot-3"
            ]
          }
        ]
      },
