# ExtensionSpecimenDefinition_TypeTested_SingleUse - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Specimen for single use only (new) 
...
```json
{
  ...
  "title" : "R5: Specimen for single use only (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `SpecimenDefinition.typeTested.singleUse` (new:boolean)",
  "jurisdiction" : [{
    "coding" : [{
