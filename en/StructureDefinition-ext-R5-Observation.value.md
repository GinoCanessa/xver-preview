# ExtensionObservation_Value - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: value additional types 

R5: `Observation.value[x]` additional types (Attachment, Reference(http://hl7.org/fhir/StructureDefinition/MolecularSequence))
...
```json
{
  ...
  "description" : "R5: `Observation.value[x]` additional types (Attachment, Reference(http://hl7.org/fhir/StructureDefinition/MolecularSequence))",
  "jurisdiction" : [{
    "coding" : [{
