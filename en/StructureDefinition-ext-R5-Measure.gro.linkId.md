# ExtensionMeasure_Group_LinkId - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Unique id for group in measure (new) 
...
```json
{
  ...
  "title" : "R5: Unique id for group in measure (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Measure.group.linkId` (new:string)",
  "jurisdiction" : [{
    "coding" : [{
