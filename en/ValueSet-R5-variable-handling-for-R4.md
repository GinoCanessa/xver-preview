# R5VariableHandlingForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
* [R5: Values and parameters for a single statistic (new)](StructureDefinition-ext-R5-Evidence.statistic.md)
* [R5: continuous | dichotomous | ordinal | polychotomous (new)](StructureDefinition-ext-R5-EvidenceVariable.handling.md)
...
```json
{
  ...
  "id" : "R5-variable-handling-for-R4",
  "extension" : [{
  ...
  "url" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-variable-handling-for-R4",
  "version" : "0.1.0",
  "name" : "R5VariableHandlingForR4",
