# ExtensionTask_Input_Value - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: value additional types 

R5: `Task.input.value[x]` additional types (CodeableReference, RatioRange, Availability, ExtendedContactDetail)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-Task.inp.value)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-Task.inp.value.csv), [Excel](../StructureDefinition-ext-R5-Task.inp.value.xlsx), [Schematron](../StructureDefinition-ext-R5-Task.inp.value.sch) 
...
```json
{
  ...
  "description" : "R5: `Task.input.value[x]` additional types (CodeableReference, RatioRange, Availability, ExtendedContactDetail)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Task.input.value"
    },
    {
