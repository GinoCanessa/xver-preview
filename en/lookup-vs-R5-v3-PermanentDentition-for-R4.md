# Lookup for R5V3PermanentDentitionForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Lookup for R5V3PermanentDentitionForR4

### Lookup for FHIR R5 ValueSet PermanentDentition:http://terminology.hl7.org/ValueSet/v3-PermanentDentition for use in FHIR R4

The FHIR R5 ValueSet PermanentDentition has no mapping to FHIR R4.
