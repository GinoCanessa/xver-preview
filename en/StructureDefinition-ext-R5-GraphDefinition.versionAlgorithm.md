# ExtensionGraphDefinition_VersionAlgorithm - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: How to compare versions (new) 

R5: `GraphDefinition.versionAlgorithm[x]` (new:Coding, string)
...
```json
{
  ...
  "description" : "R5: `GraphDefinition.versionAlgorithm[x]` (new:Coding, string)",
  "jurisdiction" : [{
    "coding" : [{
