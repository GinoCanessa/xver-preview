# ExtensionSubscription_Status - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: requested | active | error | off | entered-in-error 
...
```json
{
  ...
  "title" : "R5: requested | active | error | off | entered-in-error",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Subscription.status`",
  "jurisdiction" : [{
    "coding" : [{
