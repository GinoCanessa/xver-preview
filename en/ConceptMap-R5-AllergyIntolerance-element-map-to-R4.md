# R5AllergyIntoleranceElementMapToR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
```json
{
  ...
  "status" : "active",
  "experimental" : false,
  "date" : "2026-03-04T17:07:46.1365616-06:00",
  "contact" : [{
  ...
  "group" : [{
    ...
    },
    {
      ...
      "target" : [{
        ...
        "equivalence" : "equivalent",
        "comment" : "Element `AllergyIntolerance.encounter` is mapped to FHIR R4 element `AllergyIntolerance.encounter` as `Equivalent`."
      }]
    },
    {
