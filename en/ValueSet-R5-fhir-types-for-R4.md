# R5FhirTypesForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
* [R5: Population basis (new)](StructureDefinition-ext-R5-Measure.basis.md)
* [R5: Population basis (new)](StructureDefinition-ext-R5-Measure.gro.basis.md)
* [R5: Allowed sub-type this parameter can have (if type is abstract) (new)](StructureDefinition-ext-R5-OperationDefinition.par.allowedType.md)
