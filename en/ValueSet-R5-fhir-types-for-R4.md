# R5FhirTypesForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## ValueSet: Cross-version ValueSet R5.FHIRTypes for use in FHIR R4 

 
This cross-version ValueSet represents content from `http://hl7.org/fhir/ValueSet/fhir-types|5.0.0` for use in FHIR R4. 

 **References** 

* [Cross-version Extension `R5.Measure.basis` for use in FHIR R4](StructureDefinition-ext-R5-Measure.basis.md)
* [Cross-version Extension `R5.Measure.group.basis` for use in FHIR R4](StructureDefinition-ext-R5-Measure.gro.basis.md)
* [Cross-version Extension `R5.OperationDefinition.parameter.allowedType` for use in FHIR R4](StructureDefinition-ext-R5-OperationDefinition.par.allowedType.md)
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-fhir-types-for-R4",
  "version" : "0.0.1-snapshot-3",
  "name" : "R5FhirTypesForR4",
  "title" : "Cross-version ValueSet R5.FHIRTypes for use in FHIR R4",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "This cross-version ValueSet represents content from `http://hl7.org/fhir/ValueSet/fhir-types|5.0.0` for use in FHIR R4.",
  "jurisdiction" : [
    {
      "coding" : [
        {
  ...
  "purpose" : "This value set is part of the cross-version definitions generated to enable use of the\r\nvalue set `http://hl7.org/fhir/ValueSet/fhir-types|5.0.0` as defined in FHIR R5\r\nin FHIR R4.\r\n\r\nThe source value set is bound to the following FHIR R5 elements:\r\n* `DataRequirement.type`\n* `Measure.basis`\n* `Measure.group.basis`\n* `OperationDefinition.parameter.allowedType`\n* `OperationDefinition.parameter.type`\n* `ParameterDefinition.type`\n* `StructureDefinition.type`\r\n\r\nThe following concepts are not included in this cross-version definition because they have valid representations\r\n* _no concepts_\r\n\r\nFollowing are the generation technical comments:\r\n\nFHIR ValueSet `http://hl7.org/fhir/ValueSet/fhir-types|5.0.0`, defined in FHIR R5 does not have any mapping to FHIR R4",
  "compose" : {
    "include" : [
      {
