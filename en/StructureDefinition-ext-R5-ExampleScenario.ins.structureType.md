# ExtensionExampleScenario_Instance_StructureType - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## Extension: Cross-version Extension `R5.ExampleScenario.instance.structureType` for use in FHIR R4 

This cross-version extension represents the FHIR R5 element `ExampleScenario.instance.structureType` for use in FHIR R4.
...
```json
{
  ...
  "title" : "Cross-version Extension `R5.ExampleScenario.instance.structureType` for use in FHIR R4",
  "status" : "active",
  "experimental" : false,
    ...
    "element" : [
      ...
      },
      {
        ...
        "binding" : {
          ...
          "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-examplescenario-instance-type-for-R4|0.0.1-snapshot-3"
        }
      }
    ]
  }
