# Lookup for R5V3SupernumeraryToothForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## Lookup for R5V3SupernumeraryToothForR4

### Lookup for FHIR R5 ValueSet SupernumeraryTooth:http://terminology.hl7.org/ValueSet/v3-SupernumeraryTooth for use in FHIR R4

The FHIR R5 ValueSet SupernumeraryTooth has no mapping to FHIR R4.
