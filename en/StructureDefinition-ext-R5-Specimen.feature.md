# ExtensionSpecimen_Feature - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: The physical feature of a specimen (new) 

R5: `Specimen.feature` (new:BackboneElement)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-Specimen.feature.csv), [Excel](../StructureDefinition-ext-R5-Specimen.feature.xlsx), [Schematron](../StructureDefinition-ext-R5-Specimen.feature.sch) 
...
```json
{
  ...
  "version" : "0.1.0",
  "name" : "ExtensionSpecimen_Feature",
  "title" : "R5: The physical feature of a specimen (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Specimen.feature` (new:BackboneElement)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "path" : "Extension.extension",
      "sliceName" : "type",
      "short" : "R5: Highlighted feature (new)",
      "definition" : "R5: `Specimen.feature.type` (new:CodeableConcept)",
    ...
    },
    {
      ...
      "short" : "R5: Information about the feature (new)",
      "definition" : "R5: `Specimen.feature.description` (new:string)",
