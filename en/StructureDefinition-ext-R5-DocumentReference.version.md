# ExtensionDocumentReference_Version - FHIR Cross-Version Extensions package to use FHIR R5 in FHIR R4 v0.0.1-snapshot-3
...
```json
{
  ...
  "purpose" : "This extension is part of the cross-version definitions generated to enable use of the\r\nelement `DocumentReference.version` as defined in FHIR R5\r\nin FHIR R4.\r\n\r\nThe source element is defined as:\r\n`DocumentReference.version` 0..1 `string`\r\n\r\nAcross FHIR versions, the element set has been mapped as:\r\n*  R5: `DocumentReference.version` 0..1 `string`\n*  R5: `DocumentReference.version` 0..1 `string`\r\n\r\nFollowing are the generation technical comments:\r\nElement `DocumentReference.version` is mapped to FHIR R4 structure `DocumentReference`, but has no target element specified.\nElement `DocumentReference.version` is mapped to FHIR R4 structure `Media`, but has no target element specified.",
  "fhirVersion" : "4.0.1",
  "mapping" : [
    {
      "identity" : "rim",
