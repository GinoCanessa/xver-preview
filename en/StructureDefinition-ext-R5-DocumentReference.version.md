# ExtensionDocumentReference_Version - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: An explicitly assigned identifer of a variation of the content in the DocumentReference (new) 

R5: `DocumentReference.version` (new:string)
...
```json
{
  ...
  "title" : "R5: An explicitly assigned identifer of a variation of the content in the DocumentReference (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `DocumentReference.version` (new:string)",
  "jurisdiction" : [{
    "coding" : [{
