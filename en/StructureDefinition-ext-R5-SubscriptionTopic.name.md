# ExtensionSubscriptionTopic_Name - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Name for this subscription topic (computer friendly) (new) 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-SubscriptionTopic.name)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-SubscriptionTopic.name.csv), [Excel](../StructureDefinition-ext-R5-SubscriptionTopic.name.xlsx), [Schematron](../StructureDefinition-ext-R5-SubscriptionTopic.name.sch) 
...
```json
{
  ...
  "id" : "ext-R5-SubscriptionTopic.name",
  "extension" : [{
  ...
  "version" : "0.1.0",
  "name" : "ExtensionSubscriptionTopic_Name",
  "title" : "R5: Name for this subscription topic (computer friendly) (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `SubscriptionTopic.name` (new:string)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-SubscriptionTopic.name"
    },
    {
