# ExtensionClinicalImpression_ChangePattern - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Change in the status/pattern of a subject's condition since previously assessed, such as worsening, improving, or no change (new) 
...
```json
{
  ...
  "title" : "R5: Change in the status/pattern of a subject's condition since previously assessed, such as worsening, improving, or no change (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `ClinicalImpression.changePattern` (new:CodeableConcept)",
  "jurisdiction" : [{
    "coding" : [{
