# ExtensionChargeItem_Service - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: service additional types 
...
```json
{
  ...
  "title" : "R5: service additional types",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `ChargeItem.service` additional types (CodeableReference(http://hl7.org/fhir/StructureDefinition/DiagnosticReport), CodeableReference(http://hl7.org/fhir/StructureDefinition/ImagingStudy), CodeableReference(http://hl7.org/fhir/StructureDefinition/Immunization), CodeableReference(http://hl7.org/fhir/StructureDefinition/MedicationAdministration), CodeableReference(http://hl7.org/fhir/StructureDefinition/MedicationDispense), CodeableReference(http://hl7.org/fhir/StructureDefinition/MedicationRequest), CodeableReference(http://hl7.org/fhir/StructureDefinition/Observation), CodeableReference(http://hl7.org/fhir/StructureDefinition/Procedure), CodeableReference(http://hl7.org/fhir/StructureDefinition/ServiceRequest), CodeableReference(http://hl7.org/fhir/StructureDefinition/SupplyDelivery))",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["http://hl7.org/fhir/5.0/StructureDefinition/profile-DiagnosticReport|0.1.0",
        ...
        "http://hl7.org/fhir/5.0/StructureDefinition/profile-Immunization|0.1.0",
        "http://hl7.org/fhir/StructureDefinition/Immunization|4.0.1",
        "http://hl7.org/fhir/5.0/StructureDefinition/profile-MedicationAdministration|0.1.0",
        "http://hl7.org/fhir/StructureDefinition/MedicationAdministration|4.0.1",
        "http://hl7.org/fhir/5.0/StructureDefinition/profile-MedicationDispense|0.1.0",
        ...
        "http://hl7.org/fhir/5.0/StructureDefinition/profile-SupplyDelivery|0.1.0",
