# R5SubscriptionStatusForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
* [R5: requested | active | error | off | entered-in-error](StructureDefinition-ext-R5-Subscription.status.md)
* [R5: requested | active | error | off | entered-in-error (new)](StructureDefinition-ext-R5-SubscriptionStatus.status.md)
...
```json
{
  ...
  "id" : "R5-subscription-status-for-R4",
  "extension" : [{
  ...
  "url" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-subscription-status-for-R4",
  "version" : "0.1.0",
  "name" : "R5SubscriptionStatusForR4",
