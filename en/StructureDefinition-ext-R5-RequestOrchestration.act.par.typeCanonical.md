# ExtensionRequestOrchestration_Action_Participant_TypeCanonical - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-RequestOrchestration.act.par.typeCanonical)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-RequestOrchestration.act.par.typeCanonical.csv), [Excel](../StructureDefinition-ext-R5-RequestOrchestration.act.par.typeCanonical.xlsx), [Schematron](../StructureDefinition-ext-R5-RequestOrchestration.act.par.typeCanonical.sch) 
...
```json
{
  ...
  "id" : "ext-R5-RequestOrchestration.act.par.typeCanonical",
  "extension" : [{
  ...
  "version" : "0.1.0",
  "name" : "ExtensionRequestOrchestration_Action_Participant_TypeCanonical",
  ...
  "description" : "R5: `RequestOrchestration.action.participant.typeCanonical` (new:canonical(CapabilityStatement))",
  "jurisdiction" : [{
    "coding" : [{
