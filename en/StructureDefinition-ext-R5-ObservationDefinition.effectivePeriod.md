# ExtensionObservationDefinition_EffectivePeriod - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: The effective date range for the ObservationDefinition (new) 
...
```json
{
  ...
  "title" : "R5: The effective date range for the ObservationDefinition (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `ObservationDefinition.effectivePeriod` (new:Period)",
  "jurisdiction" : [{
    "coding" : [{
