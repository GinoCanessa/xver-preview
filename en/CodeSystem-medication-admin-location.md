# MedicationAdministrationLocationCodes - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## CodeSystem: MedicationAdministrationLocationCodes 
...
* [R5MedicationAdminLocationForR4](ValueSet-R5-medication-admin-location-for-R4.md)
...
```json
{
  ...
  "caseSensitive" : true,
  "valueSet" : "http://terminology.hl7.org/ValueSet/medication-admin-location|1.0.1",
  "content" : "complete",
  "concept" : [
    {
      "code" : "inpatient",
