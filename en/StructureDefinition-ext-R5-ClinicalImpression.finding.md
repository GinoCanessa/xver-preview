# ExtensionClinicalImpression_Finding - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## Extension: Cross-version Extension `R5.ClinicalImpression.finding` for use in FHIR R4 

This cross-version extension represents the FHIR R5 element `ClinicalImpression.finding` for use in FHIR R4.
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-ClinicalImpression.finding)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-ClinicalImpression.finding.csv), [Excel](../StructureDefinition-ext-R5-ClinicalImpression.finding.xlsx), [Schematron](../StructureDefinition-ext-R5-ClinicalImpression.finding.sch) 
...
```json
{
  ...
  "id" : "ext-R5-ClinicalImpression.finding",
  "extension" : [
    {
  ...
  "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-ClinicalImpression.finding",
  "version" : "0.0.1-snapshot-3",
  "name" : "ExtensionClinicalImpression_Finding",
  "title" : "Cross-version Extension `R5.ClinicalImpression.finding` for use in FHIR R4",
  "status" : "active",
  "experimental" : false,
  ...
  "purpose" : "This extension is part of the cross-version definitions generated to enable use of the\r\nelement `ClinicalImpression.finding` as defined in FHIR R5\r\nin FHIR R4.\r\n\r\nThe source element is defined as:\r\n`ClinicalImpression.finding` 0..* `BackboneElement`\r\n\r\nAcross FHIR versions, the element set has been mapped as:\r\n*  R5: `ClinicalImpression.finding` 0..* `BackboneElement`\n*  R4B: `ClinicalImpression.finding` 0..* `BackboneElement`\n*  R4: `ClinicalImpression.finding` 0..* `BackboneElement`\r\n\r\nFollowing are the generation technical comments:\r\nElement `ClinicalImpression.finding` has is mapped to FHIR R4 element `ClinicalImpression.finding`, but has no comparisons.",
  "fhirVersion" : "4.0.1",
  "mapping" : [
    {
      "identity" : "rim",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "requirements" : "Element `ClinicalImpression.finding.basis` is part of an existing definition because parent element `ClinicalImpression.finding` requires a cross-version extension.\nElement `ClinicalImpression.finding.basis` has is mapped to FHIR R4 element `ClinicalImpression.finding.basis`, but has no comparisons.",
        "min" : 0,
        "max" : "1",
        "base" : {
          "path" : "Extension.extension",
      ...
      },
      {
        ...
        "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-ClinicalImpression.finding.basis"
      },
      {
      ...
      },
      {
        ...
        "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-ClinicalImpression.finding"
      },
      {
