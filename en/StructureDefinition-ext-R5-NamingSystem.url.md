# ExtensionNamingSystem_Url - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Canonical identifier for this naming system, represented as a URI (globally unique) (new) 
...
```json
{
  ...
  "title" : "R5: Canonical identifier for this naming system, represented as a URI (globally unique) (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `NamingSystem.url` (new:uri)",
  "jurisdiction" : [{
    "coding" : [{
