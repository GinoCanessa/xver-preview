# R5MedicationStatementAdherenceForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
* [R5: Indicates whether the medication is or is not being consumed or administered (new)](StructureDefinition-ext-R5-MedicationStatement.adherence.md)
