# ExtensionClinicalImpression_Status - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: preparation | in-progress | not-done | on-hold | stopped | completed | entered-in-error | unknown 
...
```json
{
  ...
  "title" : "R5: preparation | in-progress | not-done | on-hold | stopped | completed | entered-in-error | unknown",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `ClinicalImpression.status`",
  "jurisdiction" : [{
    "coding" : [{
