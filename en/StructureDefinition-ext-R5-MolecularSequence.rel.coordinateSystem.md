# ExtensionMolecularSequence_Relative_CoordinateSystem - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Ways of identifying nucleotides or amino acids within a sequence (new) 
...
```json
{
  ...
  "title" : "R5: Ways of identifying nucleotides or amino acids within a sequence (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `MolecularSequence.relative.coordinateSystem` (new:CodeableConcept)",
  "jurisdiction" : [{
    "coding" : [{
