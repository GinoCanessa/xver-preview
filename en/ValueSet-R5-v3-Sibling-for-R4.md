# R5V3SiblingForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## ValueSet: Cross-version ValueSet R5.Sibling for use in FHIR R4 
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-v3-Sibling-for-R4",
  "version" : "0.0.1-snapshot-3",
  "name" : "R5V3SiblingForR4",
  "title" : "Cross-version ValueSet R5.Sibling for use in FHIR R4",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "This cross-version ValueSet represents content from `http://terminology.hl7.org/ValueSet/v3-Sibling|2.0.0` for use in FHIR R4.",
  "jurisdiction" : [
    {
      "coding" : [
        {
