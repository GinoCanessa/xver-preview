# ExtensionElementDefinition_MustHaveValue - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: For primitives, that a value must be present - not replaced by an extension (new) 
...
```json
{
  ...
  "title" : "R5: For primitives, that a value must be present - not replaced by an extension (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `ElementDefinition.mustHaveValue` (new:boolean)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    "element" : [{
      "id" : "Extension",
      "path" : "Extension",
      "short" : "R5: For primitives, that a value must be present - not replaced by an extension (new)",
      "definition" : "R5: `ElementDefinition.mustHaveValue` (new:boolean)",
