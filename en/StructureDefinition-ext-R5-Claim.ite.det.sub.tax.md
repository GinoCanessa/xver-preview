# ExtensionClaim_Item_Detail_SubDetail_Tax - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
```json
{
  ...
  "description" : "R5: `Claim.item.detail.subDetail.tax` (new:Money)",
  "jurisdiction" : [{
    "coding" : [{
