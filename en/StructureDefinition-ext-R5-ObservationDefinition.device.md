# ExtensionObservationDefinition_Device - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Measurement device or model of device (new) 
...
```json
{
  ...
  "title" : "R5: Measurement device or model of device (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `ObservationDefinition.device` (new:Reference(DeviceDefinition,Device))",
  "jurisdiction" : [{
    "coding" : [{
