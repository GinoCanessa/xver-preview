# ExtensionProcedure_Reported - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Reported rather than primary record (new) 
...
```json
{
  ...
  "title" : "R5: Reported rather than primary record (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Procedure.reported[x]` (new:boolean, Reference(Patient,RelatedPerson,Practitioner,PractitionerRole,Organization))",
  "jurisdiction" : [{
    "coding" : [{
