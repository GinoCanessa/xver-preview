# ExtensionDiagnosticReport_Composition - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Reference to a Composition resource for the DiagnosticReport structure (new) 
...
```json
{
  ...
  "title" : "R5: Reference to a Composition resource for the DiagnosticReport structure (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `DiagnosticReport.composition` (new:Reference(Composition))",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["http://hl7.org/fhir/5.0/StructureDefinition/profile-Composition|0.1.0",
