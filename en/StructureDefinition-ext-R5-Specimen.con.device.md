# ExtensionSpecimen_Container_Device - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Device resource for the container (new) 

R5: `Specimen.container.device` (new:Reference(Device))
...
```json
{
  ...
  "title" : "R5: Device resource for the container (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Specimen.container.device` (new:Reference(Device))",
  "jurisdiction" : [{
    "coding" : [{
