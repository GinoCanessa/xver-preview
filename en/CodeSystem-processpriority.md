# ProcessPriorityCodes - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3
...
```json
{
  ...
  "caseSensitive" : true,
  "valueSet" : "http://terminology.hl7.org/ValueSet/process-priority|1.0.1",
  "content" : "complete",
  "concept" : [
    {
      "code" : "stat",
