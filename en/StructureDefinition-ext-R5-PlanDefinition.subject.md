# ExtensionPlanDefinition_Subject - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: subject additional types 

R5: `PlanDefinition.subject[x]` additional types (canonical(http://hl7.org/fhir/StructureDefinition/EvidenceVariable))
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-PlanDefinition.subject)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-PlanDefinition.subject.csv), [Excel](../StructureDefinition-ext-R5-PlanDefinition.subject.xlsx), [Schematron](../StructureDefinition-ext-R5-PlanDefinition.subject.sch) 
...
```json
{
  ...
  "id" : "ext-R5-PlanDefinition.subject",
  "extension" : [{
  ...
  "version" : "0.1.0",
  "name" : "ExtensionPlanDefinition_Subject",
  "title" : "R5: subject additional types",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `PlanDefinition.subject[x]` additional types (canonical(http://hl7.org/fhir/StructureDefinition/EvidenceVariable))",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-PlanDefinition.subject"
    },
    {
