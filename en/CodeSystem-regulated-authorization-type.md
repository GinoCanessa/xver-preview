# RegulatedAuthorizationType - FHIR Cross-Version Extensions package to use FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## CodeSystem: RegulatedAuthorizationType 
...
* [ValueSetR5RegulatedAuthorizationTypeForR4](ValueSet-ValueSet-R5-regulated-authorization-type-for-R4.md)
...
```json
{
  ...
  "title" : "Regulated Authorization Type",
  "status" : "active",
  "experimental" : false,
