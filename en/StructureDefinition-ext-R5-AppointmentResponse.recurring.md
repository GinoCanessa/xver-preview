# ExtensionAppointmentResponse_Recurring - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: This response is for all occurrences in a recurring request (new) 
...
```json
{
  ...
  "title" : "R5: This response is for all occurrences in a recurring request (new)",
  "status" : "active",
  "experimental" : false,
