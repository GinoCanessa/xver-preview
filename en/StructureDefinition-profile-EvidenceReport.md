# ProfileEvidenceReport - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## Resource Profile: ProfileEvidenceReport 
...
```json
{
  ...
  "differential" : {
    "element" : [
      ...
      {
        "id" : "Basic.extension:EvidenceReport",
        "path" : "Basic.extension",
        "sliceName" : "EvidenceReport",
        "short" : "Cross-version extension for EvidenceReport from R5 for use in FHIR R4",
        "min" : 1,
        "max" : "1",
        "base" : {
          "path" : "DomainResource.extension",
        ...
        "type" : [
          {
            "code" : "Extension",
            "profile" : [
              "http://hl7.org/fhir/5.0/StructureDefinition/extension-EvidenceReport|0.0.1-snapshot-3"
            ]
          }
        ]
      },
