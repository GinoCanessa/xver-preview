# ExtensionMeasure_Group_Population_LinkId - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Unique id for population in measure (new) 
...
```json
{
  ...
  "title" : "R5: Unique id for population in measure (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Measure.group.population.linkId` (new:string)",
  "jurisdiction" : [{
    "coding" : [{
