# ExtensionHealthcareService_Contact - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Official contact details for the HealthcareService (new) 
...
* Use this Extension: [Cross-version Profile for R5.HealthcareService for use in FHIR R4](StructureDefinition-profile-HealthcareService.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-HealthcareService.contact)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-HealthcareService.contact.csv), [Excel](../StructureDefinition-ext-R5-HealthcareService.contact.xlsx), [Schematron](../StructureDefinition-ext-R5-HealthcareService.contact.sch) 
...
```json
{
  ...
  "id" : "ext-R5-HealthcareService.contact",
  "extension" : [{
  ...
  "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-HealthcareService.contact",
  "version" : "0.1.0",
  "name" : "ExtensionHealthcareService_Contact",
  "title" : "R5: Official contact details for the HealthcareService (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `HealthcareService.contact` (new:ExtendedContactDetail)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-HealthcareService.contact"
    },
    {
