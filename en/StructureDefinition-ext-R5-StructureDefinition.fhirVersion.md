# ExtensionStructureDefinition_FhirVersion - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: fhirVersion 

R5: `StructureDefinition.fhirVersion`
...
```json
{
  ...
  "description" : "R5: `StructureDefinition.fhirVersion`",
  "jurisdiction" : [{
    "coding" : [{
