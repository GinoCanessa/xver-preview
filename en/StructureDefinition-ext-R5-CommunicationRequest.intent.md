# ExtensionCommunicationRequest_Intent - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: proposal | plan | directive | order | original-order | reflex-order | filler-order | instance-order | option (new) 

R5: `CommunicationRequest.intent` (new:code)
...
```json
{
  ...
  "title" : "R5: proposal | plan | directive | order | original-order | reflex-order | filler-order | instance-order | option (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `CommunicationRequest.intent` (new:code)",
  "jurisdiction" : [{
    "coding" : [{
