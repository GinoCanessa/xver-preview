# SpecimenContainedPreference - FHIR Cross-Version Extensions package to use FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## CodeSystem: SpecimenContainedPreference 
...
```json
{
  ...
  "title" : "Specimen Contained Preference",
  "status" : "active",
  "experimental" : false,
