# R5FHIRVersionForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3
...
* [Cross-version Extension `R5.ImplementationGuide.definition.resource` for use in FHIR R4](StructureDefinition-ext-R5-ImplementationGuide.def.resource.md)
