# ExtensionCoverage_CostToBeneficiary_Unit - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Individual or family (new) 

R5: `Coverage.costToBeneficiary.unit` (new:CodeableConcept)
...
```json
{
  ...
  "title" : "R5: Individual or family (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Coverage.costToBeneficiary.unit` (new:CodeableConcept)",
  "jurisdiction" : [{
    "coding" : [{
