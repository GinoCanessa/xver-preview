# R5DirectnessForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-directness-for-R4",
  "version" : "0.1.0",
  "name" : "R5DirectnessForR4",
