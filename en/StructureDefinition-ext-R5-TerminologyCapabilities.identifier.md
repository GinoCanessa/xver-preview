# ExtensionTerminologyCapabilities_Identifier - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Additional identifier for the terminology capabilities (new) 

R5: `TerminologyCapabilities.identifier` (new:Identifier)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-TerminologyCapabilities.identifier)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-TerminologyCapabilities.identifier.csv), [Excel](../StructureDefinition-ext-R5-TerminologyCapabilities.identifier.xlsx), [Schematron](../StructureDefinition-ext-R5-TerminologyCapabilities.identifier.sch) 
...
```json
{
  ...
  "id" : "ext-R5-TerminologyCapabilities.identifier",
  "extension" : [{
  ...
  "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-TerminologyCapabilities.identifier",
  "version" : "0.1.0",
  "name" : "ExtensionTerminologyCapabilities_Identifier",
  "title" : "R5: Additional identifier for the terminology capabilities (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `TerminologyCapabilities.identifier` (new:Identifier)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-TerminologyCapabilities.identifier"
    },
    {
