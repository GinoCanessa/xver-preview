# BiologicallyDerivedProductStatus - FHIR Cross-Version Extensions package to use FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## CodeSystem: BiologicallyDerivedProductStatus 
...
```json
{
  ...
  "title" : "Biologically Derived Product Status",
  "status" : "active",
  "experimental" : false,
