# ExtensionAccount_BillingStatus - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3
    ...
    "element" : [
      ...
      },
      {
        ...
        "binding" : {
          ...
          "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-account-billing-status-for-R4|0.0.1-snapshot-3"
        }
      }
    ]
  }
