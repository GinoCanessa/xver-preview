# ExtensionEvidenceReport_Author - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Who authored the content (new) 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-EvidenceReport.author)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-EvidenceReport.author.csv), [Excel](../StructureDefinition-ext-R5-EvidenceReport.author.xlsx), [Schematron](../StructureDefinition-ext-R5-EvidenceReport.author.sch) 
...
```json
{
  ...
  "id" : "ext-R5-EvidenceReport.author",
  "extension" : [{
  ...
  "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-EvidenceReport.author",
  "version" : "0.1.0",
  "name" : "ExtensionEvidenceReport_Author",
  "title" : "R5: Who authored the content (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `EvidenceReport.author` (new:ContactDetail)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-EvidenceReport.author"
    },
    {
