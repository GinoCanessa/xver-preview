# ExtensionOperationDefinition_Parameter_Scope - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: instance | type | system (new) 

R5: `OperationDefinition.parameter.scope` (new:code)
...
```json
{
  ...
  "title" : "R5: instance | type | system (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `OperationDefinition.parameter.scope` (new:code)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-operation-parameter-scope-for-R4|0.1.0"
      }
    }]
  }
}
