# ExtensionEvidenceVariable_Characteristic_Note - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
```json
{
  ...
  "description" : "R5: `EvidenceVariable.characteristic.note` (new:Annotation)",
  "jurisdiction" : [{
    "coding" : [{
