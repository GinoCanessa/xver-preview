# ExtensionMeasure_Term - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## Extension: Cross-version Extension `R5.Measure.term` for use in FHIR R4 

This cross-version extension represents the FHIR R5 element `Measure.term` for use in FHIR R4.
...
```json
{
  ...
  "title" : "Cross-version Extension `R5.Measure.term` for use in FHIR R4",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "This cross-version extension represents the FHIR R5 element `Measure.term` for use in FHIR R4.",
  "jurisdiction" : [
    {
      "coding" : [
        {
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "requirements" : "Element `Measure.term.code` has a context of Measure based on following the parent source element upwards and mapping to `Measure`.",
        "min" : 0,
        "max" : "1",
        "base" : {
          "path" : "Extension.extension",
      ...
      },
      {
        ...
        "binding" : {
          ...
          "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-measure-definition-example-for-R4|0.0.1-snapshot-3"
        }
      },
      {
        ...
        "requirements" : "Element `Measure.term.definition` has a context of Measure based on following the parent source element upwards and mapping to `Measure`.",
        "min" : 0,
        "max" : "1",
        "base" : {
          "path" : "Extension.extension",
