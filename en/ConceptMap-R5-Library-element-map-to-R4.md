# R5LibraryElementMapToR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
```json
{
  ...
  "status" : "active",
  "experimental" : false,
  "date" : "2026-03-04T17:07:49.8788261-06:00",
  "contact" : [{
  ...
  "group" : [{
    ...
    "element" : [{
      ...
      "target" : [{
        "code" : "Library.meta",
        "display" : "Library.meta",
        "equivalence" : "equivalent",
        "comment" : "Element `Library.meta` is mapped to FHIR R4 element `Library.meta` as `Equivalent`."
      }]
    },
    {
      ...
      "target" : [{
        "code" : "Library.implicitRules",
        "display" : "Library.implicitRules",
        "equivalence" : "equivalent",
        "comment" : "Element `Library.implicitRules` is mapped to FHIR R4 element `Library.implicitRules` as `Equivalent`.\nAsserting this rule set restricts the content to be only understood by a limited set of trading partners. This inherently limits the usefulness of the data in the long term. However, the existing health eco-system is highly fractured, and not yet ready to define, collect, and exchange data in a generally computable sense. Wherever possible, implementers and/or specification writers should avoid using this element. Often, when used, the URL is a reference to an implementation guide that defines these special rules as part of its narrative along with other profiles, value sets, etc."
      }]
    },
    {
    ...
    },
    {
      ...
      "target" : [{
        "code" : "Library.text",
        "display" : "Library.text",
        "equivalence" : "equivalent",
        "comment" : "Element `Library.text` is mapped to FHIR R4 element `Library.text` as `Equivalent`.\nContained resources do not have a narrative. Resources that are not contained SHOULD have a narrative. In some cases, a resource may only have text with little or no additional discrete data (as long as all minOccurs=1 elements are satisfied).  This may be necessary for data from legacy systems where information is captured as a \"text blob\" or where text is additionally entered raw or narrated and encoded information is added later."
      }]
    },
    {
      ...
      "target" : [{
        "code" : "Library.contained",
        "display" : "Library.contained",
        "equivalence" : "equivalent",
        "comment" : "Element `Library.contained` is mapped to FHIR R4 element `Library.contained` as `Equivalent`.\nThis should never be done when the content can be identified properly, as once identification is lost, it is extremely difficult (and context dependent) to restore it again. Contained resources may have profiles and tags in their meta elements, but SHALL NOT have security labels."
      }]
    },
    {
      "code" : "Library.url",
    ...
    },
    {
      ...
      "target" : [{
        ...
        "equivalence" : "equivalent",
        "comment" : "Element `Library.name` is mapped to FHIR R4 element `Library.name` as `Equivalent`.\nThe name is not expected to be globally unique. The name should be a simple alphanumeric type name to ensure that it is machine-processing friendly."
      }]
    },
    {
      "code" : "Library.title",
      ...
      "target" : [{
        ...
        "equivalence" : "equivalent",
        "comment" : "Element `Library.title` is mapped to FHIR R4 element `Library.title` as `Equivalent`.\nThis name does not need to be machine-processing friendly and may contain punctuation, white-space, etc."
      }]
    },
    {
      ...
      "target" : [{
        "code" : "Library.subtitle",
        "display" : "Library.subtitle",
        "equivalence" : "equivalent",
        "comment" : "Element `Library.subtitle` is mapped to FHIR R4 element `Library.subtitle` as `Equivalent`."
      }]
    },
    {
      "code" : "Library.status",
    ...
    },
    {
      ...
      "target" : [{
        "code" : "Library.experimental",
        "display" : "Library.experimental",
        "equivalence" : "equivalent",
        "comment" : "Element `Library.experimental` is mapped to FHIR R4 element `Library.experimental` as `Equivalent`.\nAllows filtering of librarys that are appropriate for use versus not."
      }]
    },
    {
      "code" : "Library.type",
      ...
      "target" : [{
        ...
        "equivalence" : "equivalent",
        "comment" : "Element `Library.type` is mapped to FHIR R4 element `Library.type` as `Equivalent`."
      }]
    },
    {
      ...
      "target" : [{
        "code" : "Library.subject[x]",
        "display" : "Library.subject[x]",
        "equivalence" : "equivalent",
        "comment" : "Element `Library.subject[x]` is mapped to FHIR R4 element `Library.subject[x]` as `Equivalent`.\nThe target context `Library.subject[x]` is a choice-type element and cannot directly hold extensions. The context is moved up to parent element `Library`."
      }]
    },
    {
      "code" : "Library.date",
    ...
    },
    {
      ...
      "target" : [{
        "code" : "Library.contact",
        "display" : "Library.contact",
        "equivalence" : "equivalent",
        "comment" : "Element `Library.contact` is mapped to FHIR R4 element `Library.contact` as `Equivalent`.\nMay be a web site, an email address, a telephone number, etc.\n\nSee guidance around (not) making local changes to elements [here](https://hl7.org/fhir/canonicalreso.html#localization)."
      }]
    },
    {
    ...
    },
    {
      ...
      "target" : [{
        "code" : "Library.useContext",
        "display" : "Library.useContext",
        "equivalence" : "equivalent",
        "comment" : "Element `Library.useContext` is mapped to FHIR R4 element `Library.useContext` as `Equivalent`.\nWhen multiple useContexts are specified, there is no expectation that all or any of the contexts apply."
      }]
    },
    {
      ...
      "target" : [{
        "code" : "Library.jurisdiction",
        "display" : "Library.jurisdiction",
        "equivalence" : "equivalent",
        "comment" : "Element `Library.jurisdiction` is mapped to FHIR R4 element `Library.jurisdiction` as `Equivalent`.\nElement `Library.jurisdiction` has been flagged as deprecated.\nIt may be possible for the library to be used in jurisdictions other than those for which it was originally designed or intended.\n\nDEPRECATION NOTE: For consistency, implementations are encouraged to migrate to using the new 'jurisdiction' code in the useContext element.  (I.e. useContext.code indicating http://terminology.hl7.org/CodeSystem/usage-context-type#jurisdiction and useContext.valueCodeableConcept indicating the jurisdiction.)"
      }]
    },
    {
    ...
    },
    {
      ...
      "target" : [{
        ...
        "equivalence" : "equivalent",
        "comment" : "Element `Library.usage` is mapped to FHIR R4 element `Library.usage` as `Equivalent`."
      }]
    },
    {
    ...
    },
    {
      ...
      "target" : [{
        "code" : "Library.approvalDate",
        "display" : "Library.approvalDate",
        "equivalence" : "equivalent",
        "comment" : "Element `Library.approvalDate` is mapped to FHIR R4 element `Library.approvalDate` as `Equivalent`.\nThe 'date' element may be more recent than the approval date because of minor changes or editorial corrections.\n\nSee guidance around (not) making local changes to elements [here](https://hl7.org/fhir/canonicalreso.html#localization)."
      }]
    },
    {
      ...
      "target" : [{
        "code" : "Library.lastReviewDate",
        "display" : "Library.lastReviewDate",
        "equivalence" : "equivalent",
        "comment" : "Element `Library.lastReviewDate` is mapped to FHIR R4 element `Library.lastReviewDate` as `Equivalent`.\nIf specified, this date follows the original approval date.\n\nSee guidance around (not) making local changes to elements [here](https://hl7.org/fhir/canonicalreso.html#localization)."
      }]
    },
    {
    ...
    },
    {
      ...
      "target" : [{
        ...
        "equivalence" : "equivalent",
        "comment" : "Element `Library.author` is mapped to FHIR R4 element `Library.author` as `Equivalent`."
      }]
    },
    {
      "code" : "Library.editor",
      ...
      "target" : [{
        "code" : "Library.editor",
        "display" : "Library.editor",
        "equivalence" : "equivalent",
        "comment" : "Element `Library.editor` is mapped to FHIR R4 element `Library.editor` as `Equivalent`."
      }]
    },
    {
      ...
      "target" : [{
        "code" : "Library.reviewer",
        "display" : "Library.reviewer",
        "equivalence" : "equivalent",
        "comment" : "Element `Library.reviewer` is mapped to FHIR R4 element `Library.reviewer` as `Equivalent`.\nSee guidance around (not) making local changes to elements [here](https://hl7.org/fhir/canonicalreso.html#localization)."
      }]
    },
    {
      ...
      "target" : [{
        "code" : "Library.endorser",
        "display" : "Library.endorser",
        "equivalence" : "equivalent",
        "comment" : "Element `Library.endorser` is mapped to FHIR R4 element `Library.endorser` as `Equivalent`.\nSee guidance around (not) making local changes to elements [here](https://hl7.org/fhir/canonicalreso.html#localization)."
      }]
    },
    {
      ...
      "target" : [{
        "code" : "Library.relatedArtifact",
        "display" : "Library.relatedArtifact",
        "equivalence" : "equivalent",
        "comment" : "Element `Library.relatedArtifact` is mapped to FHIR R4 element `Library.relatedArtifact` as `Equivalent`.\nEach related artifact is either an attachment, or a reference to another resource, but not both."
      }]
    },
    {
      ...
      "target" : [{
        "code" : "Library.parameter",
        "display" : "Library.parameter",
        "equivalence" : "equivalent",
        "comment" : "Element `Library.parameter` is mapped to FHIR R4 element `Library.parameter` as `Equivalent`."
      }]
    },
    {
      ...
      "target" : [{
        "code" : "Library.dataRequirement",
        "display" : "Library.dataRequirement",
        "equivalence" : "equivalent",
        "comment" : "Element `Library.dataRequirement` is mapped to FHIR R4 element `Library.dataRequirement` as `Equivalent`."
      }]
    },
    {
      ...
      "target" : [{
        ...
        "equivalence" : "equivalent",
        "comment" : "Element `Library.content` is mapped to FHIR R4 element `Library.content` as `Equivalent`."
      }]
    }]
  },
  {
