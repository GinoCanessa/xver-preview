# ExtensionMedicationKnowledge_Definitional_DrugCharacteristic_Value - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
```json
{
  ...
  "description" : "R5: `MedicationKnowledge.definitional.drugCharacteristic.value[x]` additional types (Attachment)",
  "jurisdiction" : [{
    "coding" : [{
