# ExtensionDocumentReference_DocStatus - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
R5: `DocumentReference.docStatus`
...
```json
{
  ...
  "description" : "R5: `DocumentReference.docStatus`",
  "jurisdiction" : [{
    "coding" : [{
