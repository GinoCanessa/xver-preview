# ExtensionSubstanceDefinition_Moiety_MeasurementType - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: The measurement type of the quantitative value (new) 

R5: `SubstanceDefinition.moiety.measurementType` (new:CodeableConcept)
...
```json
{
  ...
  "title" : "R5: The measurement type of the quantitative value (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `SubstanceDefinition.moiety.measurementType` (new:CodeableConcept)",
  "jurisdiction" : [{
    "coding" : [{
