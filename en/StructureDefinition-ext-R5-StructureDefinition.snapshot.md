# ExtensionStructureDefinition_Snapshot - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## Extension: Cross-version Extension `R5.StructureDefinition.snapshot` for use in FHIR R4 

This cross-version extension represents the FHIR R5 element `StructureDefinition.snapshot` for use in FHIR R4.
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-StructureDefinition.snapshot)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-StructureDefinition.snapshot.csv), [Excel](../StructureDefinition-ext-R5-StructureDefinition.snapshot.xlsx), [Schematron](../StructureDefinition-ext-R5-StructureDefinition.snapshot.sch) 
...
```json
{
  ...
  "id" : "ext-R5-StructureDefinition.snapshot",
  "extension" : [
    {
  ...
  "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-StructureDefinition.snapshot",
  "version" : "0.0.1-snapshot-3",
  "name" : "ExtensionStructureDefinition_Snapshot",
  "title" : "Cross-version Extension `R5.StructureDefinition.snapshot` for use in FHIR R4",
  "status" : "active",
  "experimental" : false,
  ...
  "purpose" : "This extension is part of the cross-version definitions generated to enable use of the\r\nelement `StructureDefinition.snapshot` as defined in FHIR R5\r\nin FHIR R4.\r\n\r\nThe source element is defined as:\r\n`StructureDefinition.snapshot` 0..1 `BackboneElement`\r\n\r\nAcross FHIR versions, the element set has been mapped as:\r\n*  R5: `StructureDefinition.snapshot` 0..1 `BackboneElement`\n*  R4B: `StructureDefinition.snapshot` 0..1 `BackboneElement`\n*  R4: `StructureDefinition.snapshot` 0..1 `BackboneElement`\r\n\r\nFollowing are the generation technical comments:\r\nElement `StructureDefinition.snapshot` has is mapped to FHIR R4 element `StructureDefinition.snapshot`, but has no comparisons.",
  "fhirVersion" : "4.0.1",
  "mapping" : [
    {
      "identity" : "rim",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "requirements" : "Element `StructureDefinition.snapshot.element` is part of an existing definition because parent element `StructureDefinition.snapshot` requires a cross-version extension.\nElement `StructureDefinition.snapshot.element` has is mapped to FHIR R4 element `StructureDefinition.snapshot.element`, but has no comparisons.",
        "min" : 1,
        "max" : "*",
        "base" : {
          "path" : "Extension.extension",
      ...
      },
      {
        ...
        "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-StructureDefinition.snapshot.element"
      },
      {
      ...
      },
      {
        ...
        "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-StructureDefinition.snapshot"
      },
      {
