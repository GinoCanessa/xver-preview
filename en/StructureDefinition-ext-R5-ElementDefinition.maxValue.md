# ExtensionElementDefinition_MaxValue - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: maxValue additional types 

R5: `ElementDefinition.maxValue[x]` additional types (integer64)
...
```json
{
  ...
  "title" : "R5: maxValue additional types",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `ElementDefinition.maxValue[x]` additional types (integer64)",
  "jurisdiction" : [{
    "coding" : [{
