...
* Refer to this Profile: [Cross-version Extension `R5.AdministrableProductDefinition` for use in FHIR R4](StructureDefinition-ext-R5-AdministrableProductDefinition.md), [Cross-version Extension `R5.Appointment.patientInstruction` for use in FHIR R4](StructureDefinition-ext-R5-Appointment.patientInstruction.md), [Cross-version Extension `R5.ManufacturedItemDefinition` for use in FHIR R4](StructureDefinition-ext-R5-ManufacturedItemDefinition.md) and [Cross-version Extension `R5.ManufacturedItemDefinition.property` for use in FHIR R4](StructureDefinition-property.md)
...
```json
{
  ...
  "status" : "active",
  "experimental" : false,
  "date" : "2026-02-21T13:36:54.1336877-06:00",
