# ConceptMapR5SupplyRequestElementsForR4SupplyRequest - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3
...
```json
{
  ...
  "status" : "active",
  "experimental" : false,
  "date" : "2026-02-17T14:42:27.6145399-06:00",
  "contact" : [
    {
          ...
          "target" : [
            {
              ...
              "comment" : "FHIR R5 Resource `SupplyRequest` is representable via FHIR R4 Resource `SupplyRequest`.\nElement `SupplyRequest` has is mapped to FHIR R4 element `SupplyRequest`, but has no comparisons."
            }
          ]
        },
        {
          ...
          "target" : [
            {
              ...
              "equivalence" : "relatedto",
              "comment" : "Element `SupplyRequest.meta` has is mapped to FHIR R4 element `SupplyRequest.meta`, but has no comparisons."
            }
          ]
        },
        {
          ...
          "target" : [
            {
              ...
              "equivalence" : "relatedto",
              "comment" : "Element `SupplyRequest.implicitRules` has is mapped to FHIR R4 element `SupplyRequest.implicitRules`, but has no comparisons."
            }
          ]
        },
        {
          ...
          "target" : [
            {
              ...
              "equivalence" : "relatedto",
              "comment" : "Element `SupplyRequest.language` has is mapped to FHIR R4 element `SupplyRequest.language`, but has no comparisons."
            }
          ]
        },
        {
          ...
          "target" : [
            {
              ...
              "equivalence" : "relatedto",
              "comment" : "Element `SupplyRequest.text` has is mapped to FHIR R4 element `SupplyRequest.text`, but has no comparisons."
            }
          ]
        },
        {
          ...
          "target" : [
            {
              ...
              "equivalence" : "relatedto",
              "comment" : "Element `SupplyRequest.contained` has is mapped to FHIR R4 element `SupplyRequest.contained`, but has no comparisons."
            }
          ]
        },
        {
          ...
          "target" : [
            {
              ...
              "equivalence" : "relatedto",
              "comment" : "Element `SupplyRequest.identifier` has is mapped to FHIR R4 element `SupplyRequest.identifier`, but has no comparisons."
            }
          ]
        },
        {
          ...
          "target" : [
            {
              ...
              "equivalence" : "relatedto",
              "comment" : "Element `SupplyRequest.status` has is mapped to FHIR R4 element `SupplyRequest.status`, but has no comparisons."
            }
          ]
        },
        {
          ...
          "target" : [
            {
              ...
              "equivalence" : "relatedto",
              "comment" : "Element `SupplyRequest.category` has is mapped to FHIR R4 element `SupplyRequest.category`, but has no comparisons."
            }
          ]
        },
        {
          ...
          "target" : [
            {
              ...
              "equivalence" : "relatedto",
              "comment" : "Element `SupplyRequest.priority` has is mapped to FHIR R4 element `SupplyRequest.priority`, but has no comparisons."
            }
          ]
        },
        {
          ...
          "target" : [
            {
              ...
              "equivalence" : "relatedto",
              "comment" : "Element `SupplyRequest.quantity` has is mapped to FHIR R4 element `SupplyRequest.quantity`, but has no comparisons."
            }
          ]
        },
        {
          ...
          "target" : [
            {
              ...
              "equivalence" : "relatedto",
              "comment" : "Element `SupplyRequest.authoredOn` has is mapped to FHIR R4 element `SupplyRequest.authoredOn`, but has no comparisons."
            }
          ]
        },
        {
          ...
          "target" : [
            {
              ...
              "equivalence" : "relatedto",
              "comment" : "Element `SupplyRequest.supplier` has is mapped to FHIR R4 element `SupplyRequest.supplier`, but has no comparisons."
            }
          ]
        },
        {
          ...
          "target" : [
            {
              ...
              "equivalence" : "relatedto",
              "comment" : "Element `SupplyRequest.reason` has is mapped to FHIR R4 element `SupplyRequest.reasonCode`, but has no comparisons.\nElement `SupplyRequest.reason` has is mapped to FHIR R4 element `SupplyRequest.reasonReference`, but has no comparisons."
            },
            {
          ...
          "target" : [
            {
              ...
              "equivalence" : "relatedto",
              "comment" : "Element `SupplyRequest.deliverFrom` has is mapped to FHIR R4 element `SupplyRequest.deliverFrom`, but has no comparisons."
            }
          ]
        },
        {
