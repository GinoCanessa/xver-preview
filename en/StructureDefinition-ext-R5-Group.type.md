# ExtensionGroup_Type - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: person | animal | practitioner | device | careteam | healthcareservice | location | organization | relatedperson | specimen 
...
```json
{
  ...
  "title" : "R5: person | animal | practitioner | device | careteam | healthcareservice | location | organization | relatedperson | specimen",
  "status" : "active",
  "experimental" : false,
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        ...
        "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-group-type-for-R4|0.1.0"
      }
    }]
  }
}
