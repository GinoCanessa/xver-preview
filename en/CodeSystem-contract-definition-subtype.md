# ContractDefinitionSubtype - FHIR Cross-Version Extensions package to use FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## CodeSystem: ContractDefinitionSubtype (Experimental) 
...
```json
{
  ...
  "title" : "Contract Definition Subtype",
  "status" : "active",
  "experimental" : true,
