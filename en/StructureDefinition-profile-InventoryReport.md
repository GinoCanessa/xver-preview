# ProfileInventoryReport - FHIR Cross-Version Extensions package to use FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## Resource Profile: ProfileInventoryReport 
...
```json
{
  ...
  "differential" : {
    "element" : [
      ...
      {
        "id" : "Basic.extension:InventoryReport",
        "path" : "Basic.extension",
        "sliceName" : "InventoryReport",
        "short" : "Cross-version extension for InventoryReport from R5 for use in FHIR R4",
        "min" : 1,
        "max" : "1",
        "base" : {
          "path" : "DomainResource.extension",
        ...
        "type" : [
          {
            "code" : "Extension",
            "profile" : [
              "http://hl7.org/fhir/5.0/StructureDefinition/extension-InventoryReport|0.0.1-snapshot-3"
            ]
          }
        ]
      },
