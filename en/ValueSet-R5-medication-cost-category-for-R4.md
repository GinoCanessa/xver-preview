# R5MedicationCostCategoryForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
* [R5: cost](StructureDefinition-ext-R5-MedicationKnowledge.cost.md)
* [R5: The price or category of the cost of the medication additional types](StructureDefinition-ext-R5-MedicationKnowledge.cos.cost.md)
