# ExtensionCoverage_CostToBeneficiary_Category - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Benefit classification (new) 

R5: `Coverage.costToBeneficiary.category` (new:CodeableConcept)
...
```json
{
  ...
  "title" : "R5: Benefit classification (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Coverage.costToBeneficiary.category` (new:CodeableConcept)",
  "jurisdiction" : [{
    "coding" : [{
