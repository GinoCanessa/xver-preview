# ExtensionExplanationOfBenefit_AddItem_Tax - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Total tax (new) 

R5: `ExplanationOfBenefit.addItem.tax` (new:Money)
...
```json
{
  ...
  "description" : "R5: `ExplanationOfBenefit.addItem.tax` (new:Money)",
  "jurisdiction" : [{
    "coding" : [{
