# ExtensionOperationOutcome_Issue_Code - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## Extension: Cross-version Extension `R5.OperationOutcome.issue.code` for use in FHIR R4 

This cross-version extension represents the FHIR R5 element `OperationOutcome.issue.code` for use in FHIR R4.
...
```json
{
  ...
  "title" : "Cross-version Extension `R5.OperationOutcome.issue.code` for use in FHIR R4",
  "status" : "active",
  "experimental" : false,
    ...
    "element" : [
      ...
      },
      {
        ...
        "binding" : {
          ...
          "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-issue-type-for-R4|0.0.1-snapshot-3"
        }
      }
    ]
  }
