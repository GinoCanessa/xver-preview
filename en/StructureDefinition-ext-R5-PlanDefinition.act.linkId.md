# ExtensionPlanDefinition_Action_LinkId - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Unique id for the action in the PlanDefinition (new) 
...
```json
{
  ...
  "title" : "R5: Unique id for the action in the PlanDefinition (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `PlanDefinition.action.linkId` (new:string)",
  "jurisdiction" : [{
    "coding" : [{
