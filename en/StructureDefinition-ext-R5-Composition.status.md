...
This cross-version extension represents the FHIR R5 element `Composition.status` for use in FHIR R4.
...
```json
{
  ...
  "description" : "This cross-version extension represents the FHIR R5 element `Composition.status` for use in FHIR R4.",
  "jurisdiction" : [
    {
      "coding" : [
        {
    ...
    "element" : [
      ...
      },
      {
        ...
        "binding" : {
          ...
          "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-composition-status-for-R4|0.0.1-snapshot-3"
        }
      }
    ]
  }
