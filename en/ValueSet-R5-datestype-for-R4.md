# R5DatestypeForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
* [R5: Event information (new)](StructureDefinition-ext-R5-Claim.event.md)
* [R5: Event information (new)](StructureDefinition-ext-R5-ClaimResponse.event.md)
* [R5: Event information (new)](StructureDefinition-ext-R5-CoverageEligibilityRequest.event.md)
* [R5: Event information (new)](StructureDefinition-ext-R5-CoverageEligibilityResponse.event.md)
* [R5: Event information (new)](StructureDefinition-ext-R5-ExplanationOfBenefit.event.md)
