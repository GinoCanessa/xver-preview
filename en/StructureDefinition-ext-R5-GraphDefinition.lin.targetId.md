# ExtensionGraphDefinition_Link_TargetId - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Target Node for this link (new) 

R5: `GraphDefinition.link.targetId` (new:id)
...
```json
{
  ...
  "title" : "R5: Target Node for this link (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `GraphDefinition.link.targetId` (new:id)",
  "jurisdiction" : [{
    "coding" : [{
