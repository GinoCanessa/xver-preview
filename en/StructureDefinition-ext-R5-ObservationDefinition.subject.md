# ExtensionObservationDefinition_Subject - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Type of subject for the defined observation (new) 
...
```json
{
  ...
  "title" : "R5: Type of subject for the defined observation (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `ObservationDefinition.subject` (new:CodeableConcept)",
  "jurisdiction" : [{
    "coding" : [{
