# ExtensionServiceRequest_SupportingInfo - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## Extension: Cross-version Extension `R5.ServiceRequest.supportingInfo` for use in FHIR R4 

This cross-version extension represents the FHIR R5 element `ServiceRequest.supportingInfo` for use in FHIR R4.
...
```json
{
  ...
  "title" : "Cross-version Extension `R5.ServiceRequest.supportingInfo` for use in FHIR R4",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "This cross-version extension represents the FHIR R5 element `ServiceRequest.supportingInfo` for use in FHIR R4.",
  "jurisdiction" : [
    {
      "coding" : [
        {
