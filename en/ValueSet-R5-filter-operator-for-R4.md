# R5FilterOperatorForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
* [R5: = | is-a | descendent-of | is-not-a | regex | in | not-in | generalizes | child-of | descendent-leaf | exists](StructureDefinition-ext-R5-CodeSystem.fil.operator.md)
* [R5: = | is-a | descendent-of | is-not-a | regex | in | not-in | generalizes | child-of | descendent-leaf | exists](StructureDefinition-ext-R5-ValueSet.com.inc.fil.op.md)
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-filter-operator-for-R4",
  "version" : "0.1.0",
  "name" : "R5FilterOperatorForR4",
