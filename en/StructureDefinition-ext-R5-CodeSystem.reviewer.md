# ExtensionCodeSystem_Reviewer - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Who reviewed the CodeSystem (new) 

R5: `CodeSystem.reviewer` (new:ContactDetail)
...
```json
{
  ...
  "title" : "R5: Who reviewed the CodeSystem (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `CodeSystem.reviewer` (new:ContactDetail)",
  "jurisdiction" : [{
    "coding" : [{
