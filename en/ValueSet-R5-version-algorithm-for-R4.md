# R5VersionAlgorithmForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3
...
* [Cross-version Extension `R5.ActorDefinition` for use in FHIR R4](StructureDefinition-ext-R5-ActorDefinition.md)
* [Cross-version Extension `R5.ChargeItemDefinition.versionAlgorithm[x]` for use in FHIR R4](StructureDefinition-ext-R5-ChargeItemDefinition.versionAlgorithm.md)
* [Cross-version Extension `R5.Citation` for use in FHIR R4](StructureDefinition-ext-R5-Citation.md)
* [Cross-version Extension `R5.ConditionDefinition` for use in FHIR R4](StructureDefinition-ext-R5-ConditionDefinition.md)
* [Cross-version Extension `R5.EventDefinition.versionAlgorithm[x]` for use in FHIR R4](StructureDefinition-ext-R5-EventDefinition.versionAlgorithm.md)
* [Cross-version Extension `R5.Evidence.versionAlgorithm[x]` for use in FHIR R4](StructureDefinition-ext-R5-Evidence.versionAlgorithm.md)
* [Cross-version Extension `R5.EvidenceVariable.versionAlgorithm[x]` for use in FHIR R4](StructureDefinition-ext-R5-EvidenceVariable.versionAlgorithm.md)
* [Cross-version Extension `R5.Requirements` for use in FHIR R4](StructureDefinition-ext-R5-Requirements.md)
* [Cross-version Extension `R5.SubscriptionTopic` for use in FHIR R4](StructureDefinition-ext-R5-SubscriptionTopic.md)
* [Cross-version Extension `R5.TestPlan` for use in FHIR R4](StructureDefinition-ext-R5-TestPlan.md)
* [Cross-version Extension `R5.TestScript.versionAlgorithm[x]` for use in FHIR R4](StructureDefinition-ext-R5-TestScript.versionAlgorithm.md)
