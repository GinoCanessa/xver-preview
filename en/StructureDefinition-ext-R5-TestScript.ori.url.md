# ExtensionTestScript_Origin_Url - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: The url path of the origin server (new) 
...
```json
{
  ...
  "title" : "R5: The url path of the origin server (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `TestScript.origin.url` (new:url)",
  "jurisdiction" : [{
    "coding" : [{
