# TargetSpecies - FHIR Cross-Version Extensions package to use FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## CodeSystem: TargetSpecies 
...
* [ValueSetR5TargetSpeciesForR4](ValueSet-ValueSet-R5-target-species-for-R4.md)
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/target-species",
  "version" : "5.0.0",
  "name" : "TargetSpecies",
