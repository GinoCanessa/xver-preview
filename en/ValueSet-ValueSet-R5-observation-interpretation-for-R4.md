# ValueSetR5ObservationInterpretationForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3
...
* [Cross-version Extension `R5.Observation.component` for use in FHIR R4](StructureDefinition-ext-R5-Observation.component.md)
