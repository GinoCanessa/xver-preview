  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "required",
          "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-artifactassessment-information-type-for-R4|0.0.1-snapshot-3"
        }
      },
      {
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "example",
          "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-certainty-type-for-R4|0.0.1-snapshot-3"
        }
      },
      {
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "example",
          "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-certainty-rating-for-R4|0.0.1-snapshot-3"
        }
      },
      {
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "required",
          "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-artifactassessment-workflow-status-for-R4|0.0.1-snapshot-3"
        }
      },
      {
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "required",
          "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-artifactassessment-disposition-for-R4|0.0.1-snapshot-3"
        }
      },
      {
        "id" : "Extension.url",
