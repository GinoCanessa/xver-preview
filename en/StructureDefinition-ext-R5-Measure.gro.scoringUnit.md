# ExtensionMeasure_Group_ScoringUnit - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
```json
{
  ...
  "description" : "R5: `Measure.group.scoringUnit` (new:CodeableConcept)",
  "jurisdiction" : [{
    "coding" : [{
