# ExtensionExampleScenario_Process_Step_Number - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Sequential number of the step (new) 

R5: `ExampleScenario.process.step.number` (new:string)
...
```json
{
  ...
  "title" : "R5: Sequential number of the step (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `ExampleScenario.process.step.number` (new:string)",
  "jurisdiction" : [{
    "coding" : [{
