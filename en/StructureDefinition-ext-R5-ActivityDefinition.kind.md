# ExtensionActivityDefinition_Kind - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: kind 

R5: `ActivityDefinition.kind`
...
```json
{
  ...
  "description" : "R5: `ActivityDefinition.kind`",
  "jurisdiction" : [{
    "coding" : [{
