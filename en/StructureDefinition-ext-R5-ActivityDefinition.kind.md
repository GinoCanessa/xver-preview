# ExtensionActivityDefinition_Kind - FHIR Cross-Version Extensions package to use FHIR R5 in FHIR R4 v0.0.1-snapshot-3
    ...
    "element" : [
      ...
      },
      {
        ...
        "binding" : {
          ...
          "valueSet" : "http://hl7.org/fhir/5.0/ValueSet/ValueSet-R5-request-resource-types-for-R4"
        }
      }
    ]
  }
