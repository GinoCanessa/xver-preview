# EvidenceClassifier - FHIR Cross-Version Extensions package to use FHIR R5 in FHIR R4 v0.0.1-snapshot-3
...
* [ValueSetR5EvidenceClassifierCodeForR4](ValueSet-ValueSet-R5-evidence-classifier-code-for-R4.md)
