# ExtensionClaim_Event - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
```json
{
  ...
  "description" : "R5: `Claim.event` (new:BackboneElement)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "definition" : "R5: `Claim.event.type` (new:CodeableConcept)",
    ...
    },
    {
      ...
      "definition" : "R5: `Claim.event.when[x]` (new:dateTime, Period)",
