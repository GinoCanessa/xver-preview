# MedicationRequestCategoryCodes - FHIR Cross-Version Extensions package to use FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## CodeSystem: MedicationRequestCategoryCodes 
...
```json
{
  ...
  "title" : "MedicationRequest Category Codes",
  "status" : "draft",
  "experimental" : false,
  ...
  "caseSensitive" : true,
  "valueSet" : "http://terminology.hl7.org/ValueSet/medicationrequest-category|1.0.0",
  "content" : "complete",
  "concept" : [
    {
      "code" : "inpatient",
