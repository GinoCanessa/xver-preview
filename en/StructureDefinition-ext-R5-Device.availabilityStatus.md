# ExtensionDevice_AvailabilityStatus - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## Extension: Cross-version Extension `R5.Device.availabilityStatus` for use in FHIR R4 

This cross-version extension represents the FHIR R5 element `Device.availabilityStatus` for use in FHIR R4.
...
```json
{
  ...
  "description" : "This cross-version extension represents the FHIR R5 element `Device.availabilityStatus` for use in FHIR R4.",
  "jurisdiction" : [
    {
      "coding" : [
        {
    ...
    "element" : [
      ...
      },
      {
        ...
        "binding" : {
          ...
          "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-device-availability-status-for-R4|0.0.1-snapshot-3"
        }
      }
    ]
  }
