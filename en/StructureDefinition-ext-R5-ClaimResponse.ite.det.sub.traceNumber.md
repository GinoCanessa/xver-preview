# ExtensionClaimResponse_Item_Detail_SubDetail_TraceNumber - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
```json
{
  ...
  "description" : "R5: `ClaimResponse.item.detail.subDetail.traceNumber` (new:Identifier)",
  "jurisdiction" : [{
    "coding" : [{
