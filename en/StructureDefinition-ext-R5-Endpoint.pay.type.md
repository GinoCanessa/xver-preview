# ExtensionEndpoint_Payload_Type - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: The type of content that may be used at this endpoint (e.g. XDS Discharge summaries) (new) 
...
```json
{
  ...
  "title" : "R5: The type of content that may be used at this endpoint (e.g. XDS Discharge summaries) (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Endpoint.payload.type` (new:CodeableConcept)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "example",
        "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-endpoint-payload-type-for-R4|0.1.0"
      }
    }]
  }
}
