# ExtensionImagingStudy_Series_BodySite - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: bodySite additional types 

R5: `ImagingStudy.series.bodySite` additional types (CodeableReference(http://hl7.org/fhir/StructureDefinition/BodyStructure)) additional types from child elements (concept, reference)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-ImagingStudy.ser.bodySite)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-ImagingStudy.ser.bodySite.csv), [Excel](../StructureDefinition-ext-R5-ImagingStudy.ser.bodySite.xlsx), [Schematron](../StructureDefinition-ext-R5-ImagingStudy.ser.bodySite.sch) 
...
```json
{
  ...
  "id" : "ext-R5-ImagingStudy.ser.bodySite",
  "extension" : [{
  ...
  "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-ImagingStudy.series.bodySite",
  "version" : "0.1.0",
  ...
  "description" : "R5: `ImagingStudy.series.bodySite` additional types (CodeableReference(http://hl7.org/fhir/StructureDefinition/BodyStructure)) additional types from child elements (concept, reference)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "purpose" : "This extension is part of the cross-version definitions generated to enable use of the\r\nelement `ImagingStudy.series.bodySite` as defined in FHIR R5\r\nin FHIR R4.\r\n\r\nThe source element is defined as:\r\n`ImagingStudy.series.bodySite` 0..1 `CodeableReference(http://hl7.org/fhir/StructureDefinition/BodyStructure)`\r\n\r\nAcross FHIR versions, the element set has been mapped as:\r\n*  R5: `ImagingStudy.series.bodySite` 0..1 `CodeableReference(http://hl7.org/fhir/StructureDefinition/BodyStructure)`\n*  R4B: `ImagingStudy.series.bodySite` 0..1 `Coding`\n*  R4: `ImagingStudy.series.bodySite` 0..1 `Coding`\r\n\r\nFollowing are the generation technical comments:\r\nElement `ImagingStudy.series.bodySite` is mapped to FHIR R4 element `ImagingStudy.series.bodySite` as `SourceIsBroaderThanTarget`.\nThe mappings for `ImagingStudy.series.bodySite` do not cover the following types: CodeableReference.\nThe mappings for `ImagingStudy.series.bodySite` do not cover the following types based on type expansion: concept, reference.",
  "fhirVersion" : "4.0.1",
  "mapping" : [{
    "identity" : "rim",
    "uri" : "http://hl7.org/v3",
