# MedicationDispenseStatusReasonCodes - FHIR Cross-Version Extensions package to use FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## CodeSystem: MedicationDispenseStatusReasonCodes 
...
```json
{
  ...
  "caseSensitive" : true,
  "valueSet" : "http://hl7.org/fhir/ValueSet/medicationdispense-status-reason|4.0.1",
  "content" : "complete",
  "concept" : [
    {
      "code" : "frr01",
