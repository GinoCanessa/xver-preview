# ExtensionExampleScenario_Instance_StructureVersion - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: E.g. 4.0.1 (new) 

R5: `ExampleScenario.instance.structureVersion` (new:string)
...
```json
{
  ...
  "description" : "R5: `ExampleScenario.instance.structureVersion` (new:string)",
  "jurisdiction" : [{
    "coding" : [{
