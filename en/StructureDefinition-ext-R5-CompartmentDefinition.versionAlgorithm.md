# ExtensionCompartmentDefinition_VersionAlgorithm - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
```json
{
  ...
  "description" : "R5: `CompartmentDefinition.versionAlgorithm[x]` (new:Coding, string)",
  "jurisdiction" : [{
    "coding" : [{
