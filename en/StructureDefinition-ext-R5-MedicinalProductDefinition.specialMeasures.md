# ExtensionMedicinalProductDefinition_SpecialMeasures - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: specialMeasures additional types 

R5: `MedicinalProductDefinition.specialMeasures` additional types (CodeableConcept) additional types from child elements (coding)
...
```json
{
  ...
  "title" : "R5: specialMeasures additional types",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `MedicinalProductDefinition.specialMeasures` additional types (CodeableConcept) additional types from child elements (coding)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        ...
        "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-medicinal-product-special-measures-for-R4|0.1.0"
      }
    }]
  }
}
