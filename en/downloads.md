...
* [Cross-version Extension `R5.ClinicalUseDefinition.contraindication.otherTherapy` for use in FHIR R4](StructureDefinition-otherTherapy.md) has target MedicinalProduct
* [Cross-version Extension `R5.ClinicalUseDefinition.contraindication.otherTherapy` for use in FHIR R4](StructureDefinition-otherTherapy.md) has target SubstanceSpecification
