# Downloads - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3
...
* [Cross-version Extension `R5.ClinicalUseDefinition` for use in FHIR R4](StructureDefinition-ext-R5-ClinicalUseDefinition.md) has target SubstanceSpecification
...
* [Cross-version Extension `R5.MedicationKnowledge.definitional` for use in FHIR R4](StructureDefinition-ext-R5-MedicationKnowledge.definitional.md) has target MedicinalProduct
...
* [Cross-version Extension `R5.ResearchStudy.comparisonGroup` for use in FHIR R4](StructureDefinition-ext-R5-ResearchStudy.comparisonGroup.md) has target EvidenceVariable
...
* [Cross-version Extension `R5.SpecimenDefinition.typeTested` for use in FHIR R4](StructureDefinition-ext-R5-SpecimenDefinition.typeTested.md) has target SubstanceSpecification
...
* [Cross-version Extension `R5.SubstanceDefinition.relationship` for use in FHIR R4](StructureDefinition-ext-R5-SubstanceDefinition.relationship.md) has target SubstanceSpecification
