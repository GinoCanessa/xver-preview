# ExtensionClaim_Insurance - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## Extension: Cross-version Extension `R5.Claim.insurance` for use in FHIR R4 

This cross-version extension represents the FHIR R5 element `Claim.insurance` for use in FHIR R4.
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-Claim.insurance)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-Claim.insurance.csv), [Excel](../StructureDefinition-ext-R5-Claim.insurance.xlsx), [Schematron](../StructureDefinition-ext-R5-Claim.insurance.sch) 
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Claim.insurance",
  "version" : "0.0.1-snapshot-3",
  "name" : "ExtensionClaim_Insurance",
  "title" : "Cross-version Extension `R5.Claim.insurance` for use in FHIR R4",
  "status" : "active",
  "experimental" : false,
  ...
  "purpose" : "This extension is part of the cross-version definitions generated to enable use of the\r\nelement `Claim.insurance` as defined in FHIR R5\r\nin FHIR R4.\r\n\r\nThe source element is defined as:\r\n`Claim.insurance` 0..* `BackboneElement`\r\n\r\nAcross FHIR versions, the element set has been mapped as:\r\n*  R5: `Claim.insurance` 0..* `BackboneElement`\n*  R4B: `Claim.insurance` 1..* `BackboneElement`\n*  R4: `Claim.insurance` 1..* `BackboneElement`\r\n\r\nFollowing are the generation technical comments:\r\nElement `Claim.insurance` has is mapped to FHIR R4 element `Claim.insurance`, but has no comparisons.",
  "fhirVersion" : "4.0.1",
  "mapping" : [
    {
      "identity" : "rim",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "requirements" : "To maintain order of the coverages. Element `Claim.insurance.sequence` is part of an existing definition because parent element `Claim.insurance` requires a cross-version extension.\nElement `Claim.insurance.sequence` has is mapped to FHIR R4 element `Claim.insurance.sequence`, but has no comparisons.",
        "min" : 1,
        "max" : "1",
        "base" : {
          "path" : "Extension.extension",
      ...
      },
      {
        ...
        "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Claim.insurance.sequence"
      },
      {
      ...
      },
      {
        ...
        "requirements" : "To identify which coverage in the list is being used to adjudicate this claim. Element `Claim.insurance.focal` is part of an existing definition because parent element `Claim.insurance` requires a cross-version extension.\nElement `Claim.insurance.focal` has is mapped to FHIR R4 element `Claim.insurance.focal`, but has no comparisons.",
        "min" : 1,
        "max" : "1",
        "base" : {
          "path" : "Extension.extension",
      ...
      },
      {
        ...
        "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Claim.insurance.focal"
      },
      {
      ...
      },
      {
        ...
        "requirements" : "This will be the claim number should it be necessary to create this claim in the future. This is provided so that payors may forward claims to other payors in the Coordination of Benefit for adjudication rather than the provider being required to initiate each adjudication. Element `Claim.insurance.identifier` is part of an existing definition because parent element `Claim.insurance` requires a cross-version extension.\nElement `Claim.insurance.identifier` has is mapped to FHIR R4 element `Claim.insurance.identifier`, but has no comparisons.",
        "min" : 0,
        "max" : "1",
        "base" : {
          "path" : "Extension.extension",
      ...
      },
      {
        ...
        "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Claim.insurance.identifier"
      },
      {
      ...
      },
      {
        ...
        "requirements" : "Required to allow the adjudicator to locate the correct policy and history within their information system. Element `Claim.insurance.coverage` is part of an existing definition because parent element `Claim.insurance` requires a cross-version extension.\nElement `Claim.insurance.coverage` has is mapped to FHIR R4 element `Claim.insurance.coverage`, but has no comparisons.",
        "min" : 1,
        "max" : "1",
        "base" : {
          "path" : "Extension.extension",
      ...
      },
      {
        ...
        "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Claim.insurance.coverage"
      },
      {
      ...
      },
      {
        ...
        "requirements" : "Providers may have multiple business arrangements with a given insurer and must supply the specific contract number for adjudication. Element `Claim.insurance.businessArrangement` is part of an existing definition because parent element `Claim.insurance` requires a cross-version extension.\nElement `Claim.insurance.businessArrangement` has is mapped to FHIR R4 element `Claim.insurance.businessArrangement`, but has no comparisons.",
        "min" : 0,
        "max" : "1",
        "base" : {
          "path" : "Extension.extension",
      ...
      },
      {
        ...
        "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Claim.insurance.businessArrangement"
      },
      {
      ...
      },
      {
        ...
        "requirements" : "Providers must quote previously issued authorization reference numbers in order to obtain adjudication as previously advised on the Preauthorization. Element `Claim.insurance.preAuthRef` is part of an existing definition because parent element `Claim.insurance` requires a cross-version extension.\nElement `Claim.insurance.preAuthRef` has is mapped to FHIR R4 element `Claim.insurance.preAuthRef`, but has no comparisons.",
        "min" : 0,
        "max" : "*",
        "base" : {
          "path" : "Extension.extension",
      ...
      },
      {
        ...
        "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Claim.insurance.preAuthRef"
      },
      {
      ...
      },
      {
        ...
        "requirements" : "An insurer need the adjudication results from prior insurers to determine the outstanding balance remaining by item for the items in the curent claim. Element `Claim.insurance.claimResponse` is part of an existing definition because parent element `Claim.insurance` requires a cross-version extension.\nElement `Claim.insurance.claimResponse` has is mapped to FHIR R4 element `Claim.insurance.claimResponse`, but has no comparisons.",
        "min" : 0,
        "max" : "1",
        "base" : {
          "path" : "Extension.extension",
      ...
      },
      {
        ...
        "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Claim.insurance.claimResponse"
      },
      {
      ...
      },
      {
        ...
        "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Claim.insurance"
      },
      {
