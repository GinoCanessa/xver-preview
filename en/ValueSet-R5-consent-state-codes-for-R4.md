# R5ConsentStateCodesForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
* [R5: draft | active | inactive | not-done | entered-in-error | unknown](StructureDefinition-ext-R5-Consent.status.md)
...
```json
{
  ...
  "id" : "R5-consent-state-codes-for-R4",
  "extension" : [{
  ...
  "url" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-consent-state-codes-for-R4",
  "version" : "0.1.0",
  "name" : "R5ConsentStateCodesForR4",
