# ExtensionObservationDefinition_Version - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Business version of the ObservationDefinition (new) 
...
```json
{
  ...
  "title" : "R5: Business version of the ObservationDefinition (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `ObservationDefinition.version` (new:string)",
  "jurisdiction" : [{
    "coding" : [{
