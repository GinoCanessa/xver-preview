# R5ActionParticipantTypeForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
* [R5: careteam | device | group | healthcareservice | location | organization | patient | practitioner | practitionerrole | relatedperson](StructureDefinition-ext-R5-ActivityDefinition.par.type.md)
* [R5: careteam | device | group | healthcareservice | location | organization | patient | practitioner | practitionerrole | relatedperson](StructureDefinition-ext-R5-PlanDefinition.act.par.type.md)
* [R5: Actors within the plan (new)](StructureDefinition-ext-R5-PlanDefinition.actor.md)
* [R5: careteam | device | group | healthcareservice | location | organization | patient | practitioner | practitionerrole | relatedperson (new)](StructureDefinition-ext-R5-RequestOrchestration.act.par.type.md)
...
```json
{
  ...
  "id" : "R5-action-participant-type-for-R4",
  "extension" : [{
  ...
  "url" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-action-participant-type-for-R4",
  "version" : "0.1.0",
  "name" : "R5ActionParticipantTypeForR4",
