# ConformanceExpectation - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## CodeSystem: ConformanceExpectation (Experimental) 
...
* [R5ConformanceExpectationForR4](ValueSet-R5-conformance-expectation-for-R4.md)
