# ExtensionDevice_Property_Value - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Value of the property additional types 

R5: `Device.property.value[x]` additional types (string, boolean, integer, Range, Attachment)
