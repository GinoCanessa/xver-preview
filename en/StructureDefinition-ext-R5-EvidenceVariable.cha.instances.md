# ExtensionEvidenceVariable_Characteristic_Instances - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Number of occurrences meeting the characteristic (new) 
...
```json
{
  ...
  "title" : "R5: Number of occurrences meeting the characteristic (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `EvidenceVariable.characteristic.instances[x]` (new:Quantity, Range)",
  "jurisdiction" : [{
    "coding" : [{
