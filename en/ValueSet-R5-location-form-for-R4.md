# R5LocationFormForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
* [R5: The physical type of the location (usually the level in the location hierarchy - bed, room, ward, virtual etc.) (new)](StructureDefinition-ext-R5-EncounterHistory.loc.form.md)
