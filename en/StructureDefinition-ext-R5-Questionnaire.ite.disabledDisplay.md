# ExtensionQuestionnaire_Item_DisabledDisplay - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: hidden | protected (new) 
...
```json
{
  ...
  "description" : "R5: `Questionnaire.item.disabledDisplay` (new:code)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        ...
        "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-questionnaire-disabled-display-for-R4|0.1.0"
      }
    }]
  }
}
