# Lookup for R5V3HumanSubstanceAdministrationSiteForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## Lookup for R5V3HumanSubstanceAdministrationSiteForR4

### Lookup for FHIR R5 ValueSet HumanSubstanceAdministrationSite:http://terminology.hl7.org/ValueSet/v3-HumanSubstanceAdministrationSite for use in FHIR R4

The FHIR R5 ValueSet HumanSubstanceAdministrationSite has no mapping to FHIR R4.
...
| `http://terminology.hl7.org/CodeSystem/v3-ActSite` | `_HumanSubstanceAdministrationSite` | HumanSubstanceAdministrationSite | Yes |   |   |   |
