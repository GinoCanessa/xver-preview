# ExtensionSubstanceDefinition_Structure_Representation_Format - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: The format of the representation e.g. InChI, SMILES, MOLFILE (note: not the physical file format) (new) 

R5: `SubstanceDefinition.structure.representation.format` (new:CodeableConcept)
...
```json
{
  ...
  "title" : "R5: The format of the representation e.g. InChI, SMILES, MOLFILE (note: not the physical file format) (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `SubstanceDefinition.structure.representation.format` (new:CodeableConcept)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        ...
        "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-substance-representation-format-for-R4|0.1.0"
      }
    }]
  }
}
