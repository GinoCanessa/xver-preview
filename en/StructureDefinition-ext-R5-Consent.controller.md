# ExtensionConsent_Controller - FHIR Cross-Version Extensions package to use FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## Extension: Cross-version Extension `R5.Consent.controller` for use in FHIR R4 

This cross-version extension represents the FHIR R5 element `Consent.controller` for use in FHIR R4.
...
```json
{
  ...
  "title" : "Cross-version Extension `R5.Consent.controller` for use in FHIR R4",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "This cross-version extension represents the FHIR R5 element `Consent.controller` for use in FHIR R4.",
  "jurisdiction" : [
    {
      "coding" : [
        {
