# ExtensionTestScript_Destination_Url - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: The url path of the destination server (new) 
...
```json
{
  ...
  "title" : "R5: The url path of the destination server (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `TestScript.destination.url` (new:url)",
  "jurisdiction" : [{
    "coding" : [{
