# ExtensionTestScript_Setup_Action_Assert_Requirement - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Links or references to the testing requirements (new) 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-TestScript.set.act.ass.requirement)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-TestScript.set.act.ass.requirement.csv), [Excel](../StructureDefinition-ext-R5-TestScript.set.act.ass.requirement.xlsx), [Schematron](../StructureDefinition-ext-R5-TestScript.set.act.ass.requirement.sch) 
...
```json
{
  ...
  "id" : "ext-R5-TestScript.set.act.ass.requirement",
  "extension" : [{
  ...
  "title" : "R5: Links or references to the testing requirements (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `TestScript.setup.action.assert.requirement` (new:BackboneElement)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "path" : "Extension.extension",
      "sliceName" : "link",
      "short" : "R5: Link or reference to the testing requirement (new)",
      "definition" : "R5: `TestScript.setup.action.assert.requirement.link[x]` (new:canonical(Requirements), uri)",
