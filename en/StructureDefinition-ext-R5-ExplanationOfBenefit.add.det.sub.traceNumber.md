# ExtensionExplanationOfBenefit_AddItem_Detail_SubDetail_TraceNumber - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Number for tracking (new) 

R5: `ExplanationOfBenefit.addItem.detail.subDetail.traceNumber` (new:Identifier)
...
```json
{
  ...
  "description" : "R5: `ExplanationOfBenefit.addItem.detail.subDetail.traceNumber` (new:Identifier)",
  "jurisdiction" : [{
    "coding" : [{
