# ExtensionMeasureReport_Group_Population_Subjects - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: What individual(s) in the population (new) 

R5: `MeasureReport.group.population.subjects` (new:Reference(Group))
...
```json
{
  ...
  "description" : "R5: `MeasureReport.group.population.subjects` (new:Reference(Group))",
  "jurisdiction" : [{
    "coding" : [{
