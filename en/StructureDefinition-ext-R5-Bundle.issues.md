# ExtensionBundle_Issues - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Issues with the Bundle (new) 

R5: `Bundle.issues` (new:Resource[OperationOutcome])
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-Bundle.issues)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-Bundle.issues.csv), [Excel](../StructureDefinition-ext-R5-Bundle.issues.xlsx), [Schematron](../StructureDefinition-ext-R5-Bundle.issues.sch) 
...
```json
{
  ...
  "version" : "0.1.0",
  "name" : "ExtensionBundle_Issues",
  "title" : "R5: Issues with the Bundle (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Bundle.issues` (new:Resource[OperationOutcome])",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "sliceName" : "meta",
      "short" : "R5: meta",
      "definition" : "R5: `Resource.meta`",
      "comment" : "Element `Resource.meta` is mapped to FHIR R4 element `Resource.meta` as `Equivalent`.",
      "requirements" : "Element `Resource.meta` is mapped to FHIR R4 element `Resource.meta` as `Equivalent`.",
      "min" : 0,
      "max" : "1",
      "base" : {
        "path" : "Extension.extension",
    ...
    {
      "id" : "Extension.extension:implicitRules",
      "path" : "Extension.extension",
      "sliceName" : "implicitRules",
      "short" : "R5: implicitRules",
      "definition" : "R5: `Resource.implicitRules`",
      ...
      "requirements" : "Element `Resource.implicitRules` is mapped to FHIR R4 element `Resource.implicitRules` as `Equivalent`.",
      "min" : 0,
      "max" : "1",
      "base" : {
        "path" : "Extension.extension",
    ...
    {
      "id" : "Extension.extension:implicitRules.url",
      "path" : "Extension.extension.url",
      "min" : 1,
      "max" : "1",
      "base" : {
    ...
    {
      "id" : "Extension.extension:implicitRules.value[x]",
      "path" : "Extension.extension.value[x]",
    ...
    },
    {
      ...
      "sliceName" : "language",
      "short" : "R5: language",
      "definition" : "R5: `Resource.language`",
      ...
      "requirements" : "Element `Resource.language` is mapped to FHIR R4 element `Resource.language` as `Equivalent`.",
      "min" : 0,
      "max" : "1",
      "base" : {
        "path" : "Extension.extension",
    ...
    },
    {
      ...
      "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Bundle.issues"
    },
    {
