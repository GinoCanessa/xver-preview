# ExtensionMedicationStatement_Effective - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: effective additional types 
...
```json
{
  ...
  "title" : "R5: effective additional types",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `MedicationStatement.effective[x]` additional types (Timing)",
  "jurisdiction" : [{
    "coding" : [{
