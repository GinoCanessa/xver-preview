# SubstanceOpticalActivity - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## CodeSystem: SubstanceOpticalActivity 
...
* [ValueSetR5SubstanceOpticalActivityForR4](ValueSet-ValueSet-R5-substance-optical-activity-for-R4.md)
...
```json
{
  ...
  "title" : "Substance Optical Activity",
  "status" : "active",
  "experimental" : false,
