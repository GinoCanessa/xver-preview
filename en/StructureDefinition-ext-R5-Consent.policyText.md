# ExtensionConsent_PolicyText - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Human Readable Policy (new) 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-Consent.policyText)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-Consent.policyText.csv), [Excel](../StructureDefinition-ext-R5-Consent.policyText.xlsx), [Schematron](../StructureDefinition-ext-R5-Consent.policyText.sch) 
...
```json
{
  ...
  "version" : "0.1.0",
  "name" : "ExtensionConsent_PolicyText",
  "title" : "R5: Human Readable Policy (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Consent.policyText` (new:Reference(DocumentReference))",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Consent.policyText"
    },
    {
