# ExtensionCodeSystem_Filter_Operator - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: = | is-a | descendent-of | is-not-a | regex | in | not-in | generalizes | child-of | descendent-leaf | exists 

R5: `CodeSystem.filter.operator`
...
```json
{
  ...
  "description" : "R5: `CodeSystem.filter.operator`",
  "jurisdiction" : [{
    "coding" : [{
