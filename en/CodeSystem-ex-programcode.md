# ExampleProgramReasonCodes - FHIR Cross-Version Extensions package to use FHIR R5 in FHIR R4 v0.0.1-snapshot-3
...
```json
{
  ...
  "caseSensitive" : true,
  "valueSet" : "http://terminology.hl7.org/ValueSet/ex-program-code|1.0.1",
  "content" : "complete",
  "concept" : [
    {
      "code" : "as",
