# ExtensionSubscriptionTopic_Date - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Date status first applied (new) 

R5: `SubscriptionTopic.date` (new:dateTime)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-SubscriptionTopic.date)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-SubscriptionTopic.date.csv), [Excel](../StructureDefinition-ext-R5-SubscriptionTopic.date.xlsx), [Schematron](../StructureDefinition-ext-R5-SubscriptionTopic.date.sch) 
...
```json
{
  ...
  "id" : "ext-R5-SubscriptionTopic.date",
  "extension" : [{
  ...
  "version" : "0.1.0",
  "name" : "ExtensionSubscriptionTopic_Date",
  ...
  "description" : "R5: `SubscriptionTopic.date` (new:dateTime)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-SubscriptionTopic.date"
    },
    {
