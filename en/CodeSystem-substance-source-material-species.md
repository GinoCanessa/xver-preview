# SubstanceSourceMaterialSpecies - FHIR Cross-Version Extensions package to use FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## CodeSystem: SubstanceSourceMaterialSpecies 
...
* [ValueSetR5SubstanceSourceMaterialSpeciesForR4](ValueSet-ValueSet-R5-substance-source-material-species-for-R4.md)
...
```json
{
  ...
  "title" : "Substance Source Material Species",
  "status" : "active",
  "experimental" : false,
