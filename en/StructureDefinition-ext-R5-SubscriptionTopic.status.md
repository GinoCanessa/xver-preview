# ExtensionSubscriptionTopic_Status - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: draft | active | retired | unknown (new) 

R5: `SubscriptionTopic.status` (new:code)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-SubscriptionTopic.status)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-SubscriptionTopic.status.csv), [Excel](../StructureDefinition-ext-R5-SubscriptionTopic.status.xlsx), [Schematron](../StructureDefinition-ext-R5-SubscriptionTopic.status.sch) 
...
```json
{
  ...
  "id" : "ext-R5-SubscriptionTopic.status",
  "extension" : [{
  ...
  "version" : "0.1.0",
  "name" : "ExtensionSubscriptionTopic_Status",
  ...
  "description" : "R5: `SubscriptionTopic.status` (new:code)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-SubscriptionTopic.status"
    },
    {
