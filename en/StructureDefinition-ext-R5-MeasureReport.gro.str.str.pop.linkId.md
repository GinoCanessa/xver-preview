# ExtensionMeasureReport_Group_Stratifier_Stratum_Population_LinkId - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Pointer to specific population from Measure (new) 

R5: `MeasureReport.group.stratifier.stratum.population.linkId` (new:string)
...
```json
{
  ...
  "description" : "R5: `MeasureReport.group.stratifier.stratum.population.linkId` (new:string)",
  "jurisdiction" : [{
    "coding" : [{
