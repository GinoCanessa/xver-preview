# ExtensionDeviceDefinition_Version_Value - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: The version text (new) 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-DeviceDefinition.ver.value)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-DeviceDefinition.ver.value.csv), [Excel](../StructureDefinition-ext-R5-DeviceDefinition.ver.value.xlsx), [Schematron](../StructureDefinition-ext-R5-DeviceDefinition.ver.value.sch) 
...
```json
{
  ...
  "id" : "ext-R5-DeviceDefinition.ver.value",
  "extension" : [{
  ...
  "version" : "0.1.0",
  "name" : "ExtensionDeviceDefinition_Version_Value",
  "title" : "R5: The version text (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `DeviceDefinition.version.value` (new:string)",
  "jurisdiction" : [{
    "coding" : [{
