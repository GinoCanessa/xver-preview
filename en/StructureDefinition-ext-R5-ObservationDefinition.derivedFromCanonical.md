# ExtensionObservationDefinition_DerivedFromCanonical - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Based on FHIR definition of another observation (new) 
...
```json
{
  ...
  "title" : "R5: Based on FHIR definition of another observation (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `ObservationDefinition.derivedFromCanonical` (new:canonical(ObservationDefinition))",
  "jurisdiction" : [{
    "coding" : [{
