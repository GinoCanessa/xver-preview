# R5AdditionalBindingPurposeForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## ValueSet: Cross-version ValueSet R5.AdditionalBindingPurposeVS for use in FHIR R4 
...
* [R5: Additional Bindings - more rules about the binding (new)](StructureDefinition-ext-R5-ElementDefinition.bin.additional.md)
...
```json
{
  ...
  "id" : "R5-additional-binding-purpose-for-R4",
  "extension" : [{
  ...
  "url" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-additional-binding-purpose-for-R4",
  "version" : "0.1.0",
  "name" : "R5AdditionalBindingPurposeForR4",
  "title" : "Cross-version ValueSet R5.AdditionalBindingPurposeVS for use in FHIR R4",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "This cross-version ValueSet represents content from `http://hl7.org/fhir/ValueSet/additional-binding-purpose|5.0.0` for use in FHIR R4.",
  "jurisdiction" : [{
    "coding" : [{
