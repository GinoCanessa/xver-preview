# ExtensionRequestOrchestration_Action_Participant_Function - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: E.g. Author, Reviewer, Witness, etc (new) 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-RequestOrchestration.act.par.function)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-RequestOrchestration.act.par.function.csv), [Excel](../StructureDefinition-ext-R5-RequestOrchestration.act.par.function.xlsx), [Schematron](../StructureDefinition-ext-R5-RequestOrchestration.act.par.function.sch) 
...
```json
{
  ...
  "id" : "ext-R5-RequestOrchestration.act.par.function",
  "extension" : [{
  ...
  "version" : "0.1.0",
  "name" : "ExtensionRequestOrchestration_Action_Participant_Function",
  "title" : "R5: E.g. Author, Reviewer, Witness, etc (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `RequestOrchestration.action.participant.function` (new:CodeableConcept)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "example",
        "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-action-participant-function-for-R4|0.1.0"
      }
    }]
  }
}
