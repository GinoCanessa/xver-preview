# ExtensionDetectedIssue_Category - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Type of detected issue, e.g. drug-drug, duplicate therapy, etc (new) 
...
```json
{
  ...
  "title" : "R5: Type of detected issue, e.g. drug-drug, duplicate therapy, etc (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `DetectedIssue.category` (new:CodeableConcept)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        ...
        "valueSet" : "http://hl7.org/fhir/ValueSet/detectedissue-category|4.0.1"
      }
    }]
  }
}
