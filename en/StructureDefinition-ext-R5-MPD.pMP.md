# ExtensionMedicinalProductDefinition_PackagedMedicinalProduct - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Package type for the product additional types 

R5: `MedicinalProductDefinition.packagedMedicinalProduct` additional types (CodeableConcept) additional types from child elements (coding, text)
...
```json
{
  ...
  "title" : "R5: Package type for the product additional types",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `MedicinalProductDefinition.packagedMedicinalProduct` additional types (CodeableConcept) additional types from child elements (coding, text)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        ...
        "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-medicinal-product-package-type-for-R4|0.1.0"
      }
    }]
  }
}
