# ExtensionSubstanceDefinition_Structure_Technique - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: The method used to find the structure e.g. X-ray, NMR (new) 

R5: `SubstanceDefinition.structure.technique` (new:CodeableConcept)
...
```json
{
  ...
  "title" : "R5: The method used to find the structure e.g. X-ray, NMR (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `SubstanceDefinition.structure.technique` (new:CodeableConcept)",
  "jurisdiction" : [{
    "coding" : [{
