# ExtensionNutritionOrder_EnteralFormula_Administration_Schedule_AsNeeded - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Take 'as needed' (new) 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-NutritionOrder.ent.adm.sch.asNeeded)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-NutritionOrder.ent.adm.sch.asNeeded.csv), [Excel](../StructureDefinition-ext-R5-NutritionOrder.ent.adm.sch.asNeeded.xlsx), [Schematron](../StructureDefinition-ext-R5-NutritionOrder.ent.adm.sch.asNeeded.sch) 
...
```json
{
  ...
  "id" : "ext-R5-NutritionOrder.ent.adm.sch.asNeeded",
  "extension" : [{
  ...
  "version" : "0.1.0",
  "name" : "ExtensionNutritionOrder_EnteralFormula_Administration_Schedule_AsNeeded",
  "title" : "R5: Take 'as needed' (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `NutritionOrder.enteralFormula.administration.schedule.asNeeded` (new:boolean)",
  "jurisdiction" : [{
    "coding" : [{
