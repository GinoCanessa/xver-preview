# ExtensionMeasure_Group_ImprovementNotation - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: increase | decrease (new) 
...
```json
{
  ...
  "title" : "R5: increase | decrease (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Measure.group.improvementNotation` (new:CodeableConcept)",
  "jurisdiction" : [{
    "coding" : [{
