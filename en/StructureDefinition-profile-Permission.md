...
```json
{
  ...
  "status" : "active",
  "experimental" : false,
  "date" : "2026-02-21T13:36:54.3192997-06:00",
  ...
  "differential" : {
    "element" : [
      ...
      {
        "id" : "Basic.extension:Permission",
        "path" : "Basic.extension",
        "sliceName" : "Permission",
        "short" : "Cross-version extension for Permission from R5 for use in FHIR R4",
        "min" : 1,
        "max" : "1",
        "base" : {
          "path" : "DomainResource.extension",
        ...
        "type" : [
          {
            "code" : "Extension",
            "profile" : [
              "http://hl7.org/fhir/5.0/StructureDefinition/extension-Permission|0.0.1-snapshot-3"
            ]
          }
        ]
      },
