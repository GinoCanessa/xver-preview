# ExtensionValueSet_Reviewer - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Who reviewed the ValueSet (new) 

R5: `ValueSet.reviewer` (new:ContactDetail)
...
```json
{
  ...
  "title" : "R5: Who reviewed the ValueSet (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `ValueSet.reviewer` (new:ContactDetail)",
  "jurisdiction" : [{
    "coding" : [{
