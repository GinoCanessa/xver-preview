# ExtensionSpecimenDefinition_EffectivePeriod - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: The effective date range for the SpecimenDefinition (new) 
...
```json
{
  ...
  "title" : "R5: The effective date range for the SpecimenDefinition (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `SpecimenDefinition.effectivePeriod` (new:Period)",
  "jurisdiction" : [{
    "coding" : [{
