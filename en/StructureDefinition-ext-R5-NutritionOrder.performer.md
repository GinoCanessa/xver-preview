# ExtensionNutritionOrder_Performer - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Who is desired to perform the administration of what is being ordered (new) 
...
```json
{
  ...
  "title" : "R5: Who is desired to perform the administration of what is being ordered (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `NutritionOrder.performer` (new:CodeableReference(CareTeam,Practitioner,PractitionerRole,RelatedPerson,Patient,Organization))",
  "jurisdiction" : [{
    "coding" : [{
