...
### Lookup for FHIR R5 FormularyItem for use in FHIR R4

The FHIR R5 resource is represented in FHIR R4 via the Basic resource.

Note that there is a profile defined to simplify use of this cross-version resource representation:[Profile: FormularyItem](StructureDefinition-profile-FormularyItem.md)

A computable version of the following element information is available in: [R5FormularyItemElementMapToR4](ConceptMap-R5-FormularyItem-element-map-to-R4.md)
