# ClinicalUseDefinitionCategory - FHIR Cross-Version Extensions package to use FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## CodeSystem: ClinicalUseDefinitionCategory 
...
* [ValueSetR5ClinicalUseDefinitionCategoryForR4](ValueSet-ValueSet-R5-clinical-use-definition-category-for-R4.md)
...
```json
{
  ...
  "title" : "Clinical Use Definition Category",
  "status" : "active",
  "experimental" : false,
