  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "requirements" : "This value differentiates among the sites in a multi-site enterprise health information system. Element `AuditEvent.source.site` is mapped to FHIR R4 element `AuditEvent.source.site`.",
        "min" : 0,
        "max" : "1",
        "base" : {
          "path" : "Extension.extension",
      ...
      },
      {
        ...
        "requirements" : "This field ties the event to a specific source system. It may be used to group events for analysis according to where the event was detected. Element `AuditEvent.source.observer` is mapped to FHIR R4 element `AuditEvent.source.observer`.",
        "min" : 1,
        "max" : "1",
        "base" : {
          "path" : "Extension.extension",
