# ExtensionAuditEvent_Encounter - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Encounter within which this event occurred or which the event is tightly associated (new) 

R5: `AuditEvent.encounter` (new:Reference(Encounter))
...
```json
{
  ...
  "title" : "R5: Encounter within which this event occurred or which the event is tightly associated (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `AuditEvent.encounter` (new:Reference(Encounter))",
  "jurisdiction" : [{
    "coding" : [{
