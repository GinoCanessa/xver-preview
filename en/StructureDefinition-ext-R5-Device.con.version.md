# ExtensionDevice_ConformsTo_Version - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Specific form or variant of the standard (new) 

R5: `Device.conformsTo.version` (new:string)
...
```json
{
  ...
  "title" : "R5: Specific form or variant of the standard (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Device.conformsTo.version` (new:string)",
  "jurisdiction" : [{
    "coding" : [{
