# R5EventDefinitionElementMapToR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
```json
{
  ...
  "status" : "active",
  "experimental" : false,
  "date" : "2026-03-04T17:07:47.979326-06:00",
  "contact" : [{
  ...
  "group" : [{
    ...
    "element" : [{
      ...
      "target" : [{
        "code" : "EventDefinition.meta",
        "display" : "EventDefinition.meta",
        "equivalence" : "equivalent",
        "comment" : "Element `EventDefinition.meta` is mapped to FHIR R4 element `EventDefinition.meta` as `Equivalent`."
      }]
    },
    {
      ...
      "target" : [{
        "code" : "EventDefinition.implicitRules",
        "display" : "EventDefinition.implicitRules",
        "equivalence" : "equivalent",
        "comment" : "Element `EventDefinition.implicitRules` is mapped to FHIR R4 element `EventDefinition.implicitRules` as `Equivalent`.\nAsserting this rule set restricts the content to be only understood by a limited set of trading partners. This inherently limits the usefulness of the data in the long term. However, the existing health eco-system is highly fractured, and not yet ready to define, collect, and exchange data in a generally computable sense. Wherever possible, implementers and/or specification writers should avoid using this element. Often, when used, the URL is a reference to an implementation guide that defines these special rules as part of its narrative along with other profiles, value sets, etc."
      }]
    },
    {
      ...
      "target" : [{
        "code" : "EventDefinition.language",
        "display" : "EventDefinition.language",
        "equivalence" : "equivalent",
        "comment" : "Element `EventDefinition.language` is mapped to FHIR R4 element `EventDefinition.language` as `Equivalent`.\nLanguage is provided to support indexing and accessibility (typically, services such as text to speech use the language tag). The html language tag in the narrative applies  to the narrative. The language tag on the resource may be used to specify the language of other presentations generated from the data in the resource. Not all the content has to be in the base language. The Resource.language should not be assumed to apply to the narrative automatically. If a language is specified, it should it also be specified on the div element in the html (see rules in HTML5 for information about the relationship between xml:lang and the html lang attribute)."
      }]
    },
    {
      ...
      "target" : [{
        "code" : "EventDefinition.text",
        "display" : "EventDefinition.text",
        "equivalence" : "equivalent",
        "comment" : "Element `EventDefinition.text` is mapped to FHIR R4 element `EventDefinition.text` as `Equivalent`.\nContained resources do not have a narrative. Resources that are not contained SHOULD have a narrative. In some cases, a resource may only have text with little or no additional discrete data (as long as all minOccurs=1 elements are satisfied).  This may be necessary for data from legacy systems where information is captured as a \"text blob\" or where text is additionally entered raw or narrated and encoded information is added later."
      }]
    },
    {
      ...
      "target" : [{
        "code" : "EventDefinition.contained",
        "display" : "EventDefinition.contained",
        "equivalence" : "equivalent",
        "comment" : "Element `EventDefinition.contained` is mapped to FHIR R4 element `EventDefinition.contained` as `Equivalent`.\nThis should never be done when the content can be identified properly, as once identification is lost, it is extremely difficult (and context dependent) to restore it again. Contained resources may have profiles and tags in their meta elements, but SHALL NOT have security labels."
      }]
    },
    {
    ...
    },
    {
      ...
      "target" : [{
        "code" : "EventDefinition.name",
        "display" : "EventDefinition.name",
        "equivalence" : "equivalent",
        "comment" : "Element `EventDefinition.name` is mapped to FHIR R4 element `EventDefinition.name` as `Equivalent`.\nThe name is not expected to be globally unique. The name should be a simple alphanumeric type name to ensure that it is machine-processing friendly."
      }]
    },
    {
      ...
      "target" : [{
        "code" : "EventDefinition.title",
        "display" : "EventDefinition.title",
        "equivalence" : "equivalent",
        "comment" : "Element `EventDefinition.title` is mapped to FHIR R4 element `EventDefinition.title` as `Equivalent`.\nThis name does not need to be machine-processing friendly and may contain punctuation, white-space, etc."
      }]
    },
    {
      ...
      "target" : [{
        "code" : "EventDefinition.subtitle",
        "display" : "EventDefinition.subtitle",
        "equivalence" : "equivalent",
        "comment" : "Element `EventDefinition.subtitle` is mapped to FHIR R4 element `EventDefinition.subtitle` as `Equivalent`."
      }]
    },
    {
    ...
    },
    {
      ...
      "target" : [{
        "code" : "EventDefinition.experimental",
        "display" : "EventDefinition.experimental",
        "equivalence" : "equivalent",
        "comment" : "Element `EventDefinition.experimental` is mapped to FHIR R4 element `EventDefinition.experimental` as `Equivalent`.\nAllows filtering of event definitions that are appropriate for use versus not."
      }]
    },
    {
      ...
      "target" : [{
        "code" : "EventDefinition.subject[x]",
        "display" : "EventDefinition.subject[x]",
        "equivalence" : "equivalent",
        "comment" : "Element `EventDefinition.subject[x]` is mapped to FHIR R4 element `EventDefinition.subject[x]` as `Equivalent`.\nThe target context `EventDefinition.subject[x]` is a choice-type element and cannot directly hold extensions. The context is moved up to parent element `EventDefinition`."
      }]
    },
    {
      ...
      "target" : [{
        "code" : "EventDefinition.date",
        "display" : "EventDefinition.date",
        "equivalence" : "equivalent",
        "comment" : "Element `EventDefinition.date` is mapped to FHIR R4 element `EventDefinition.date` as `Equivalent`.\nThe date is often not tracked until the resource is published, but may be present on draft content. Note that this is not the same as the resource last-modified-date, since the resource may be a secondary representation of the event definition. Additional specific dates may be added as extensions or be found by consulting Provenances associated with past versions of the resource.\n\nSee guidance around (not) making local changes to elements [here](https://hl7.org/fhir/canonicalreso.html#localization)."
      }]
    },
    {
    ...
    },
    {
      ...
      "target" : [{
        "code" : "EventDefinition.contact",
        "display" : "EventDefinition.contact",
        "equivalence" : "equivalent",
        "comment" : "Element `EventDefinition.contact` is mapped to FHIR R4 element `EventDefinition.contact` as `Equivalent`.\nMay be a web site, an email address, a telephone number, etc.\n\nSee guidance around (not) making local changes to elements [here](https://hl7.org/fhir/canonicalreso.html#localization)."
      }]
    },
    {
    ...
    },
    {
      ...
      "target" : [{
        "code" : "EventDefinition.useContext",
        "display" : "EventDefinition.useContext",
        "equivalence" : "equivalent",
        "comment" : "Element `EventDefinition.useContext` is mapped to FHIR R4 element `EventDefinition.useContext` as `Equivalent`.\nWhen multiple useContexts are specified, there is no expectation that all or any of the contexts apply."
      }]
    },
    {
      ...
      "target" : [{
        "code" : "EventDefinition.jurisdiction",
        "display" : "EventDefinition.jurisdiction",
        "equivalence" : "equivalent",
        "comment" : "Element `EventDefinition.jurisdiction` is mapped to FHIR R4 element `EventDefinition.jurisdiction` as `Equivalent`.\nElement `EventDefinition.jurisdiction` has been flagged as deprecated.\nIt may be possible for the event definition to be used in jurisdictions other than those for which it was originally designed or intended.\n\nDEPRECATION NOTE: For consistency, implementations are encouraged to migrate to using the new 'jurisdiction' code in the useContext element.  (I.e. useContext.code indicating http://terminology.hl7.org/CodeSystem/usage-context-type#jurisdiction and useContext.valueCodeableConcept indicating the jurisdiction.)"
      }]
    },
    {
    ...
    },
    {
      ...
      "target" : [{
        "code" : "EventDefinition.usage",
        "display" : "EventDefinition.usage",
        "equivalence" : "equivalent",
        "comment" : "Element `EventDefinition.usage` is mapped to FHIR R4 element `EventDefinition.usage` as `Equivalent`."
      }]
    },
    {
      ...
      "target" : [{
        "code" : "EventDefinition.copyright",
        "display" : "EventDefinition.copyright",
        "equivalence" : "equivalent",
        "comment" : "Element `EventDefinition.copyright` is mapped to FHIR R4 element `EventDefinition.copyright` as `Equivalent`.\nThe short copyright declaration (e.g. (c) '2015+ xyz organization' should be sent in the copyrightLabel element."
      }]
    },
    {
      ...
      "target" : [{
        "code" : "EventDefinition.approvalDate",
        "display" : "EventDefinition.approvalDate",
        "equivalence" : "equivalent",
        "comment" : "Element `EventDefinition.approvalDate` is mapped to FHIR R4 element `EventDefinition.approvalDate` as `Equivalent`.\nThe 'date' element may be more recent than the approval date because of minor changes or editorial corrections.\n\nSee guidance around (not) making local changes to elements [here](https://hl7.org/fhir/canonicalreso.html#localization)."
      }]
    },
    {
      ...
      "target" : [{
        "code" : "EventDefinition.lastReviewDate",
        "display" : "EventDefinition.lastReviewDate",
        "equivalence" : "equivalent",
        "comment" : "Element `EventDefinition.lastReviewDate` is mapped to FHIR R4 element `EventDefinition.lastReviewDate` as `Equivalent`.\nIf specified, this date follows the original approval date.\n\nSee guidance around (not) making local changes to elements [here](https://hl7.org/fhir/canonicalreso.html#localization)."
      }]
    },
    {
    ...
    },
    {
      ...
      "target" : [{
        "code" : "EventDefinition.author",
        "display" : "EventDefinition.author",
        "equivalence" : "equivalent",
        "comment" : "Element `EventDefinition.author` is mapped to FHIR R4 element `EventDefinition.author` as `Equivalent`."
      }]
    },
    {
      ...
      "target" : [{
        "code" : "EventDefinition.editor",
        "display" : "EventDefinition.editor",
        "equivalence" : "equivalent",
        "comment" : "Element `EventDefinition.editor` is mapped to FHIR R4 element `EventDefinition.editor` as `Equivalent`."
      }]
    },
    {
      ...
      "target" : [{
        "code" : "EventDefinition.reviewer",
        "display" : "EventDefinition.reviewer",
        "equivalence" : "equivalent",
        "comment" : "Element `EventDefinition.reviewer` is mapped to FHIR R4 element `EventDefinition.reviewer` as `Equivalent`.\nSee guidance around (not) making local changes to elements [here](https://hl7.org/fhir/canonicalreso.html#localization)."
      }]
    },
    {
      ...
      "target" : [{
        "code" : "EventDefinition.endorser",
        "display" : "EventDefinition.endorser",
        "equivalence" : "equivalent",
        "comment" : "Element `EventDefinition.endorser` is mapped to FHIR R4 element `EventDefinition.endorser` as `Equivalent`.\nSee guidance around (not) making local changes to elements [here](https://hl7.org/fhir/canonicalreso.html#localization)."
      }]
    },
    {
      ...
      "target" : [{
        "code" : "EventDefinition.relatedArtifact",
        "display" : "EventDefinition.relatedArtifact",
        "equivalence" : "equivalent",
        "comment" : "Element `EventDefinition.relatedArtifact` is mapped to FHIR R4 element `EventDefinition.relatedArtifact` as `Equivalent`.\nEach related resource is either an attachment, or a reference to another resource, but not both."
      }]
    },
    {
      ...
      "target" : [{
        "code" : "EventDefinition.trigger",
        "display" : "EventDefinition.trigger",
        "equivalence" : "equivalent",
        "comment" : "Element `EventDefinition.trigger` is mapped to FHIR R4 element `EventDefinition.trigger` as `Equivalent`."
      }]
    }]
  },
  {
