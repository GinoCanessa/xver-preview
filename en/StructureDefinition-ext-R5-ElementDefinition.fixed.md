# ExtensionElementDefinition_Fixed - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: fixed additional types 

R5: `ElementDefinition.fixed[x]` additional types (CodeableReference, RatioRange, Availability, ExtendedContactDetail)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-ElementDefinition.fixed)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-ElementDefinition.fixed.csv), [Excel](../StructureDefinition-ext-R5-ElementDefinition.fixed.xlsx), [Schematron](../StructureDefinition-ext-R5-ElementDefinition.fixed.sch) 
...
```json
{
  ...
  "id" : "ext-R5-ElementDefinition.fixed",
  "extension" : [{
  ...
  "title" : "R5: fixed additional types",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `ElementDefinition.fixed[x]` additional types (CodeableReference, RatioRange, Availability, ExtendedContactDetail)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    "element" : [{
      "id" : "Extension",
      "path" : "Extension",
      "short" : "R5: fixed additional types",
      "definition" : "R5: `ElementDefinition.fixed[x]` additional types (CodeableReference, RatioRange, Availability, ExtendedContactDetail)",
      "comment" : "Element `ElementDefinition.fixed[x]` is mapped to FHIR R4 element `ElementDefinition.fixed[x]` as `RelatedTo`.\nThe mappings for `ElementDefinition.fixed[x]` do not cover the following types: Availability, CodeableReference, ExtendedContactDetail, RatioRange.\nThe target context `ElementDefinition.fixed[x]` is a choice-type element and cannot directly hold extensions. The context is moved up to parent element `ElementDefinition`.\nThis is not recommended for Coding and CodeableConcept since these often have highly contextual properties such as version or display.",
      "min" : 0,
      "max" : "1",
      "base" : {
        "path" : "Extension",
    ...
    },
    {
      ...
      "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-ElementDefinition.fixed"
    },
    {
