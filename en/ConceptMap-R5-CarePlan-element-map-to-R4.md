# R5CarePlanElementMapToR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
```json
{
  ...
  "status" : "active",
  "experimental" : false,
  "date" : "2026-03-04T17:07:46.7551422-06:00",
  "contact" : [{
  ...
  "group" : [{
    ...
    "element" : [{
      ...
      "target" : [{
        ...
        "comment" : "Element `CarePlan.meta` is mapped to FHIR R4 element `CarePlan.meta` as `Equivalent`."
      }]
    },
    {
    ...
    },
    {
      ...
      "target" : [{
        ...
        "equivalence" : "equivalent",
        "comment" : "Element `CarePlan.text` is mapped to FHIR R4 element `CarePlan.text` as `Equivalent`.\nContained resources do not have a narrative. Resources that are not contained SHOULD have a narrative. In some cases, a resource may only have text with little or no additional discrete data (as long as all minOccurs=1 elements are satisfied).  This may be necessary for data from legacy systems where information is captured as a \"text blob\" or where text is additionally entered raw or narrated and encoded information is added later."
      }]
    },
    {
      ...
      "target" : [{
        ...
        "equivalence" : "equivalent",
        "comment" : "Element `CarePlan.contained` is mapped to FHIR R4 element `CarePlan.contained` as `Equivalent`.\nThis should never be done when the content can be identified properly, as once identification is lost, it is extremely difficult (and context dependent) to restore it again. Contained resources may have profiles and tags in their meta elements, but SHALL NOT have security labels."
      }]
    },
    {
    ...
    },
    {
      ...
      "target" : [{
        "code" : "CarePlan.instantiatesCanonical",
        "display" : "CarePlan.instantiatesCanonical",
        "equivalence" : "equivalent",
        "comment" : "Element `CarePlan.instantiatesCanonical` is mapped to FHIR R4 element `CarePlan.instantiatesCanonical` as `Equivalent`."
      }]
    },
    {
      ...
      "target" : [{
        "code" : "CarePlan.instantiatesUri",
        "display" : "CarePlan.instantiatesUri",
        "equivalence" : "equivalent",
        "comment" : "Element `CarePlan.instantiatesUri` is mapped to FHIR R4 element `CarePlan.instantiatesUri` as `Equivalent`.\nThis might be an HTML page, PDF, etc. or could just be a non-resolvable URI identifier."
      }]
    },
    {
    ...
    },
    {
      ...
      "target" : [{
        ...
        "equivalence" : "equivalent",
        "comment" : "Element `CarePlan.replaces` is mapped to FHIR R4 element `CarePlan.replaces` as `Equivalent`.\nThe replacement could be because the initial care plan was immediately rejected (due to an issue) or because the previous care plan was completed, but the need for the action described by the care plan remains ongoing."
      }]
    },
    {
      ...
      "target" : [{
        ...
        "equivalence" : "equivalent",
        "comment" : "Element `CarePlan.partOf` is mapped to FHIR R4 element `CarePlan.partOf` as `Equivalent`.\nEach care plan is an independent request, such that having a care plan be part of another care plan can cause issues with cascading statuses.  As such, this element is still being discussed."
      }]
    },
    {
      ...
      "target" : [{
        ...
        "equivalence" : "equivalent",
        "comment" : "Element `CarePlan.status` is mapped to FHIR R4 element `CarePlan.status` as `Equivalent`.\nThe unknown code is not to be used to convey other statuses.  The unknown code should be used when one of the statuses applies, but the authoring system doesn't know the current state of the care plan.\n\nThis element is labeled as a modifier because the status contains the code entered-in-error that marks the plan as not currently valid."
      }]
    },
    {
    ...
    },
    {
      ...
      "target" : [{
        ...
        "equivalence" : "equivalent",
        "comment" : "Element `CarePlan.title` is mapped to FHIR R4 element `CarePlan.title` as `Equivalent`."
      }]
    },
    {
      ...
      "target" : [{
        ...
        "equivalence" : "equivalent",
        "comment" : "Element `CarePlan.description` is mapped to FHIR R4 element `CarePlan.description` as `Equivalent`."
      }]
    },
    {
      ...
      "target" : [{
        ...
        "equivalence" : "equivalent",
        "comment" : "Element `CarePlan.subject` is mapped to FHIR R4 element `CarePlan.subject` as `Equivalent`."
      }]
    },
    {
    ...
    },
    {
      ...
      "target" : [{
        ...
        "equivalence" : "equivalent",
        "comment" : "Element `CarePlan.created` is mapped to FHIR R4 element `CarePlan.created` as `Equivalent`."
      }]
    },
    {
      ...
      "target" : [{
        ...
        "equivalence" : "equivalent",
        "comment" : "Element `CarePlan.custodian` is mapped to FHIR R4 element `CarePlan.author` as `Equivalent`.\nThe custodian might or might not be a contributor."
      }]
    },
    {
      ...
      "target" : [{
        "code" : "CarePlan.contributor",
        "display" : "CarePlan.contributor",
        "equivalence" : "equivalent",
        "comment" : "Element `CarePlan.contributor` is mapped to FHIR R4 element `CarePlan.contributor` as `Equivalent`.\nCollaborative care plans may have multiple contributors."
      }]
    },
    {
      ...
      "target" : [{
        ...
        "equivalence" : "equivalent",
        "comment" : "Element `CarePlan.careTeam` is mapped to FHIR R4 element `CarePlan.careTeam` as `Equivalent`."
      }]
    },
    {
    ...
    },
    {
      ...
      "target" : [{
        ...
        "equivalence" : "equivalent",
        "comment" : "Element `CarePlan.goal` is mapped to FHIR R4 element `CarePlan.goal` as `Equivalent`.\nGoal can be achieving a particular change or merely maintaining a current state or even slowing a decline."
      }]
    },
    {
      ...
      "target" : [{
        ...
        "equivalence" : "wider",
        "comment" : "Element `CarePlan.activity` is mapped to FHIR R4 element `CarePlan.activity` as `Equivalent`."
      }]
    },
    {
    ...
    },
    {
      ...
      "target" : [{
        ...
        "equivalence" : "equivalent",
        "comment" : "Element `CarePlan.activity.progress` is mapped to FHIR R4 element `CarePlan.activity.progress` as `Equivalent`.\nThis element should NOT be used to describe the activity to be performed - that occurs either within the resource pointed to by activity.detail.reference or in activity.detail.description."
      }]
    },
    {
    ...
    },
    {
      ...
      "target" : [{
        ...
        "equivalence" : "equivalent",
        "comment" : "Element `CarePlan.note` is mapped to FHIR R4 element `CarePlan.note` as `Equivalent`."
      }]
    }]
  },
  {
