# ExtensionPlanDefinition_Action_Output_Title - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: User-visible title (new) 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-PlanDefinition.act.out.title)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-PlanDefinition.act.out.title.csv), [Excel](../StructureDefinition-ext-R5-PlanDefinition.act.out.title.xlsx), [Schematron](../StructureDefinition-ext-R5-PlanDefinition.act.out.title.sch) 
...
```json
{
  ...
  "id" : "ext-R5-PlanDefinition.act.out.title",
  "extension" : [{
  ...
  "version" : "0.1.0",
  "name" : "ExtensionPlanDefinition_Action_Output_Title",
  "title" : "R5: User-visible title (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `PlanDefinition.action.output.title` (new:string)",
  "jurisdiction" : [{
    "coding" : [{
