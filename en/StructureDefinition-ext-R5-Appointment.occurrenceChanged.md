# ExtensionAppointment_OccurrenceChanged - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Indicates that this appointment varies from a recurrence pattern (new) 
...
```json
{
  ...
  "title" : "R5: Indicates that this appointment varies from a recurrence pattern (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Appointment.occurrenceChanged` (new:boolean)",
  "jurisdiction" : [{
    "coding" : [{
