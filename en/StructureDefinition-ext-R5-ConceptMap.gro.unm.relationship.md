# ExtensionConceptMap_Group_Unmapped_Relationship - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: related-to | equivalent | source-is-narrower-than-target | source-is-broader-than-target | not-related-to (new) 

R5: `ConceptMap.group.unmapped.relationship` (new:code)
...
```json
{
  ...
  "title" : "R5: related-to | equivalent | source-is-narrower-than-target | source-is-broader-than-target | not-related-to (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `ConceptMap.group.unmapped.relationship` (new:code)",
  "jurisdiction" : [{
    "coding" : [{
