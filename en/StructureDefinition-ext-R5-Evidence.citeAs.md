# ExtensionEvidence_CiteAs - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Citation for this evidence (new) 
...
```json
{
  ...
  "title" : "R5: Citation for this evidence (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Evidence.citeAs[x]` (new:markdown, Reference(Citation))",
  "jurisdiction" : [{
    "coding" : [{
