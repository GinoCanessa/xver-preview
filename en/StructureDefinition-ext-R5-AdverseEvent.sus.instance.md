# ExtensionAdverseEvent_SuspectEntity_Instance - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: instance additional types 
...
```json
{
  ...
  "title" : "R5: instance additional types",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `AdverseEvent.suspectEntity.instance[x]` additional types (CodeableConcept)",
  "jurisdiction" : [{
    "coding" : [{
