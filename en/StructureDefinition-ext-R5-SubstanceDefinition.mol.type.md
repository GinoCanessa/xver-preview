# ExtensionSubstanceDefinition_MolecularWeight_Type - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Type of molecular weight e.g. exact, average, weight average (new) 

R5: `SubstanceDefinition.molecularWeight.type` (new:CodeableConcept)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-SubstanceDefinition.mol.type)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-SubstanceDefinition.mol.type.csv), [Excel](../StructureDefinition-ext-R5-SubstanceDefinition.mol.type.xlsx), [Schematron](../StructureDefinition-ext-R5-SubstanceDefinition.mol.type.sch) 
...
```json
{
  ...
  "id" : "ext-R5-SubstanceDefinition.mol.type",
  "extension" : [{
  ...
  "version" : "0.1.0",
  "name" : "ExtensionSubstanceDefinition_MolecularWeight_Type",
  "title" : "R5: Type of molecular weight e.g. exact, average, weight average (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `SubstanceDefinition.molecularWeight.type` (new:CodeableConcept)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        ...
        "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-substance-weight-type-for-R4|0.1.0"
      }
    }]
  }
}
