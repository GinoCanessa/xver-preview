# ExtensionConsent_Provision_Expression - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: A computable expression of the consent (new) 
...
```json
{
  ...
  "title" : "R5: A computable expression of the consent (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Consent.provision.expression` (new:Expression)",
  "jurisdiction" : [{
    "coding" : [{
