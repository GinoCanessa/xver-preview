# ValueSetR5StatisticModelCodeForR4 - FHIR Cross-Version Extensions package to use FHIR R5 in FHIR R4 v0.0.1-snapshot-3
...
```json
{
  ...
  "id" : "ValueSet-R5-statistic-model-code-for-R4",
  "extension" : [
    {
  ...
  "url" : "http://hl7.org/fhir/5.0/ValueSet/ValueSet-R5-statistic-model-code-for-R4",
  "version" : "0.0.1-snapshot-3",
  "name" : "ValueSetR5StatisticModelCodeForR4",
