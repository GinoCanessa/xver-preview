# ExtensionSpecimenDefinition_DerivedFromCanonical - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Based on FHIR definition of another SpecimenDefinition (new) 
...
```json
{
  ...
  "title" : "R5: Based on FHIR definition of another SpecimenDefinition (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `SpecimenDefinition.derivedFromCanonical` (new:canonical(SpecimenDefinition))",
  "jurisdiction" : [{
    "coding" : [{
