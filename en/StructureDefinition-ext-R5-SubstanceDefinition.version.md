...
This cross-version extension represents the FHIR R5 element `SubstanceDefinition.version` for use in FHIR R4.
...
```json
{
  ...
  "description" : "This cross-version extension represents the FHIR R5 element `SubstanceDefinition.version` for use in FHIR R4.",
  "jurisdiction" : [
    {
      "coding" : [
        {
