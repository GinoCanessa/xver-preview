# ExtensionCitation_Date - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Date last changed (new) 

R5: `Citation.date` (new:dateTime)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-Citation.date)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-Citation.date.csv), [Excel](../StructureDefinition-ext-R5-Citation.date.xlsx), [Schematron](../StructureDefinition-ext-R5-Citation.date.sch) 
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Citation.date",
  "version" : "0.1.0",
  "name" : "ExtensionCitation_Date",
  ...
  "description" : "R5: `Citation.date` (new:dateTime)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "purpose" : "This extension is part of the cross-version definitions generated to enable use of the\r\nelement `Citation.date` as defined in FHIR R5\r\nin FHIR R4.\r\n\r\nThe source element is defined as:\r\n`Citation.date` 0..1 `dateTime`\r\n\r\nAcross FHIR versions, the element set has been mapped as:\r\n*  R5: `Citation.date` 0..1 `dateTime`\r\n\r\nFollowing are the generation technical comments:\r\nElement `Citation.date` is not mapped to FHIR R4, since FHIR R5 `Citation` is not mapped.\nElement `Citation.date` has no mapping targets in FHIR R4. Typically, this is because the element has been added (is a new element).",
  "fhirVersion" : "4.0.1",
  "mapping" : [{
    "identity" : "rim",
    "uri" : "http://hl7.org/v3",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Citation.date"
    },
    {
