# ExtensionImmunization_AdministeredProduct - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Product that was administered (new) 
...
```json
{
  ...
  "title" : "R5: Product that was administered (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Immunization.administeredProduct` (new:CodeableReference(Medication))",
  "jurisdiction" : [{
    "coding" : [{
