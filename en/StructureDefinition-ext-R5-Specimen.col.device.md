# ExtensionSpecimen_Collection_Device - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Device used to perform collection (new) 

R5: `Specimen.collection.device` (new:CodeableReference(Device))
...
```json
{
  ...
  "title" : "R5: Device used to perform collection (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Specimen.collection.device` (new:CodeableReference(Device))",
  "jurisdiction" : [{
    "coding" : [{
