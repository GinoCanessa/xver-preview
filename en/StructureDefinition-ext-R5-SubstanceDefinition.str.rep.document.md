# ExtensionSubstanceDefinition_Structure_Representation_Document - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: An attachment with the structural representation e.g. a structure graphic or AnIML file (new) 

R5: `SubstanceDefinition.structure.representation.document` (new:Reference(DocumentReference))
...
```json
{
  ...
  "title" : "R5: An attachment with the structural representation e.g. a structure graphic or AnIML file (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `SubstanceDefinition.structure.representation.document` (new:Reference(DocumentReference))",
  "jurisdiction" : [{
    "coding" : [{
