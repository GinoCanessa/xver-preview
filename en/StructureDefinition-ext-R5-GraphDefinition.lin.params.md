# ExtensionGraphDefinition_Link_Params - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Criteria for reverse lookup (new) 

R5: `GraphDefinition.link.params` (new:string)
...
```json
{
  ...
  "title" : "R5: Criteria for reverse lookup (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `GraphDefinition.link.params` (new:string)",
  "jurisdiction" : [{
    "coding" : [{
