# R5V3HL7FormatCodesForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
* [R5: Content profile rules for the document (new)](StructureDefinition-ext-R5-DocumentReference.con.profile.md)
