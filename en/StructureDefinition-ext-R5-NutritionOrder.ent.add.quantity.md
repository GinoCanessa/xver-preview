# ExtensionNutritionOrder_EnteralFormula_Additive_Quantity - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Amount of additive to be given or mixed in (new) 
...
```json
{
  ...
  "title" : "R5: Amount of additive to be given or mixed in (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `NutritionOrder.enteralFormula.additive.quantity` (new:Quantity[SimpleQuantity])",
  "jurisdiction" : [{
    "coding" : [{
