...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-FamilyMemberHistory.reason)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-FamilyMemberHistory.reason.csv), [Excel](../StructureDefinition-ext-R5-FamilyMemberHistory.reason.xlsx), [Schematron](../StructureDefinition-ext-R5-FamilyMemberHistory.reason.sch) 
...
```json
{
  ...
  "id" : "ext-R5-FamilyMemberHistory.reason",
  "extension" : [{
  ...
  "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-FamilyMemberHistory.reason",
  "version" : "0.1.0",
  "name" : "ExtensionFamilyMemberHistory_Reason",
  "title" : "R5: Why was family member history performed? additional types",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `FamilyMemberHistory.reason` additional types (CodeableReference(http://hl7.org/fhir/StructureDefinition/Condition), CodeableReference(http://hl7.org/fhir/StructureDefinition/Observation), CodeableReference(http://hl7.org/fhir/StructureDefinition/AllergyIntolerance), CodeableReference(http://hl7.org/fhir/StructureDefinition/QuestionnaireResponse), CodeableReference(http://hl7.org/fhir/StructureDefinition/DiagnosticReport), CodeableReference(http://hl7.org/fhir/StructureDefinition/DocumentReference))",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-FamilyMemberHistory.reason"
    },
    {
