# ExtensionMeasure_Group_Subject - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: E.g. Patient, Practitioner, RelatedPerson, Organization, Location, Device (new) 
...
```json
{
  ...
  "title" : "R5: E.g. Patient, Practitioner, RelatedPerson, Organization, Location, Device (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Measure.group.subject[x]` (new:CodeableConcept, Reference(Group))",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        ...
        "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-participant-resource-types-for-R4|0.1.0"
      }
    }]
  }
}
