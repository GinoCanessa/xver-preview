# ExtensionSubscription_Parameter - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
```json
{
  ...
  "description" : "R5: `Subscription.parameter` (new:BackboneElement)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "path" : "Extension.extension",
      "sliceName" : "name",
      "short" : "R5: Name (key) of the parameter (new)",
      "definition" : "R5: `Subscription.parameter.name` (new:string)",
    ...
    },
    {
      ...
      "path" : "Extension.extension",
      "sliceName" : "value",
      "short" : "R5: Value of the parameter to use or pass through (new)",
      "definition" : "R5: `Subscription.parameter.value` (new:string)",
