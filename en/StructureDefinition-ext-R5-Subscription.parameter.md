# ExtensionSubscription_Parameter - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## Extension: Cross-version Extension `R5.Subscription.parameter` for use in FHIR R4 

This cross-version extension represents the FHIR R5 element `Subscription.parameter` for use in FHIR R4.
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-Subscription.parameter.csv), [Excel](../StructureDefinition-ext-R5-Subscription.parameter.xlsx), [Schematron](../StructureDefinition-ext-R5-Subscription.parameter.sch) 
...
```json
{
  ...
  "id" : "ext-R5-Subscription.parameter",
  "extension" : [
    {
  ...
  "name" : "ExtensionSubscription_Parameter",
  ...
  "description" : "This cross-version extension represents the FHIR R5 element `Subscription.parameter` for use in FHIR R4.",
  "jurisdiction" : [
    {
      "coding" : [
        {
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "requirements" : "Element `Subscription.parameter.name` has a context of Subscription based on following the parent source element upwards and mapping to `Subscription`.",
        "min" : 1,
        "max" : "1",
        "base" : {
          "path" : "Extension.extension",
      ...
      },
      {
        ...
        "requirements" : "Element `Subscription.parameter.value` has a context of Subscription based on following the parent source element upwards and mapping to `Subscription`.",
        "min" : 1,
        "max" : "1",
        "base" : {
          "path" : "Extension.extension",
      ...
      },
      {
        ...
        "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Subscription.parameter"
      },
      {
