# ExtensionExplanationOfBenefit_Decision - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Result of the adjudication (new) 

R5: `ExplanationOfBenefit.decision` (new:CodeableConcept)
...
```json
{
  ...
  "description" : "R5: `ExplanationOfBenefit.decision` (new:CodeableConcept)",
  "jurisdiction" : [{
    "coding" : [{
