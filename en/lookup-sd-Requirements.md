...
Note that there is a profile defined to simplify use of this cross-version resource representation:[Profile: Requirements](StructureDefinition-profile-Requirements.md)

A computable version of the following element information is available in: [ConceptMapR5RequirementsElementsForR4](ConceptMap-ConceptMap-R5-Requirements-elements-for-R4.md)
