# SpecialMeasures - FHIR Cross-Version Extensions package to use FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## CodeSystem: SpecialMeasures 
...
* [ValueSetR5MedicinalProductSpecialMeasuresForR4](ValueSet-ValueSet-R5-medicinal-product-special-measures-for-R4.md)
  ...
  "concept" : [
    {
      ...
      "definition" : "Requirement to conduct post-authorization studies"
    }
  ]
}
