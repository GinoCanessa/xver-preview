# ExtensionOperationDefinition_Parameter_AllowedType - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Allowed sub-type this parameter can have (if type is abstract) (new) 

R5: `OperationDefinition.parameter.allowedType` (new:code)
...
```json
{
  ...
  "title" : "R5: Allowed sub-type this parameter can have (if type is abstract) (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `OperationDefinition.parameter.allowedType` (new:code)",
  "jurisdiction" : [{
    "coding" : [{
