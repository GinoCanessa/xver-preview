# ExtensionValueSet_Author - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Who authored the ValueSet (new) 

R5: `ValueSet.author` (new:ContactDetail)
...
```json
{
  ...
  "title" : "R5: Who authored the ValueSet (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `ValueSet.author` (new:ContactDetail)",
  "jurisdiction" : [{
    "coding" : [{
