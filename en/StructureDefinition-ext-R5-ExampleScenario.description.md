# ExtensionExampleScenario_Description - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Natural language description of the ExampleScenario (new) 

R5: `ExampleScenario.description` (new:markdown)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-ExampleScenario.description)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-ExampleScenario.description.csv), [Excel](../StructureDefinition-ext-R5-ExampleScenario.description.xlsx), [Schematron](../StructureDefinition-ext-R5-ExampleScenario.description.sch) 
...
```json
{
  ...
  "id" : "ext-R5-ExampleScenario.description",
  "extension" : [{
  ...
  "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-ExampleScenario.description",
  "version" : "0.1.0",
  "name" : "ExtensionExampleScenario_Description",
  "title" : "R5: Natural language description of the ExampleScenario (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `ExampleScenario.description` (new:markdown)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-ExampleScenario.description"
    },
    {
