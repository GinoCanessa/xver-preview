# ExtensionAppointment_OriginatingAppointment - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: The originating appointment in a recurring set of appointments (new) 
...
```json
{
  ...
  "title" : "R5: The originating appointment in a recurring set of appointments (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Appointment.originatingAppointment` (new:Reference(Appointment))",
  "jurisdiction" : [{
    "coding" : [{
