# ExtensionSubstanceDefinition_SourceMaterial_Type - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Classification of the origin of the raw material. e.g. cat hair is an Animal source type (new) 

R5: `SubstanceDefinition.sourceMaterial.type` (new:CodeableConcept)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-SubstanceDefinition.sou.type)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-SubstanceDefinition.sou.type.csv), [Excel](../StructureDefinition-ext-R5-SubstanceDefinition.sou.type.xlsx), [Schematron](../StructureDefinition-ext-R5-SubstanceDefinition.sou.type.sch) 
...
```json
{
  ...
  "id" : "ext-R5-SubstanceDefinition.sou.type",
  "extension" : [{
  ...
  "version" : "0.1.0",
  "name" : "ExtensionSubstanceDefinition_SourceMaterial_Type",
  "title" : "R5: Classification of the origin of the raw material. e.g. cat hair is an Animal source type (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `SubstanceDefinition.sourceMaterial.type` (new:CodeableConcept)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        ...
        "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-substance-source-material-type-for-R4|0.1.0"
      }
    }]
  }
}
