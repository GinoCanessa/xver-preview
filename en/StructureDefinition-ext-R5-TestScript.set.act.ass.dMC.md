# ExtensionTestScript_Setup_Action_Assert_DefaultManualCompletion - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: fail | pass | skip | stop (new) 
...
```json
{
  ...
  "title" : "R5: fail | pass | skip | stop (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `TestScript.setup.action.assert.defaultManualCompletion` (new:code)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        ...
        "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-assert-manual-completion-codes-for-R4|0.1.0"
      }
    }]
  }
}
