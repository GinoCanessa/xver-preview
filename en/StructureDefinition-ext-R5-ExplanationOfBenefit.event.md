# ExtensionExplanationOfBenefit_Event - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## Extension: Cross-version Extension `R5.ExplanationOfBenefit.event` for use in FHIR R4 

This cross-version extension represents the FHIR R5 element `ExplanationOfBenefit.event` for use in FHIR R4.
...
```json
{
  ...
  "title" : "Cross-version Extension `R5.ExplanationOfBenefit.event` for use in FHIR R4",
  "status" : "active",
  "experimental" : false,
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "requirements" : "Element `ExplanationOfBenefit.event.type` has a context of ExplanationOfBenefit based on following the parent source element upwards and mapping to `ExplanationOfBenefit`.",
        "min" : 1,
        "max" : "1",
        "base" : {
          "path" : "Extension.extension",
      ...
      },
      {
        ...
        "requirements" : "Element `ExplanationOfBenefit.event.when[x]` has a context of ExplanationOfBenefit based on following the parent source element upwards and mapping to `ExplanationOfBenefit`.",
        "min" : 1,
        "max" : "1",
        "base" : {
          "path" : "Extension.extension",
