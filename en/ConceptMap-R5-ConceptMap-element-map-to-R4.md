# R5ConceptMapElementMapToR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
```json
{
  ...
  "status" : "active",
  "experimental" : false,
  "date" : "2026-03-04T17:07:47.4077355-06:00",
  "contact" : [{
  ...
  "group" : [{
    ...
    "element" : [{
      ...
      "target" : [{
        "code" : "ConceptMap.meta",
        "display" : "ConceptMap.meta",
        "equivalence" : "equivalent",
        "comment" : "Element `ConceptMap.meta` is mapped to FHIR R4 element `ConceptMap.meta` as `Equivalent`."
      }]
    },
    {
      ...
      "target" : [{
        "code" : "ConceptMap.implicitRules",
        "display" : "ConceptMap.implicitRules",
        "equivalence" : "equivalent",
        "comment" : "Element `ConceptMap.implicitRules` is mapped to FHIR R4 element `ConceptMap.implicitRules` as `Equivalent`.\nAsserting this rule set restricts the content to be only understood by a limited set of trading partners. This inherently limits the usefulness of the data in the long term. However, the existing health eco-system is highly fractured, and not yet ready to define, collect, and exchange data in a generally computable sense. Wherever possible, implementers and/or specification writers should avoid using this element. Often, when used, the URL is a reference to an implementation guide that defines these special rules as part of its narrative along with other profiles, value sets, etc."
      }]
    },
    {
    ...
    },
    {
      ...
      "target" : [{
        "code" : "ConceptMap.text",
        "display" : "ConceptMap.text",
        "equivalence" : "equivalent",
        "comment" : "Element `ConceptMap.text` is mapped to FHIR R4 element `ConceptMap.text` as `Equivalent`.\nContained resources do not have a narrative. Resources that are not contained SHOULD have a narrative. In some cases, a resource may only have text with little or no additional discrete data (as long as all minOccurs=1 elements are satisfied).  This may be necessary for data from legacy systems where information is captured as a \"text blob\" or where text is additionally entered raw or narrated and encoded information is added later."
      }]
    },
    {
      ...
      "target" : [{
        "code" : "ConceptMap.contained",
        "display" : "ConceptMap.contained",
        "equivalence" : "equivalent",
        "comment" : "Element `ConceptMap.contained` is mapped to FHIR R4 element `ConceptMap.contained` as `Equivalent`.\nThis should never be done when the content can be identified properly, as once identification is lost, it is extremely difficult (and context dependent) to restore it again. Contained resources may have profiles and tags in their meta elements, but SHALL NOT have security labels."
      }]
    },
    {
      "code" : "ConceptMap.url",
    ...
    },
    {
      ...
      "target" : [{
        "code" : "ConceptMap.name",
        "display" : "ConceptMap.name",
        "equivalence" : "equivalent",
        "comment" : "Element `ConceptMap.name` is mapped to FHIR R4 element `ConceptMap.name` as `Equivalent`.\nThe name is not expected to be globally unique. The name should be a simple alphanumeric type name to ensure that it is machine-processing friendly."
      }]
    },
    {
      ...
      "target" : [{
        "code" : "ConceptMap.title",
        "display" : "ConceptMap.title",
        "equivalence" : "equivalent",
        "comment" : "Element `ConceptMap.title` is mapped to FHIR R4 element `ConceptMap.title` as `Equivalent`.\nThis name does not need to be machine-processing friendly and may contain punctuation, white-space, etc."
      }]
    },
    {
    ...
    },
    {
      ...
      "target" : [{
        "code" : "ConceptMap.experimental",
        "display" : "ConceptMap.experimental",
        "equivalence" : "equivalent",
        "comment" : "Element `ConceptMap.experimental` is mapped to FHIR R4 element `ConceptMap.experimental` as `Equivalent`.\nAllows filtering of concept maps that are appropriate for use versus not."
      }]
    },
    {
    ...
    },
    {
      ...
      "target" : [{
        "code" : "ConceptMap.publisher",
        "display" : "ConceptMap.publisher",
        "equivalence" : "equivalent",
        "comment" : "Element `ConceptMap.publisher` is mapped to FHIR R4 element `ConceptMap.publisher` as `Equivalent`.\nUsually an organization but may be an individual. The publisher (or steward) of the concept map is the organization or individual primarily responsible for the maintenance and upkeep of the concept map. This is not necessarily the same individual or organization that developed and initially authored the content. The publisher is the primary point of contact for questions or issues with the concept map. This item SHOULD be populated unless the information is available from context."
      }]
    },
    {
      ...
      "target" : [{
        "code" : "ConceptMap.contact",
        "display" : "ConceptMap.contact",
        "equivalence" : "equivalent",
        "comment" : "Element `ConceptMap.contact` is mapped to FHIR R4 element `ConceptMap.contact` as `Equivalent`.\nMay be a web site, an email address, a telephone number, etc.\n\nSee guidance around (not) making local changes to elements [here](https://hl7.org/fhir/canonicalreso.html#localization)."
      }]
    },
    {
    ...
    },
    {
      ...
      "target" : [{
        "code" : "ConceptMap.useContext",
        "display" : "ConceptMap.useContext",
        "equivalence" : "equivalent",
        "comment" : "Element `ConceptMap.useContext` is mapped to FHIR R4 element `ConceptMap.useContext` as `Equivalent`.\nWhen multiple useContexts are specified, there is no expectation that all or any of the contexts apply."
      }]
    },
    {
    ...
    },
    {
      ...
      "target" : [{
        "code" : "ConceptMap.group",
        "display" : "ConceptMap.group",
        "equivalence" : "wider",
        "comment" : "Element `ConceptMap.group` is mapped to FHIR R4 element `ConceptMap.group` as `Equivalent`."
      }]
    },
    {
      ...
      "target" : [{
        "code" : "ConceptMap.group.source",
        "display" : "ConceptMap.group.source",
        "equivalence" : "equivalent",
        "comment" : "Element `ConceptMap.group.source` is mapped to FHIR R4 element `ConceptMap.group.source` as `Equivalent`.\nThis is not needed if the source value set is specified and it contains concepts from only a single system."
      }]
    },
    {
    ...
    },
    {
      ...
      "target" : [{
        "code" : "ConceptMap.group.element",
        "display" : "ConceptMap.group.element",
        "equivalence" : "wider",
        "comment" : "Element `ConceptMap.group.element` is mapped to FHIR R4 element `ConceptMap.group.element` as `Equivalent`.\nGenerally, the ideal is that there would only be one mapping for each concept in the source value set, but a given concept may be mapped multiple times with different comments or dependencies."
      }]
    },
    {
      ...
      "target" : [{
        "code" : "ConceptMap.group.element.code",
        "display" : "ConceptMap.group.element.code",
        "equivalence" : "equivalent",
        "comment" : "Element `ConceptMap.group.element.code` is mapped to FHIR R4 element `ConceptMap.group.element.code` as `Equivalent`."
      }]
    },
    {
      ...
      "target" : [{
        "code" : "ConceptMap.group.element.display",
        "display" : "ConceptMap.group.element.display",
        "equivalence" : "equivalent",
        "comment" : "Element `ConceptMap.group.element.display` is mapped to FHIR R4 element `ConceptMap.group.element.display` as `Equivalent`.\nThe display is ignored when processing the map."
      }]
    },
    {
      ...
      "target" : [{
        ...
        "display" : "ConceptMap.group.element.target.equivalence",
        "equivalence" : "wider",
    ...
    },
    {
      ...
      "target" : [{
        "code" : "ConceptMap.group.element.target.code",
        "display" : "ConceptMap.group.element.target.code",
        "equivalence" : "equivalent",
        "comment" : "Element `ConceptMap.group.element.target.code` is mapped to FHIR R4 element `ConceptMap.group.element.target.code` as `Equivalent`."
      }]
    },
    {
      ...
      "target" : [{
        "code" : "ConceptMap.group.element.target.display",
        "display" : "ConceptMap.group.element.target.display",
        "equivalence" : "equivalent",
        "comment" : "Element `ConceptMap.group.element.target.display` is mapped to FHIR R4 element `ConceptMap.group.element.target.display` as `Equivalent`.\nThe display is ignored when processing the map."
      }]
    },
    {
    ...
    },
    {
      ...
      "target" : [{
        "code" : "ConceptMap.group.element.target.comment",
        "display" : "ConceptMap.group.element.target.comment",
        "equivalence" : "equivalent",
        "comment" : "Element `ConceptMap.group.element.target.comment` is mapped to FHIR R4 element `ConceptMap.group.element.target.comment` as `Equivalent`."
      }]
    },
    {
      ...
      "target" : [{
        "code" : "ConceptMap.group.element.target.dependsOn",
        "display" : "ConceptMap.group.element.target.dependsOn",
        "equivalence" : "wider",
        "comment" : "Element `ConceptMap.group.element.target.dependsOn` is mapped to FHIR R4 element `ConceptMap.group.element.target.dependsOn` as `Equivalent`."
      }]
    },
    {
      ...
      "target" : [{
        ...
        "display" : "ConceptMap.group.element.target.dependsOn.property",
        "equivalence" : "wider",
    ...
    },
    {
      ...
      "target" : [{
        ...
        "display" : "ConceptMap.group.element.target.dependsOn.value",
        "equivalence" : "wider",
    ...
    },
    {
      ...
      "target" : [{
        "code" : "ConceptMap.group.element.target.product",
        "display" : "ConceptMap.group.element.target.product",
        "equivalence" : "equivalent",
        "comment" : "Element `ConceptMap.group.element.target.product` is mapped to FHIR R4 element `ConceptMap.group.element.target.product` as `Equivalent`."
      }]
    },
    {
      ...
      "target" : [{
        "code" : "ConceptMap.group.unmapped",
        "display" : "ConceptMap.group.unmapped",
        "equivalence" : "wider",
        "comment" : "Element `ConceptMap.group.unmapped` is mapped to FHIR R4 element `ConceptMap.group.unmapped` as `Equivalent`.\nThe 'unmapped' element is ignored if a code is specified to have relationship = not-related-to or if ConceptMap.group.element.noMap = true."
      }]
    },
    {
      ...
      "target" : [{
        "code" : "ConceptMap.group.unmapped.mode",
        "display" : "ConceptMap.group.unmapped.mode",
        "equivalence" : "equivalent",
        "comment" : "Element `ConceptMap.group.unmapped.mode` is mapped to FHIR R4 element `ConceptMap.group.unmapped.mode` as `Equivalent`."
      }]
    },
    {
      ...
      "target" : [{
        "code" : "ConceptMap.group.unmapped.code",
        "display" : "ConceptMap.group.unmapped.code",
        "equivalence" : "equivalent",
        "comment" : "Element `ConceptMap.group.unmapped.code` is mapped to FHIR R4 element `ConceptMap.group.unmapped.code` as `Equivalent`."
      }]
    },
    {
      ...
      "target" : [{
        "code" : "ConceptMap.group.unmapped.display",
        "display" : "ConceptMap.group.unmapped.display",
        "equivalence" : "equivalent",
        "comment" : "Element `ConceptMap.group.unmapped.display` is mapped to FHIR R4 element `ConceptMap.group.unmapped.display` as `Equivalent`.\nThe display is ignored when processing the map."
      }]
    },
    {
      ...
      "target" : [{
        ...
        "display" : "ConceptMap.group.unmapped.url",
        "equivalence" : "equivalent",
        "comment" : "Element `ConceptMap.group.unmapped.otherMap` is mapped to FHIR R4 element `ConceptMap.group.unmapped.url` as `Equivalent`."
      }]
    }]
  },
  {
    ...
    },
    {
      ...
      "display" : "attribute",
      "target" : [{
        "code" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-ConceptMap.group.element.target.dependsOn.attribute",
        "equivalence" : "wider",
        "comment" : "Element `ConceptMap.group.element.target.dependsOn.attribute` is mapped to FHIR R4 element `ConceptMap.group.element.target.dependsOn.property` as `SourceIsBroaderThanTarget`.\nThe mappings for `ConceptMap.group.element.target.dependsOn.attribute` do not cover the following types: code.\nThe mappings for `ConceptMap.group.element.target.dependsOn.attribute` do not cover the following types based on type expansion: value."
      }]
    },
    {
      ...
      "display" : "value[x]",
      "target" : [{
        "code" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-ConceptMap.group.element.target.dependsOn.value",
        "equivalence" : "wider",
        "comment" : "Element `ConceptMap.group.element.target.dependsOn.value[x]` is mapped to FHIR R4 element `ConceptMap.group.element.target.dependsOn.value` as `SourceIsBroaderThanTarget`.\nThe mappings for `ConceptMap.group.element.target.dependsOn.value[x]` do not cover the following types: boolean, Coding, Quantity.\nIf the data type is a code, then the code system is .group.source for .dependsOn.valueCode and .group.target for .product.valueCode."
      }]
    },
    {
      ...
      "display" : "valueSet",
      "target" : [{
        "code" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-ConceptMap.group.element.target.dependsOn.valueSet",
        "equivalence" : "wider",
