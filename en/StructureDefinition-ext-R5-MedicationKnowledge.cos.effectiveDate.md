# ExtensionMedicationKnowledge_Cost_EffectiveDate - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: The date range for which the cost is effective (new) 
...
```json
{
  ...
  "title" : "R5: The date range for which the cost is effective (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `MedicationKnowledge.cost.effectiveDate` (new:Period)",
  "jurisdiction" : [{
    "coding" : [{
