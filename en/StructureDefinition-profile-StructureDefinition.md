...
* Refer to this Profile: [Cross-version Extension `R5.GraphDefinition.node` for use in FHIR R4](StructureDefinition-ext-R5-GraphDefinition.node.md) and [Cross-version Extension `R5.ImplementationGuide.definition.resource` for use in FHIR R4](StructureDefinition-ext-R5-ImplementationGuide.def.resource.md)
...
```json
{
  ...
  "status" : "active",
  "experimental" : false,
  "date" : "2026-02-21T13:36:54.3555429-06:00",
