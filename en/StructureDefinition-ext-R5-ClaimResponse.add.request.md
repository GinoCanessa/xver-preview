# ExtensionClaimResponse_AddItem_Request - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
```json
{
  ...
  "description" : "R5: `ClaimResponse.addItem.request` (new:Reference(DeviceRequest,MedicationRequest,NutritionOrder,ServiceRequest,SupplyRequest,VisionPrescription))",
  "jurisdiction" : [{
    "coding" : [{
