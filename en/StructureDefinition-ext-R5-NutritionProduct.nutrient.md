# ExtensionNutritionProduct_Nutrient - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: The product's nutritional information expressed by the nutrients (new) 

R5: `NutritionProduct.nutrient` (new:BackboneElement)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-NutritionProduct.nutrient)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-NutritionProduct.nutrient.csv), [Excel](../StructureDefinition-ext-R5-NutritionProduct.nutrient.xlsx), [Schematron](../StructureDefinition-ext-R5-NutritionProduct.nutrient.sch) 
...
```json
{
  ...
  "id" : "ext-R5-NutritionProduct.nutrient",
  "extension" : [{
  ...
  "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-NutritionProduct.nutrient",
  "version" : "0.1.0",
  "name" : "ExtensionNutritionProduct_Nutrient",
  "title" : "R5: The product's nutritional information expressed by the nutrients (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `NutritionProduct.nutrient` (new:BackboneElement)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "purpose" : "This extension is part of the cross-version definitions generated to enable use of the\r\nelement `NutritionProduct.nutrient` as defined in FHIR R5\r\nin FHIR R4.\r\n\r\nThe source element is defined as:\r\n`NutritionProduct.nutrient` 0..* `BackboneElement`\r\n\r\nAcross FHIR versions, the element set has been mapped as:\r\n*  R5: `NutritionProduct.nutrient` 0..* `BackboneElement`\r\n\r\nFollowing are the generation technical comments:\r\nElement `NutritionProduct.nutrient` is not mapped to FHIR R4, since FHIR R5 `NutritionProduct` is not mapped.\nElement `NutritionProduct.nutrient` has no mapping targets in FHIR R4. Typically, this is because the element has been added (is a new element).",
  "fhirVersion" : "4.0.1",
  "mapping" : [{
    "identity" : "rim",
    "uri" : "http://hl7.org/v3",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "path" : "Extension.extension",
      "sliceName" : "item",
      "short" : "R5: The (relevant) nutrients in the product (new)",
      "definition" : "R5: `NutritionProduct.nutrient.item` (new:CodeableReference(Substance))",
    ...
    {
      "id" : "Extension.extension:item.extension:_datatype",
      "path" : "Extension.extension.extension",
      "sliceName" : "_datatype",
    ...
    {
      "id" : "Extension.extension:item.extension:_datatype.url",
    ...
    {
      "id" : "Extension.extension:item.extension:_datatype.value[x]",
    ...
    {
      "id" : "Extension.extension:item.extension:concept",
      "path" : "Extension.extension.extension",
      "sliceName" : "concept",
    ...
    {
      "id" : "Extension.extension:item.extension:concept.url",
      "path" : "Extension.extension.extension.url",
      "min" : 1,
      "max" : "1",
      "base" : {
    ...
    {
      "id" : "Extension.extension:item.extension:concept.value[x]",
      "path" : "Extension.extension.extension.value[x]",
    ...
    {
      "id" : "Extension.extension:item.extension:reference",
      "path" : "Extension.extension.extension",
      "sliceName" : "reference",
    ...
    {
      "id" : "Extension.extension:item.extension:reference.url",
      "path" : "Extension.extension.extension.url",
      "min" : 1,
      "max" : "1",
      "base" : {
    ...
    {
      "id" : "Extension.extension:item.extension:reference.value[x]",
      "path" : "Extension.extension.extension.value[x]",
    ...
    },
    {
      ...
      "path" : "Extension.extension",
      "sliceName" : "amount",
      "short" : "R5: The amount of nutrient expressed in one or more units: X per pack / per serving / per dose (new)",
      "definition" : "R5: `NutritionProduct.nutrient.amount` (new:Ratio)",
    ...
    },
    {
      ...
      "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-NutritionProduct.nutrient"
    },
    {
