# ExtensionInvoice_LineItem - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## Extension: Cross-version Extension `R5.Invoice.lineItem` for use in FHIR R4 

This cross-version extension represents the FHIR R5 element `Invoice.lineItem` for use in FHIR R4.
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-Invoice.lineItem)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-Invoice.lineItem.csv), [Excel](../StructureDefinition-ext-R5-Invoice.lineItem.xlsx), [Schematron](../StructureDefinition-ext-R5-Invoice.lineItem.sch) 
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Invoice.lineItem",
  "version" : "0.0.1-snapshot-3",
  "name" : "ExtensionInvoice_LineItem",
  "title" : "Cross-version Extension `R5.Invoice.lineItem` for use in FHIR R4",
  "status" : "active",
  "experimental" : false,
  ...
  "purpose" : "This extension is part of the cross-version definitions generated to enable use of the\r\nelement `Invoice.lineItem` as defined in FHIR R5\r\nin FHIR R4.\r\n\r\nThe source element is defined as:\r\n`Invoice.lineItem` 0..* `BackboneElement`\r\n\r\nAcross FHIR versions, the element set has been mapped as:\r\n*  R5: `Invoice.lineItem` 0..* `BackboneElement`\n*  R4B: `Invoice.lineItem` 0..* `BackboneElement`\n*  R4: `Invoice.lineItem` 0..* `BackboneElement`\r\n\r\nFollowing are the generation technical comments:\r\nElement `Invoice.lineItem` has is mapped to FHIR R4 element `Invoice.lineItem`, but has no comparisons.",
  "fhirVersion" : "4.0.1",
  "mapping" : [
    {
      "identity" : "rim",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "requirements" : "Element `Invoice.lineItem.sequence` is part of an existing definition because parent element `Invoice.lineItem` requires a cross-version extension.\nElement `Invoice.lineItem.sequence` has is mapped to FHIR R4 element `Invoice.lineItem.sequence`, but has no comparisons.",
        "min" : 0,
        "max" : "1",
        "base" : {
          "path" : "Extension.extension",
      ...
      },
      {
        ...
        "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Invoice.lineItem.sequence"
      },
      {
      ...
      },
      {
        ...
        "requirements" : "Element `Invoice.lineItem.serviced[x]` is part of an existing definition because parent element `Invoice.lineItem` requires a cross-version extension.\nElement `Invoice.lineItem.serviced[x]` has a context of Invoice.lineItem based on following the parent source element upwards and mapping to `Invoice`.",
        "min" : 0,
        "max" : "1",
        "base" : {
          "path" : "Extension.extension",
      ...
      },
      {
        ...
        "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Invoice.lineItem.serviced"
      },
      {
      ...
      {
        "id" : "Extension.extension:chargeItem",
        "path" : "Extension.extension",
      ...
      {
        "id" : "Extension.extension:chargeItem.url",
        "path" : "Extension.extension.url",
        "min" : 1,
        "max" : "1",
        "base" : {
        ...
        "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Invoice.lineItem.chargeItem"
      },
      {
        "id" : "Extension.extension:chargeItem.value[x]",
        "path" : "Extension.extension.value[x]",
        "short" : "Reference to ChargeItem containing details of this line item or an inline billing code",
        "definition" : "The ChargeItem contains information such as the billing code, date, amount etc. If no further details are required for the lineItem, inline billing codes can be added using the CodeableConcept data type instead of the Reference.",
        "min" : 1,
      ...
      },
      {
        ...
        "requirements" : "Element `Invoice.lineItem.priceComponent` is part of an existing definition because parent element `Invoice.lineItem` requires a cross-version extension.\nElement `Invoice.lineItem.priceComponent` has is mapped to FHIR R4 element `Invoice.lineItem.priceComponent`, but has no comparisons.",
        "min" : 0,
        "max" : "*",
        "base" : {
          "path" : "Extension.extension",
      ...
      },
      {
        ...
        "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Invoice.lineItem.priceComponent"
      },
      {
      ...
      },
      {
        ...
        "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Invoice.lineItem"
      },
      {
