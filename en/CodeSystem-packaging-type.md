# PackagingType - FHIR Cross-Version Extensions package to use FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## CodeSystem: PackagingType 
...
* [ValueSetR5PackagingTypeForR4](ValueSet-ValueSet-R5-packaging-type-for-R4.md)
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/packaging-type",
  "version" : "5.0.0",
  "name" : "PackagingType",
