# ExtensionImmunization_Reaction - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## Extension: Cross-version Extension `R5.Immunization.reaction` for use in FHIR R4 

This cross-version extension represents the FHIR R5 element `Immunization.reaction` for use in FHIR R4.
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-Immunization.reaction)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-Immunization.reaction.csv), [Excel](../StructureDefinition-ext-R5-Immunization.reaction.xlsx), [Schematron](../StructureDefinition-ext-R5-Immunization.reaction.sch) 
...
```json
{
  ...
  "id" : "ext-R5-Immunization.reaction",
  "extension" : [
    {
  ...
  "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Immunization.reaction",
  "version" : "0.0.1-snapshot-3",
  "name" : "ExtensionImmunization_Reaction",
  "title" : "Cross-version Extension `R5.Immunization.reaction` for use in FHIR R4",
  "status" : "active",
  "experimental" : false,
  ...
  "purpose" : "This extension is part of the cross-version definitions generated to enable use of the\r\nelement `Immunization.reaction` as defined in FHIR R5\r\nin FHIR R4.\r\n\r\nThe source element is defined as:\r\n`Immunization.reaction` 0..* `BackboneElement`\r\n\r\nAcross FHIR versions, the element set has been mapped as:\r\n*  R5: `Immunization.reaction` 0..* `BackboneElement`\n*  R4B: `Immunization.reaction` 0..* `BackboneElement`\n*  R4: `Immunization.reaction` 0..* `BackboneElement`\r\n\r\nFollowing are the generation technical comments:\r\nElement `Immunization.reaction` has is mapped to FHIR R4 element `Immunization.reaction`, but has no comparisons.",
  "fhirVersion" : "4.0.1",
  "mapping" : [
    {
      "identity" : "rim",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "requirements" : "Element `Immunization.reaction.date` is part of an existing definition because parent element `Immunization.reaction` requires a cross-version extension.\nElement `Immunization.reaction.date` has is mapped to FHIR R4 element `Immunization.reaction.date`, but has no comparisons.",
        "min" : 0,
        "max" : "1",
        "base" : {
          "path" : "Extension.extension",
      ...
      },
      {
        ...
        "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Immunization.reaction.date"
      },
      {
      ...
      },
      {
        ...
        "requirements" : "Element `Immunization.reaction.manifestation` is part of an existing definition because parent element `Immunization.reaction` requires a cross-version extension.\nElement `Immunization.reaction.manifestation` has is mapped to FHIR R4 element `Immunization.reaction.detail`, but has no comparisons.",
        "min" : 0,
        "max" : "1",
        "base" : {
          "path" : "Extension.extension",
      ...
      },
      {
        ...
        "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Immunization.reaction.manifestation"
      },
      {
      ...
      },
      {
        ...
        "requirements" : "Element `Immunization.reaction.reported` is part of an existing definition because parent element `Immunization.reaction` requires a cross-version extension.\nElement `Immunization.reaction.reported` has is mapped to FHIR R4 element `Immunization.reaction.reported`, but has no comparisons.",
        "min" : 0,
        "max" : "1",
        "base" : {
          "path" : "Extension.extension",
      ...
      },
      {
        ...
        "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Immunization.reaction.reported"
      },
      {
      ...
      },
      {
        ...
        "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Immunization.reaction"
      },
      {
