# ExtensionEncounterHistory_Location_Form - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: The physical type of the location (usually the level in the location hierarchy - bed, room, ward, virtual etc.) (new) 
...
```json
{
  ...
  "title" : "R5: The physical type of the location (usually the level in the location hierarchy - bed, room, ward, virtual etc.) (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `EncounterHistory.location.form` (new:CodeableConcept)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        ...
        "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-location-form-for-R4|0.1.0"
      }
    }]
  }
}
