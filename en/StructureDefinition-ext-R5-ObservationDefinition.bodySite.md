# ExtensionObservationDefinition_BodySite - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Body part to be observed (new) 
...
```json
{
  ...
  "title" : "R5: Body part to be observed (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `ObservationDefinition.bodySite` (new:CodeableConcept)",
  "jurisdiction" : [{
    "coding" : [{
