# ExtensionSubstanceDefinition_SourceMaterial_CountryOfOrigin - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: The country or countries where the material is harvested (new) 

R5: `SubstanceDefinition.sourceMaterial.countryOfOrigin` (new:CodeableConcept)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-SubstanceDefinition.sou.countryOfOrigin)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-SubstanceDefinition.sou.countryOfOrigin.csv), [Excel](../StructureDefinition-ext-R5-SubstanceDefinition.sou.countryOfOrigin.xlsx), [Schematron](../StructureDefinition-ext-R5-SubstanceDefinition.sou.countryOfOrigin.sch) 
...
```json
{
  ...
  "id" : "ext-R5-SubstanceDefinition.sou.countryOfOrigin",
  "extension" : [{
  ...
  "version" : "0.1.0",
  "name" : "ExtensionSubstanceDefinition_SourceMaterial_CountryOfOrigin",
  "title" : "R5: The country or countries where the material is harvested (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `SubstanceDefinition.sourceMaterial.countryOfOrigin` (new:CodeableConcept)",
  "jurisdiction" : [{
    "coding" : [{
