# ExtensionCoverage_CostToBeneficiary_Term - FHIR Cross-Version Extensions package to use FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## Extension: Cross-version Extension `R5.Coverage.costToBeneficiary.term` for use in FHIR R4 

This cross-version extension represents the FHIR R5 element `Coverage.costToBeneficiary.term` for use in FHIR R4.
...
```json
{
  ...
  "title" : "Cross-version Extension `R5.Coverage.costToBeneficiary.term` for use in FHIR R4",
  "status" : "active",
  "experimental" : false,
