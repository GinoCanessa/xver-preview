# ConsentPolicyRuleCodes - FHIR Cross-Version Extensions package to use FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## CodeSystem: ConsentPolicyRuleCodes 
...
```json
{
  ...
  "caseSensitive" : true,
  "valueSet" : "http://terminology.hl7.org/ValueSet/consent-policy|1.0.1",
  ...
  "concept" : [
    ...
    },
    {
      ...
      "definition" : "Consent for the Swiss Federal Act on the Electronic Patient Record (EPRA) https://www.bag.admin.ch/bag/de/home/gesetze-und-bewilligungen/gesetzgebung/gesetzgebung-mensch-gesundheit/gesetzgebung-elektronisches-patientendossier.html"
    }
  ]
}
