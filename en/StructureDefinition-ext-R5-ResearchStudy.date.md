# ExtensionResearchStudy_Date - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Date the resource last changed (new) 
...
```json
{
  ...
  "title" : "R5: Date the resource last changed (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `ResearchStudy.date` (new:dateTime)",
  "jurisdiction" : [{
    "coding" : [{
