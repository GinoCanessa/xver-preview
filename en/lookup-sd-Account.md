...
| [`Account.coverage`](https://hl7.org/fhir/R5/Account.html#resource) | [Account.coverage](https://hl7.org/fhir/R4/Account.html#resource)[Extension: ExtensionAccount_Coverage](StructureDefinition-ext-R5-Account.coverage.md) |
| [`Account.coverage.coverage`](https://hl7.org/fhir/R5/Account.html#resource) | [Account.coverage.coverage](https://hl7.org/fhir/R4/Account.html#resource)[Extension: ExtensionAccount_Coverage Slice:coverage](StructureDefinition-ext-R5-Account.coverage.md) |
| [`Account.coverage.priority`](https://hl7.org/fhir/R5/Account.html#resource) | [Account.coverage.priority](https://hl7.org/fhir/R4/Account.html#resource)[Extension: ExtensionAccount_Coverage Slice:priority](StructureDefinition-ext-R5-Account.coverage.md) |
...
| [`Account.guarantor`](https://hl7.org/fhir/R5/Account.html#resource) | [Account.guarantor](https://hl7.org/fhir/R4/Account.html#resource)[Extension: ExtensionAccount_Guarantor](StructureDefinition-ext-R5-Account.guarantor.md) |
| [`Account.guarantor.party`](https://hl7.org/fhir/R5/Account.html#resource) | [Account.guarantor.party](https://hl7.org/fhir/R4/Account.html#resource)[Extension: ExtensionAccount_Guarantor Slice:party](StructureDefinition-ext-R5-Account.guarantor.md) |
| [`Account.guarantor.onHold`](https://hl7.org/fhir/R5/Account.html#resource) | [Account.guarantor.onHold](https://hl7.org/fhir/R4/Account.html#resource)[Extension: ExtensionAccount_Guarantor Slice:onHold](StructureDefinition-ext-R5-Account.guarantor.md) |
| [`Account.guarantor.period`](https://hl7.org/fhir/R5/Account.html#resource) | [Account.guarantor.period](https://hl7.org/fhir/R4/Account.html#resource)[Extension: ExtensionAccount_Guarantor Slice:period](StructureDefinition-ext-R5-Account.guarantor.md) |
...
| [`Account.procedure.device`](https://hl7.org/fhir/R5/Account.html#resource) | [http://hl7.org/fhir/StructureDefinition/alternate-reference](http://hl7.org/fhir/StructureDefinition/alternate-reference) |
| [`Account.relatedAccount`](https://hl7.org/fhir/R5/Account.html#resource) | [Extension: ExtensionAccount_RelatedAccount](StructureDefinition-ext-R5-Account.relatedAccount.md) |
| [`Account.relatedAccount.relationship`](https://hl7.org/fhir/R5/Account.html#resource) | [Extension: ExtensionAccount_RelatedAccount Slice:relationship](StructureDefinition-ext-R5-Account.relatedAccount.md) |
| [`Account.relatedAccount.account`](https://hl7.org/fhir/R5/Account.html#resource) | [Account.partOf](https://hl7.org/fhir/R4/Account.html#resource)[Extension: ExtensionAccount_RelatedAccount Slice:account](StructureDefinition-ext-R5-Account.relatedAccount.md) |
