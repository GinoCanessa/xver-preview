# R5AppointmentresponseStatusForR4Participationstatus - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
* [R5: accepted | declined | tentative | needs-action | entered-in-error](StructureDefinition-ext-R5-AppointmentResponse.participantStatus.md)
...
```json
{
  ...
  "id" : "R5-appointmentresponse-status-for-R4-participationstatus",
  "extension" : [{
  ...
  "url" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-appointmentresponse-status-for-R4-participationstatus",
  "version" : "0.1.0",
  "name" : "R5AppointmentresponseStatusForR4Participationstatus",
