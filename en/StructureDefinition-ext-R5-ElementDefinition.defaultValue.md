# ExtensionElementDefinition_DefaultValue - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: defaultValue additional types 

R5: `ElementDefinition.defaultValue[x]` additional types (CodeableReference, RatioRange, Availability, ExtendedContactDetail)
...
```json
{
  ...
  "title" : "R5: defaultValue additional types",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `ElementDefinition.defaultValue[x]` additional types (CodeableReference, RatioRange, Availability, ExtendedContactDetail)",
  "jurisdiction" : [{
    "coding" : [{
