# ExtensionAppointmentResponse_ParticipantStatus - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: accepted | declined | tentative | needs-action | entered-in-error 
...
```json
{
  ...
  "title" : "R5: accepted | declined | tentative | needs-action | entered-in-error",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `AppointmentResponse.participantStatus`",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        ...
        "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-appointmentresponse-status-for-R4-participationstatus|0.1.0"
      }
    }]
  }
}
