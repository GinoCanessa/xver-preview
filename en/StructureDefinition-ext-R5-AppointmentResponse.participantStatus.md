# ExtensionAppointmentResponse_ParticipantStatus - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3
    ...
    "element" : [
      ...
      },
      {
        ...
        "binding" : {
          ...
          "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-appointmentresponse-status-for-R4-participationstatus|0.0.1-snapshot-3"
        }
      }
    ]
  }
