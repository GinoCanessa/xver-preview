# R5V3ActInvoiceAdjudicationPaymentCodeForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## ValueSet: Cross-version ValueSet R5.ActInvoiceAdjudicationPaymentCode for use in FHIR R4 
