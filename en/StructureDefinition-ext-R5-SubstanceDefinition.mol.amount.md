# ExtensionSubstanceDefinition_MolecularWeight_Amount - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Used to capture quantitative values for a variety of elements (new) 

R5: `SubstanceDefinition.molecularWeight.amount` (new:Quantity)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-SubstanceDefinition.mol.amount)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-SubstanceDefinition.mol.amount.csv), [Excel](../StructureDefinition-ext-R5-SubstanceDefinition.mol.amount.xlsx), [Schematron](../StructureDefinition-ext-R5-SubstanceDefinition.mol.amount.sch) 
...
```json
{
  ...
  "id" : "ext-R5-SubstanceDefinition.mol.amount",
  "extension" : [{
  ...
  "version" : "0.1.0",
  "name" : "ExtensionSubstanceDefinition_MolecularWeight_Amount",
  "title" : "R5: Used to capture quantitative values for a variety of elements (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `SubstanceDefinition.molecularWeight.amount` (new:Quantity)",
  "jurisdiction" : [{
    "coding" : [{
