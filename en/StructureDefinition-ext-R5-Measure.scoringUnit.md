# ExtensionMeasure_ScoringUnit - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: What units? (new) 
...
```json
{
  ...
  "description" : "R5: `Measure.scoringUnit` (new:CodeableConcept)",
  "jurisdiction" : [{
    "coding" : [{
