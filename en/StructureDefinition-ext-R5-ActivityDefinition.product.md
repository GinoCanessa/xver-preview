...
This cross-version extension represents the FHIR R5 element `ActivityDefinition.product[x]` for use in FHIR R4.
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-ActivityDefinition.product)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-ActivityDefinition.product.csv), [Excel](../StructureDefinition-ext-R5-ActivityDefinition.product.xlsx), [Schematron](../StructureDefinition-ext-R5-ActivityDefinition.product.sch) 
...
```json
{
  ...
  "id" : "ext-R5-ActivityDefinition.product",
  "extension" : [
    {
  ...
  "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-ActivityDefinition.product",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-ActivityDefinition.product"
      },
      {
