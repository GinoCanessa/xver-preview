# ExtensionSubscriptionTopic_VersionAlgorithm - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-SubscriptionTopic.versionAlgorithm)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-SubscriptionTopic.versionAlgorithm.csv), [Excel](../StructureDefinition-ext-R5-SubscriptionTopic.versionAlgorithm.xlsx), [Schematron](../StructureDefinition-ext-R5-SubscriptionTopic.versionAlgorithm.sch) 
...
```json
{
  ...
  "id" : "ext-R5-SubscriptionTopic.versionAlgorithm",
  "extension" : [{
  ...
  "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-SubscriptionTopic.versionAlgorithm",
  "version" : "0.1.0",
  "name" : "ExtensionSubscriptionTopic_VersionAlgorithm",
  ...
  "description" : "R5: `SubscriptionTopic.versionAlgorithm[x]` (new:Coding, string)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-SubscriptionTopic.versionAlgorithm"
    },
    {
