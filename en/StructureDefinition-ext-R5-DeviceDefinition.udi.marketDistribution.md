# ExtensionDeviceDefinition_UdiDeviceIdentifier_MarketDistribution - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Indicates whether and when the device is available on the market (new) 
...
```json
{
  ...
  "title" : "R5: Indicates whether and when the device is available on the market (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `DeviceDefinition.udiDeviceIdentifier.marketDistribution` (new:BackboneElement)",
  "jurisdiction" : [{
    "coding" : [{
