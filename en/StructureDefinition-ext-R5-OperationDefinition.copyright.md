# ExtensionOperationDefinition_Copyright - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Use and/or publishing restrictions (new) 

R5: `OperationDefinition.copyright` (new:markdown)
...
```json
{
  ...
  "description" : "R5: `OperationDefinition.copyright` (new:markdown)",
  "jurisdiction" : [{
    "coding" : [{
