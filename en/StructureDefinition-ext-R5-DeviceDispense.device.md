# ExtensionDeviceDispense_Device - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: What device was supplied (new) 

R5: `DeviceDispense.device` (new:CodeableReference(Device,DeviceDefinition))
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-DeviceDispense.device)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-DeviceDispense.device.csv), [Excel](../StructureDefinition-ext-R5-DeviceDispense.device.xlsx), [Schematron](../StructureDefinition-ext-R5-DeviceDispense.device.sch) 
...
```json
{
  ...
  "id" : "ext-R5-DeviceDispense.device",
  "extension" : [{
  ...
  "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-DeviceDispense.device",
  "version" : "0.1.0",
  "name" : "ExtensionDeviceDispense_Device",
  "title" : "R5: What device was supplied (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `DeviceDispense.device` (new:CodeableReference(Device,DeviceDefinition))",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "purpose" : "This extension is part of the cross-version definitions generated to enable use of the\r\nelement `DeviceDispense.device` as defined in FHIR R5\r\nin FHIR R4.\r\n\r\nThe source element is defined as:\r\n`DeviceDispense.device` 1..1 `CodeableReference(http://hl7.org/fhir/StructureDefinition/Device,http://hl7.org/fhir/StructureDefinition/DeviceDefinition)`\r\n\r\nAcross FHIR versions, the element set has been mapped as:\r\n* R5 `DeviceDispense.device` 1..1 `CodeableReference(http://hl7.org/fhir/StructureDefinition/Device,http://hl7.org/fhir/StructureDefinition/DeviceDefinition)`\r\n\r\nFollowing are the generation technical comments:\r\nElement `DeviceDispense.device` is not mapped to FHIR R4, since FHIR R5 `DeviceDispense` is not mapped.\nElement `DeviceDispense.device` has no mapping targets in FHIR R4. Typically, this is because the element has been added (is a new element).",
  "fhirVersion" : "4.0.1",
  "mapping" : [{
    "identity" : "rim",
    "uri" : "http://hl7.org/v3",
