# ExtensionObservationDefinition_Url - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Logical canonical URL to reference this ObservationDefinition (globally unique) (new) 
...
```json
{
  ...
  "title" : "R5: Logical canonical URL to reference this ObservationDefinition (globally unique) (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `ObservationDefinition.url` (new:uri)",
  "jurisdiction" : [{
    "coding" : [{
