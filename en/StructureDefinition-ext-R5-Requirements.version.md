# ExtensionRequirements_Version - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Business version of the Requirements (new) 

R5: `Requirements.version` (new:string)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-Requirements.version)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-Requirements.version.csv), [Excel](../StructureDefinition-ext-R5-Requirements.version.xlsx), [Schematron](../StructureDefinition-ext-R5-Requirements.version.sch) 
...
```json
{
  ...
  "id" : "ext-R5-Requirements.version",
  "extension" : [{
  ...
  "version" : "0.1.0",
  "name" : "ExtensionRequirements_Version",
  "title" : "R5: Business version of the Requirements (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Requirements.version` (new:string)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "purpose" : "This extension is part of the cross-version definitions generated to enable use of the\r\nelement `Requirements.version` as defined in FHIR R5\r\nin FHIR R4.\r\n\r\nThe source element is defined as:\r\n`Requirements.version` 0..1 `string`\r\n\r\nAcross FHIR versions, the element set has been mapped as:\r\n* R5 `Requirements.version` 0..1 `string`\r\n\r\nFollowing are the generation technical comments:\r\nElement `Requirements.version` is not mapped to FHIR R4, since FHIR R5 `Requirements` is not mapped.\nElement `Requirements.version` has no mapping targets in FHIR R4. Typically, this is because the element has been added (is a new element).",
  "fhirVersion" : "4.0.1",
  "mapping" : [{
    "identity" : "rim",
    "uri" : "http://hl7.org/v3",
