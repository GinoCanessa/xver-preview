# R5QuantityComparatorForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
* [R5: < | <= | >= | > | ad - how to understand the value](StructureDefinition-ext-R5-Age.comparator.md)
* [R5: < | <= | >= | > | ad - how to understand the value](StructureDefinition-ext-R5-Count.comparator.md)
* [R5: < | <= | >= | > | ad - how to understand the value](StructureDefinition-ext-R5-Distance.comparator.md)
* [R5: < | <= | >= | > | ad - how to understand the value](StructureDefinition-ext-R5-Duration.comparator.md)
* [R5: < | <= | >= | > | ad - how to understand the value](StructureDefinition-ext-R5-Quantity.comparator.md)
