# R5SubstanceSourceMaterialTypeForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
* [R5: Classification of the origin of the raw material. e.g. cat hair is an Animal source type (new)](StructureDefinition-ext-R5-SubstanceDefinition.sou.type.md)
