# ExtensionBiologicallyDerivedProduct_Division - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: A unique identifier for an aliquot of a product (new) 

R5: `BiologicallyDerivedProduct.division` (new:string)
...
```json
{
  ...
  "title" : "R5: A unique identifier for an aliquot of a product (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `BiologicallyDerivedProduct.division` (new:string)",
  "jurisdiction" : [{
    "coding" : [{
