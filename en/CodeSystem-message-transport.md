# MessageTransport - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3
...
```json
{
  ...
  "caseSensitive" : true,
  "valueSet" : "http://hl7.org/fhir/ValueSet/message-transport|4.0.1",
  "content" : "complete",
  "concept" : [
    {
      "code" : "http",
