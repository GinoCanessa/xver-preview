# ExtensionExampleScenario_Process_Step_Operation_Type - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## Extension: Cross-version Extension `R5.ExampleScenario.process.step.operation.type` for use in FHIR R4 

This cross-version extension represents the FHIR R5 element `ExampleScenario.process.step.operation.type` for use in FHIR R4.
...
```json
{
  ...
  "title" : "Cross-version Extension `R5.ExampleScenario.process.step.operation.type` for use in FHIR R4",
  "status" : "active",
  "experimental" : false,
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "extensible",
          "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-testscript-operation-codes-for-R4|0.0.1-snapshot-3"
        }
      }
    ]
  }
