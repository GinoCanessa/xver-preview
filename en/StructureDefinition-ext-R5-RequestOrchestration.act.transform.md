# ExtensionRequestOrchestration_Action_Transform - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Transform to apply the template (new) 
...
```json
{
  ...
  "title" : "R5: Transform to apply the template (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `RequestOrchestration.action.transform` (new:canonical(StructureMap))",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "canonical",
        "targetProfile" : ["http://hl7.org/fhir/5.0/StructureDefinition/profile-StructureMap|0.1.0",
