# ExtensionExplanationOfBenefit_AddItem_Detail_SubDetail_Revenue - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Revenue or cost center code (new) 

R5: `ExplanationOfBenefit.addItem.detail.subDetail.revenue` (new:CodeableConcept)
...
```json
{
  ...
  "description" : "R5: `ExplanationOfBenefit.addItem.detail.subDetail.revenue` (new:CodeableConcept)",
  "jurisdiction" : [{
    "coding" : [{
