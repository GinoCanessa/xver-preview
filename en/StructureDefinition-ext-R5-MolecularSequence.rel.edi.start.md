# ExtensionMolecularSequence_Relative_Edit_Start - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Start position of the edit on the starting sequence (new) 
...
```json
{
  ...
  "title" : "R5: Start position of the edit on the starting sequence (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `MolecularSequence.relative.edit.start` (new:integer)",
  "jurisdiction" : [{
    "coding" : [{
