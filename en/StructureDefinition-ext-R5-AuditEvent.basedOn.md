# ExtensionAuditEvent_BasedOn - FHIR Cross-Version Extensions package to use FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## Extension: Cross-version Extension `R5.AuditEvent.basedOn` for use in FHIR R4 

This cross-version extension represents the FHIR R5 element `AuditEvent.basedOn` for use in FHIR R4.
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-AuditEvent.basedOn)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-AuditEvent.basedOn.csv), [Excel](../StructureDefinition-ext-R5-AuditEvent.basedOn.xlsx), [Schematron](../StructureDefinition-ext-R5-AuditEvent.basedOn.sch) 
...
```json
{
  ...
  "name" : "ExtensionAuditEvent_BasedOn",
  "title" : "Cross-version Extension `R5.AuditEvent.basedOn` for use in FHIR R4",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "This cross-version extension represents the FHIR R5 element `AuditEvent.basedOn` for use in FHIR R4.",
  "jurisdiction" : [
    {
      "coding" : [
        {
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-AuditEvent.basedOn"
      },
      {
