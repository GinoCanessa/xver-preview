# ExtensionChargeItemDefinition_Applicability_Condition - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Boolean-valued expression (new) 

R5: `ChargeItemDefinition.applicability.condition` (new:Expression)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-ChargeItemDefinition.app.condition)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-ChargeItemDefinition.app.condition.csv), [Excel](../StructureDefinition-ext-R5-ChargeItemDefinition.app.condition.xlsx), [Schematron](../StructureDefinition-ext-R5-ChargeItemDefinition.app.condition.sch) 
...
```json
{
  ...
  "id" : "ext-R5-ChargeItemDefinition.app.condition",
  "extension" : [{
  ...
  "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-ChargeItemDefinition.applicability.condition",
  "version" : "0.1.0",
  "name" : "ExtensionChargeItemDefinition_Applicability_Condition",
  "title" : "R5: Boolean-valued expression (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `ChargeItemDefinition.applicability.condition` (new:Expression)",
  "jurisdiction" : [{
    "coding" : [{
