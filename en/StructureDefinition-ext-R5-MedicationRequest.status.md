# ExtensionMedicationRequest_Status - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: active | on-hold | ended | stopped | completed | cancelled | entered-in-error | draft | unknown additional codes 

R5: `MedicationRequest.status` additional codes
...
```json
{
  ...
  "title" : "R5: active | on-hold | ended | stopped | completed | cancelled | entered-in-error | draft | unknown additional codes",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `MedicationRequest.status` additional codes",
  "jurisdiction" : [{
    "coding" : [{
