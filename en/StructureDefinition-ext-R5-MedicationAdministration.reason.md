# ExtensionMedicationAdministration_Reason - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Concept, condition or observation that supports why the medication was administered additional types 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-MedicationAdministration.reason)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-MedicationAdministration.reason.csv), [Excel](../StructureDefinition-ext-R5-MedicationAdministration.reason.xlsx), [Schematron](../StructureDefinition-ext-R5-MedicationAdministration.reason.sch) 
...
```json
{
  ...
  "id" : "ext-R5-MedicationAdministration.reason",
  "extension" : [{
  ...
  "version" : "0.1.0",
  "name" : "ExtensionMedicationAdministration_Reason",
  "title" : "R5: Concept, condition or observation that supports why the medication was administered additional types",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `MedicationAdministration.reason` additional types (CodeableReference(http://hl7.org/fhir/StructureDefinition/Condition), CodeableReference(http://hl7.org/fhir/StructureDefinition/Observation), CodeableReference(http://hl7.org/fhir/StructureDefinition/DiagnosticReport))",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "purpose" : "This extension is part of the cross-version definitions generated to enable use of the\r\nelement `MedicationAdministration.reason` as defined in FHIR R5\r\nin FHIR R4.\r\n\r\nThe source element is defined as:\r\n`MedicationAdministration.reason` 0..* `CodeableReference(http://hl7.org/fhir/StructureDefinition/Condition,http://hl7.org/fhir/StructureDefinition/Observation,http://hl7.org/fhir/StructureDefinition/DiagnosticReport)`\r\n\r\nAcross FHIR versions, the element set has been mapped as:\r\n*  R5: `MedicationAdministration.reason` 0..* `CodeableReference(http://hl7.org/fhir/StructureDefinition/Condition,http://hl7.org/fhir/StructureDefinition/Observation,http://hl7.org/fhir/StructureDefinition/DiagnosticReport)`\n*  R4B: `MedicationAdministration.reasonCode` 0..* `CodeableConcept`\n*  R4: `MedicationAdministration.reasonCode` 0..* `CodeableConcept`\r\n\r\nFollowing are the generation technical comments:\r\nElement `MedicationAdministration.reason` is mapped to FHIR R4 element `MedicationAdministration.reasonCode` as `SourceIsBroaderThanTarget`.\nElement `MedicationAdministration.reason` is mapped to FHIR R4 element `MedicationAdministration.reasonReference` as `SourceIsBroaderThanTarget`.\nThe mappings for `MedicationAdministration.reason` do not cover the following types: CodeableReference.",
  "fhirVersion" : "4.0.1",
  "mapping" : [{
    "identity" : "rim",
    "uri" : "http://hl7.org/v3",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "preferred",
        "valueSet" : "http://hl7.org/fhir/ValueSet/reason-medication-given-codes|4.0.1"
      }
    },
    {
    ...
    },
    {
      ...
      "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-MedicationAdministration.reason"
    },
    {
