# R5ActionReasonCodeForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
* [R5: Why the request orchestration is needed additional types](StructureDefinition-ext-R5-RequestOrchestration.reason.md)
...
```json
{
  ...
  "id" : "R5-action-reason-code-for-R4",
  "extension" : [{
  ...
  "url" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-action-reason-code-for-R4",
  "version" : "0.1.0",
  "name" : "R5ActionReasonCodeForR4",
