# ExtensionPlanDefinition_Action_Output - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## Extension: Cross-version Extension `R5.PlanDefinition.action.output` for use in FHIR R4 

This cross-version extension represents the FHIR R5 element `PlanDefinition.action.output` for use in FHIR R4.
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-PlanDefinition.act.output)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-PlanDefinition.act.output.csv), [Excel](../StructureDefinition-ext-R5-PlanDefinition.act.output.xlsx), [Schematron](../StructureDefinition-ext-R5-PlanDefinition.act.output.sch) 
...
```json
{
  ...
  "id" : "ext-R5-PlanDefinition.act.output",
  "extension" : [
    {
  ...
  "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-PlanDefinition.action.output",
  ...
  "purpose" : "This extension is part of the cross-version definitions generated to enable use of the\r\nelement `PlanDefinition.action.output` as defined in FHIR R5\r\nin FHIR R4.\r\n\r\nThe source element is defined as:\r\n`PlanDefinition.action.output` 0..* `BackboneElement`\r\n\r\nAcross FHIR versions, the element set has been mapped as:\r\n*  R5: `PlanDefinition.action.output` 0..* `BackboneElement`\n*  R4B: `PlanDefinition.action.output` 0..* `DataRequirement`\n*  R4: `PlanDefinition.action.output` 0..* `DataRequirement`\r\n\r\nFollowing are the generation technical comments:\r\nElement `PlanDefinition.action.output` is mapped to FHIR R4 element `PlanDefinition.action.output` as `Equivalent`, concept domain: `NotRelatedTo`, value domain: `NotRelatedTo`.\nNote available implied context: `PlanDefinition.action.action.output` because `PlanDefinition.action.action` is defined via a content reference to `PlanDefinition.action`.",
  "fhirVersion" : "4.0.1",
  "mapping" : [
    {
      "identity" : "rim",
  ...
  "context" : [
    {
      "type" : "element",
      "expression" : "PlanDefinition.action.output"
    }
  ],
  "type" : "Extension",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "requirements" : "Element `PlanDefinition.action.output.title` has a context of PlanDefinition.action.output based on following the parent source element upwards and mapping to `PlanDefinition`.\nNote available implied context: `PlanDefinition.action.action.output` because `PlanDefinition.action.action` is defined via a content reference to `PlanDefinition.action`.",
        "min" : 0,
        "max" : "1",
        "base" : {
          "path" : "Extension.extension",
      ...
      },
      {
        ...
        "requirements" : "Element `PlanDefinition.action.output.requirement` has a context of PlanDefinition.action.output based on following the parent source element upwards and mapping to `PlanDefinition`.\nNote available implied context: `PlanDefinition.action.action.output` because `PlanDefinition.action.action` is defined via a content reference to `PlanDefinition.action`.",
        "min" : 0,
        "max" : "1",
        "base" : {
          "path" : "Extension.extension",
      ...
      },
      {
        ...
        "requirements" : "Element `PlanDefinition.action.output.relatedData` has a context of PlanDefinition.action.output based on following the parent source element upwards and mapping to `PlanDefinition`.\nNote available implied context: `PlanDefinition.action.action.output` because `PlanDefinition.action.action` is defined via a content reference to `PlanDefinition.action`.",
        "min" : 0,
        "max" : "1",
        "base" : {
          "path" : "Extension.extension",
