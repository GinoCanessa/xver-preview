# ExtensionGraphDefinition_Node - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Potential target for the link (new) 

R5: `GraphDefinition.node` (new:BackboneElement)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-GraphDefinition.node)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-GraphDefinition.node.csv), [Excel](../StructureDefinition-ext-R5-GraphDefinition.node.xlsx), [Schematron](../StructureDefinition-ext-R5-GraphDefinition.node.sch) 
...
```json
{
  ...
  "id" : "ext-R5-GraphDefinition.node",
  "extension" : [{
  ...
  "version" : "0.1.0",
  "name" : "ExtensionGraphDefinition_Node",
  "title" : "R5: Potential target for the link (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `GraphDefinition.node` (new:BackboneElement)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "path" : "Extension.extension",
      "sliceName" : "nodeId",
      "short" : "R5: Internal ID - target for link references (new)",
      "definition" : "R5: `GraphDefinition.node.nodeId` (new:id)",
    ...
    {
      "id" : "Extension.extension:nodeId.url",
    ...
    },
    {
      ...
      "short" : "R5: Why this node is specified (new)",
      "definition" : "R5: `GraphDefinition.node.description` (new:string)",
    ...
    },
    {
      ...
      "path" : "Extension.extension",
      "sliceName" : "type",
      "short" : "R5: Type of resource this link refers to (new)",
      "definition" : "R5: `GraphDefinition.node.type` (new:code)",
    ...
    },
    {
      ...
      "binding" : {
        ...
        "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-version-independent-all-resource-types-for-R4|0.1.0"
      }
    },
    {
      ...
      "path" : "Extension.extension",
      "sliceName" : "profile",
      "short" : "R5: Profile for the target resource (new)",
      "definition" : "R5: `GraphDefinition.node.profile` (new:canonical(StructureDefinition))",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "canonical",
        "targetProfile" : ["http://hl7.org/fhir/5.0/StructureDefinition/profile-StructureDefinition|0.1.0",
    ...
    },
    {
      ...
      "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-GraphDefinition.node"
    },
    {
