# ExtensionRatioRange - FHIR Cross-Version Extensions package to use FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## Extension: Cross-version Extension `R5.RatioRange` for use in FHIR R4 

This cross-version extension represents the FHIR R5 element `RatioRange` for use in FHIR R4.
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-RatioRange)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-RatioRange.csv), [Excel](../StructureDefinition-ext-R5-RatioRange.xlsx), [Schematron](../StructureDefinition-ext-R5-RatioRange.sch) 
...
```json
{
  ...
  "name" : "ExtensionRatioRange",
  "title" : "Cross-version Extension `R5.RatioRange` for use in FHIR R4",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "This cross-version extension represents the FHIR R5 element `RatioRange` for use in FHIR R4.",
  "jurisdiction" : [
    {
      "coding" : [
        {
  ...
  "purpose" : "This extension is part of the cross-version definitions generated to enable use of the\r\nelement `RatioRange` as defined in FHIR R5\r\nin FHIR R4.\r\n\r\nThe source element is defined as:\r\n`RatioRange` 0..* `RatioRange`\r\n\r\nAcross FHIR versions, the element set has been mapped as:\r\n*  R5: `RatioRange` 0..* `RatioRange`\r\n\r\nFollowing are the generation technical comments:\r\nFHIR R5 ComplexType `RatioRange` is representable via FHIR R4 extensions.\nElement `RatioRange` is not mapped to FHIR R4, since FHIR R5 `RatioRange` is not mapped.",
  "fhirVersion" : "4.0.1",
  "mapping" : [
    {
      "identity" : "rim",
