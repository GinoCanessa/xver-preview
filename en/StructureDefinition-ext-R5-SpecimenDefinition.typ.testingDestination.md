# ExtensionSpecimenDefinition_TypeTested_TestingDestination - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Where the specimen will be tested (new) 
...
```json
{
  ...
  "title" : "R5: Where the specimen will be tested (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `SpecimenDefinition.typeTested.testingDestination` (new:CodeableConcept)",
  "jurisdiction" : [{
    "coding" : [{
