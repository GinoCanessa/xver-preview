# ExtensionTerminologyCapabilities_CodeSystem_Version_Language - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: language 

R5: `TerminologyCapabilities.codeSystem.version.language`
...
```json
{
  ...
  "description" : "R5: `TerminologyCapabilities.codeSystem.version.language`",
  "jurisdiction" : [{
    "coding" : [{
