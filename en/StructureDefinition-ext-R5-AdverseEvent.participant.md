# ExtensionAdverseEvent_Participant - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Who was involved in the adverse event or the potential adverse event and what they did (new) 
...
```json
{
  ...
  "title" : "R5: Who was involved in the adverse event or the potential adverse event and what they did (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `AdverseEvent.participant` (new:BackboneElement)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "definition" : "R5: `AdverseEvent.participant.function` (new:CodeableConcept)",
    ...
    },
    {
      ...
      "binding" : {
        ...
        "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-adverse-event-participant-function-for-R4|0.1.0"
      }
    },
    {
      ...
      "path" : "Extension.extension",
      "sliceName" : "actor",
      "short" : "R5: Who was involved in the adverse event or the potential adverse event (new)",
      "definition" : "R5: `AdverseEvent.participant.actor` (new:Reference(Practitioner,PractitionerRole,Organization,CareTeam,Patient,Device,RelatedPerson,ResearchSubject))",
    ...
    },
    {
      ...
      "type" : [{
        ...
        "http://hl7.org/fhir/5.0/StructureDefinition/profile-ResearchSubject|0.1.0",
