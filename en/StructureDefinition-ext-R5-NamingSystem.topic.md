# ExtensionNamingSystem_Topic - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: E.g. Education, Treatment, Assessment, etc (new) 
...
```json
{
  ...
  "title" : "R5: E.g. Education, Treatment, Assessment, etc (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `NamingSystem.topic` (new:CodeableConcept)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "example",
        "valueSet" : "http://hl7.org/fhir/ValueSet/definition-topic|4.0.1"
      }
    }]
  }
}
