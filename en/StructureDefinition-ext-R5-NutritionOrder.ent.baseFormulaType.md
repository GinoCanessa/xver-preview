# ExtensionNutritionOrder_EnteralFormula_BaseFormulaType - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: baseFormulaType additional types 
...
```json
{
  ...
  "title" : "R5: baseFormulaType additional types",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `NutritionOrder.enteralFormula.baseFormulaType` additional types (CodeableReference(http://hl7.org/fhir/StructureDefinition/NutritionProduct)) additional types from child elements (reference)",
  "jurisdiction" : [{
    "coding" : [{
