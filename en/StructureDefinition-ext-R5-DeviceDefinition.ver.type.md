# ExtensionDeviceDefinition_Version_Type - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: The type of the device version, e.g. manufacturer, approved, internal (new) 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-DeviceDefinition.ver.type)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-DeviceDefinition.ver.type.csv), [Excel](../StructureDefinition-ext-R5-DeviceDefinition.ver.type.xlsx), [Schematron](../StructureDefinition-ext-R5-DeviceDefinition.ver.type.sch) 
...
```json
{
  ...
  "id" : "ext-R5-DeviceDefinition.ver.type",
  "extension" : [{
  ...
  "version" : "0.1.0",
  "name" : "ExtensionDeviceDefinition_Version_Type",
  "title" : "R5: The type of the device version, e.g. manufacturer, approved, internal (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `DeviceDefinition.version.type` (new:CodeableConcept)",
  "jurisdiction" : [{
    "coding" : [{
