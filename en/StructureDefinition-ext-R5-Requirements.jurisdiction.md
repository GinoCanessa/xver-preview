# ExtensionRequirements_Jurisdiction - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Intended jurisdiction for Requirements (if applicable) (new) 

R5: `Requirements.jurisdiction` (new:CodeableConcept)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-Requirements.jurisdiction)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-Requirements.jurisdiction.csv), [Excel](../StructureDefinition-ext-R5-Requirements.jurisdiction.xlsx), [Schematron](../StructureDefinition-ext-R5-Requirements.jurisdiction.sch) 
...
```json
{
  ...
  "id" : "ext-R5-Requirements.jurisdiction",
  "extension" : [{
  ...
  "version" : "0.1.0",
  "name" : "ExtensionRequirements_Jurisdiction",
  "title" : "R5: Intended jurisdiction for Requirements (if applicable) (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Requirements.jurisdiction` (new:CodeableConcept)",
  "jurisdiction" : [{
    "coding" : [{
