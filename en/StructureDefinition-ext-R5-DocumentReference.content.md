# ExtensionDocumentReference_Content - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## Extension: Cross-version Extension `R5.DocumentReference.content` for use in FHIR R4 

This cross-version extension represents the FHIR R5 element `DocumentReference.content` for use in FHIR R4.
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-DocumentReference.content)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-DocumentReference.content.csv), [Excel](../StructureDefinition-ext-R5-DocumentReference.content.xlsx), [Schematron](../StructureDefinition-ext-R5-DocumentReference.content.sch) 
...
```json
{
  ...
  "id" : "ext-R5-DocumentReference.content",
  "extension" : [
    {
  ...
  "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-DocumentReference.content",
  "version" : "0.0.1-snapshot-3",
  "name" : "ExtensionDocumentReference_Content",
  "title" : "Cross-version Extension `R5.DocumentReference.content` for use in FHIR R4",
  "status" : "active",
  "experimental" : false,
  ...
  "purpose" : "This extension is part of the cross-version definitions generated to enable use of the\r\nelement `DocumentReference.content` as defined in FHIR R5\r\nin FHIR R4.\r\n\r\nThe source element is defined as:\r\n`DocumentReference.content` 1..* `BackboneElement`\r\n\r\nAcross FHIR versions, the element set has been mapped as:\r\n*  R5: `DocumentReference.content` 1..* `BackboneElement`\n*  R4B: `Media.content` 1..1 `Attachment`\n*  R4: `Media.content` 1..1 `Attachment`\n*  R5: `DocumentReference.content` 1..* `BackboneElement`\n*  R4B: `DocumentReference.content` 1..* `BackboneElement`\n*  R4: `DocumentReference.content` 1..* `BackboneElement`\r\n\r\nFollowing are the generation technical comments:\r\nElement `DocumentReference.content` has is mapped to FHIR R4 element `DocumentReference.content`, but has no comparisons.\nElement `DocumentReference.content` has is mapped to FHIR R4 element `Media.content`, but has no comparisons.",
  "fhirVersion" : "4.0.1",
  "mapping" : [
    {
      "identity" : "rim",
  ...
  "differential" : {
    "element" : [
      ...
      {
        "id" : "Extension.extension:attachment",
        "path" : "Extension.extension",
      ...
      {
        "id" : "Extension.extension:attachment.url",
        ...
        "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-DocumentReference.content.attachment"
      },
      {
        "id" : "Extension.extension:attachment.value[x]",
      ...
      {
        "id" : "Extension.extension:profile.extension:value",
        "path" : "Extension.extension.extension",
        "sliceName" : "value",
      ...
      {
        "id" : "Extension.extension:profile.extension:value.url",
        ...
        "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-DocumentReference.content.profile.value"
      },
      {
        "id" : "Extension.extension:profile.extension:value.value[x]",
      ...
      },
      {
        ...
        "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-DocumentReference.content"
      },
      {
