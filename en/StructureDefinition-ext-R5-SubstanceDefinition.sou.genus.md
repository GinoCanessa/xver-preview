# ExtensionSubstanceDefinition_SourceMaterial_Genus - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: The genus of an organism e.g. the Latin epithet of the plant/animal scientific name (new) 

R5: `SubstanceDefinition.sourceMaterial.genus` (new:CodeableConcept)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-SubstanceDefinition.sou.genus)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-SubstanceDefinition.sou.genus.csv), [Excel](../StructureDefinition-ext-R5-SubstanceDefinition.sou.genus.xlsx), [Schematron](../StructureDefinition-ext-R5-SubstanceDefinition.sou.genus.sch) 
...
```json
{
  ...
  "id" : "ext-R5-SubstanceDefinition.sou.genus",
  "extension" : [{
  ...
  "version" : "0.1.0",
  "name" : "ExtensionSubstanceDefinition_SourceMaterial_Genus",
  "title" : "R5: The genus of an organism e.g. the Latin epithet of the plant/animal scientific name (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `SubstanceDefinition.sourceMaterial.genus` (new:CodeableConcept)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        ...
        "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-substance-source-material-genus-for-R4|0.1.0"
      }
    }]
  }
}
