# R5SearchModifierCodeForR4 - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0
...
* [R5: missing | exact | contains | not | text | in | not-in | below | above | type | identifier | of-type | code-text | text-advanced | iterate additional codes](StructureDefinition-ext-R5-SearchParameter.modifier.md)
* [R5: Criteria for narrowing the subscription topic stream (new)](StructureDefinition-ext-R5-Subscription.filterBy.md)
* [R5: Properties by which a Subscription can filter notifications from the SubscriptionTopic (new)](StructureDefinition-ext-R5-SubscriptionTopic.canFilterBy.md)
...
```json
{
  ...
  "id" : "R5-search-modifier-code-for-R4",
  "extension" : [{
  ...
  "url" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-search-modifier-code-for-R4",
  "version" : "0.1.0",
  "name" : "R5SearchModifierCodeForR4",
