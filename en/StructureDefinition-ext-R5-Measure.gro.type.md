# ExtensionMeasure_Group_Type - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: process | outcome | structure | patient-reported-outcome | composite (new) 
...
```json
{
  ...
  "title" : "R5: process | outcome | structure | patient-reported-outcome | composite (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Measure.group.type` (new:CodeableConcept)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "extensible",
        "valueSet" : "http://hl7.org/fhir/ValueSet/measure-type|4.0.1"
      }
    }]
  }
}
