...
This cross-version extension represents the FHIR R5 element `Contract.rule` for use in FHIR R4.
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-Contract.rule)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-Contract.rule.csv), [Excel](../StructureDefinition-ext-R5-Contract.rule.xlsx), [Schematron](../StructureDefinition-ext-R5-Contract.rule.sch) 
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Contract.rule",
  "version" : "0.0.1-snapshot-3",
  "name" : "ExtensionContract_Rule",
  ...
  "description" : "This cross-version extension represents the FHIR R5 element `Contract.rule` for use in FHIR R4.",
  "jurisdiction" : [
    {
      "coding" : [
        {
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Contract.rule"
      },
      {
