# ExtensionAppointment_Priority - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## Extension: Cross-version Extension `R5.Appointment.priority` for use in FHIR R4 

This cross-version extension represents the FHIR R5 element `Appointment.priority` for use in FHIR R4.
...
```json
{
  ...
  "title" : "Cross-version Extension `R5.Appointment.priority` for use in FHIR R4",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "This cross-version extension represents the FHIR R5 element `Appointment.priority` for use in FHIR R4.",
  "jurisdiction" : [
    {
      "coding" : [
        {
    ...
    "element" : [
      ...
      },
      {
        ...
        "binding" : {
          ...
          "valueSet" : "http://hl7.org/fhir/5.0/ValueSet/ValueSet-R5-v3-ActPriority-for-R4"
        }
      }
    ]
  }
