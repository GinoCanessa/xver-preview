# ExtensionDetectedIssue_Mitigation_Note - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Additional notes about the mitigation (new) 
...
```json
{
  ...
  "title" : "R5: Additional notes about the mitigation (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `DetectedIssue.mitigation.note` (new:Annotation)",
  "jurisdiction" : [{
    "coding" : [{
