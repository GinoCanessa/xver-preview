# ExtensionLocation_VirtualService - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Connection details of a virtual service (e.g. conference call) (new) 

R5: `Location.virtualService` (new:VirtualServiceDetail)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.xver-r5.r4|current/StructureDefinition/ext-R5-Location.virtualService)
...
Other representations of profile: [CSV](../StructureDefinition-ext-R5-Location.virtualService.csv), [Excel](../StructureDefinition-ext-R5-Location.virtualService.xlsx), [Schematron](../StructureDefinition-ext-R5-Location.virtualService.sch) 
...
```json
{
  ...
  "id" : "ext-R5-Location.virtualService",
  "extension" : [{
  ...
  "version" : "0.1.0",
  "name" : "ExtensionLocation_VirtualService",
  "title" : "R5: Connection details of a virtual service (e.g. conference call) (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Location.virtualService` (new:VirtualServiceDetail)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "purpose" : "This extension is part of the cross-version definitions generated to enable use of the\r\nelement `Location.virtualService` as defined in FHIR R5\r\nin FHIR R4.\r\n\r\nThe source element is defined as:\r\n`Location.virtualService` 0..* `VirtualServiceDetail`\r\n\r\nAcross FHIR versions, the element set has been mapped as:\r\n*  R5: `Location.virtualService` 0..* `VirtualServiceDetail`\r\n\r\nFollowing are the generation technical comments:\r\nElement `Location.virtualService` has a context of Location based on following the parent source element upwards and mapping to `Location`.\nElement `Location.virtualService` has no mapping targets in FHIR R4. Typically, this is because the element has been added (is a new element).",
  "fhirVersion" : "4.0.1",
  "mapping" : [{
    "identity" : "rim",
    "uri" : "http://hl7.org/v3",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "path" : "Extension.extension",
      "sliceName" : "_datatype",
      "short" : "DataType slice for a FHIR R5 `VirtualServiceDetail` value",
      "definition" : "Slice to indicate the presence of a R5 `VirtualServiceDetail` in FHIR R4",
      "min" : 1,
      "max" : "1",
      "base" : {
        "path" : "Extension.extension",
    ...
    },
    {
      ...
      "comment" : "Must be: VirtualServiceDetail",
      "min" : 1,
      "max" : "1",
      "base" : {
      ...
      "fixedString" : "VirtualServiceDetail"
    },
    {
    ...
    },
    {
      ...
      "path" : "Extension.extension",
      "sliceName" : "address",
      "short" : "R5: Contact address/number (new)",
      "definition" : "R5: `VirtualServiceDetail.address[x]` (new:ContactPoint, ExtendedContactDetail, string, url)",
      "comment" : "Element `VirtualServiceDetail.address[x]` is not mapped to FHIR R4, since FHIR R5 `VirtualServiceDetail` is not mapped.\nElement `VirtualServiceDetail.address[x]` has no mapping targets in FHIR R4. Typically, this is because the element has been added (is a new element).",
    ...
    },
    {
      ...
      "fixedUri" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Location.virtualService"
    },
    {
