# ExtensionLocation_VirtualService - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.0.1-snapshot-3

## Extension: Cross-version Extension `R5.Location.virtualService` for use in FHIR R4 

This cross-version extension represents the FHIR R5 element `Location.virtualService` for use in FHIR R4.
...
```json
{
  ...
  "title" : "Cross-version Extension `R5.Location.virtualService` for use in FHIR R4",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "This cross-version extension represents the FHIR R5 element `Location.virtualService` for use in FHIR R4.",
  "jurisdiction" : [
    {
      "coding" : [
        {
    ...
    "element" : [
      {
        ...
        "comment" : "There are two types of virtual meetings that often exist:\r\r* a persistent, virtual meeting room that can only be used for a single purpose at a time,\r * and a dynamic virtual meeting room that is generated on demand for a specific purpose.\r\r Implementers may consider using Appointment.virtualService for virtual meeting rooms that are generated on-demand.",
        "min" : 0,
        "max" : "*",
        "base" : {
          "path" : "Extension",
      ...
      },
      {
        ...
        "binding" : {
          ...
          "valueSet" : "http://hl7.org/fhir/uv/xver/ValueSet/R5-virtual-service-type-for-R4|0.0.1-snapshot-3"
        }
      },
      {
