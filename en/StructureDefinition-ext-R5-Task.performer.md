# ExtensionTask_Performer - Extensions for Using Data Elements from FHIR R5 in FHIR R4 v0.1.0

## Extension: R5: Who or what performed the task (new) 

R5: `Task.performer` (new:BackboneElement)
...
```json
{
  ...
  "title" : "R5: Who or what performed the task (new)",
  "status" : "active",
  "experimental" : false,
  ...
  "description" : "R5: `Task.performer` (new:BackboneElement)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "path" : "Extension.extension",
      "sliceName" : "function",
      "short" : "R5: Type of performance (new)",
      "definition" : "R5: `Task.performer.function` (new:CodeableConcept)",
    ...
    },
    {
      ...
      "path" : "Extension.extension",
      "sliceName" : "actor",
      "short" : "R5: Who performed the task (new)",
      "definition" : "R5: `Task.performer.actor` (new:Reference(Practitioner,PractitionerRole,Organization,CareTeam,Patient,RelatedPerson))",
