...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      <sch:assert test="count(f:extension[@url = 'treatmentIntent']) &lt;= 1">extension with URL = 'treatmentIntent': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'administrationTreatment']) &lt;= 1">extension with URL = 'administrationTreatment': maximum cardinality of 'extension' is 1</sch:assert>
