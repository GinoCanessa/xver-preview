...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      ...
      <sch:assert test="count(f:extension[@url = 'cost']) &gt;= 1">extension with URL = 'cost': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'cost']) &lt;= 1">extension with URL = 'cost': maximum cardinality of 'extension' is 1</sch:assert>
