...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      ...
      <sch:assert test="count(f:extension[@url = 'rule']) &gt;= 1">extension with URL = 'rule': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'rule']) &lt;= 1">extension with URL = 'rule': maximum cardinality of 'extension' is 1</sch:assert>
