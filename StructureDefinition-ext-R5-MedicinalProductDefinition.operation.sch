...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      ...
      <sch:assert test="count(f:extension[@url = 'effectiveDate']) &lt;= 1">extension with URL = 'effectiveDate': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'confidentialityIndicator']) &lt;= 1">extension with URL = 'confidentialityIndicator': maximum cardinality of 'extension' is 1</sch:assert>
